...
public:
   ...
   mc_comparator< ac_int<32, false > , MaskPacket< 0, 32 > > *arrsum_comp;
   ...
   sc_port< tlm::tlm_fifo_get_if< ac_int<32, false > > > ccs_arrsum;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_arrsum;
   ...
   tlm::tlm_fifo< mc_golden_info< ac_int<32, false >, MaskPacket<0, 32> > > arrsum_golden;
   bool _capture_arrsum;
   int arrsum_capture_count;
   int arrsum_iteration_count;
   ...
   mc_testbench(
      ...
      , ccs_arrsum("ccs_arrsum")
      , ccs_wait_ctrl_arrsum("ccs_wait_ctrl_arrsum")
      ...
      , remaining_ccs_run(0)
      , arrsum_golden("arrsum_golden",-1)
      , remaining_complete_golden(0)
      , complete_golden("complete_golden",-1)
   {
      // Instantiate other modules
      arrsum_comp = new mc_comparator< ac_int<32, false > , MaskPacket< 0, 32 > > (
         "arrsum_comp",
         "arrsum",
         0,
         0,
      ...
      arrsum_comp->data_in(ccs_arrsum);
      arrsum_comp->data_golden(arrsum_golden);
   ...
   public:
      void capture_arrsum( ac_int<32, false > &arrsum) ;
   public:
      void capture_complete( ac_sync &complete) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN( ac_sync &run,  ac_int<32, false > a[16],  ac_int<32, false > &arrsum,  ac_sync &complete) ;
   public:
      static void capture_OUT( ac_sync &run,  ac_int<32, false > a[16],  ac_int<32, false > &arrsum,  ac_sync &complete) ;
   public:
