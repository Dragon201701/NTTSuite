...
public:
  ...
  sc_signal<sc_lv<9> >                                                         TLS_vec_rsc_0_0_wadr;
  ...
  sc_signal<sc_lv<9> >                                                         TLS_vec_rsc_0_1_wadr;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_0_1_d;
  sc_signal<sc_logic>                                                          TLS_vec_rsc_0_1_we;
  sc_signal<sc_lv<9> >                                                         TLS_vec_rsc_0_1_radr;
  ...
  BLOCK_1R1W_RBW_trans_rsc<9,64,512 >                                          vec_rsc_0__1__INST;
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_0_wadr(TLS_vec_rsc_0_0_wadr);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_0_d(TLS_vec_rsc_0_0_d);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_0_we(TLS_vec_rsc_0_0_we);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_0_radr(TLS_vec_rsc_0_0_radr);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_0_q(TLS_vec_rsc_0_0_q);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_triosy_0_0_lz(TLS_vec_rsc_triosy_0_0_lz);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_1_wadr(TLS_vec_rsc_0_1_wadr);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_1_d(TLS_vec_rsc_0_1_d);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_1_we(TLS_vec_rsc_0_1_we);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_1_radr(TLS_vec_rsc_0_1_radr);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_0_1_q(TLS_vec_rsc_0_1_q);
    ...
    inPlaceNTT_DIT_precomp_INST.twiddle_rsc_0_0_radr(TLS_twiddle_rsc_0_0_radr);
    inPlaceNTT_DIT_precomp_INST.twiddle_rsc_0_0_q(TLS_twiddle_rsc_0_0_q);
    inPlaceNTT_DIT_precomp_INST.twiddle_rsc_triosy_0_0_lz(TLS_twiddle_rsc_triosy_0_0_lz);
    inPlaceNTT_DIT_precomp_INST.twiddle_rsc_0_1_radr(TLS_twiddle_rsc_0_1_radr);
    inPlaceNTT_DIT_precomp_INST.twiddle_rsc_0_1_q(TLS_twiddle_rsc_0_1_q);
