...
public:
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    inPlaceNTT_DIT_precomp_INST.vec_rsc_wadr(TLS_vec_rsc_wadr);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_d(TLS_vec_rsc_d);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_we(TLS_vec_rsc_we);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_radr(TLS_vec_rsc_radr);
    inPlaceNTT_DIT_precomp_INST.vec_rsc_q(TLS_vec_rsc_q);
    ...
    inPlaceNTT_DIT_precomp_INST.twiddle_rsc_radr(TLS_twiddle_rsc_radr);
    inPlaceNTT_DIT_precomp_INST.twiddle_rsc_q(TLS_twiddle_rsc_q);
