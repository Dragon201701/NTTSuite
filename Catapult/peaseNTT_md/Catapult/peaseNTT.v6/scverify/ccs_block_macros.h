...
extern void mc_testbench_capture_IN( ac_int<32, false > xt[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384]);
extern void mc_testbench_capture_OUT( ac_int<32, false > xt[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384]);
extern void mc_testbench_wait_for_idle_sync();

#define ccs_intercept_peaseNTT_67 \
  ccs_real_peaseNTT(ac_int<32, false > xt[16384],ac_int<32, false > p,ac_int<32, false > r,ac_int<32, false > twiddle[16384],ac_int<32, false > twiddle_h[16384]);\
  void peaseNTT(ac_int<32, false > xt[16384],ac_int<32, false > p,ac_int<32, false > r,ac_int<32, false > twiddle[16384],ac_int<32, false > twiddle_h[16384])\
{\
...
#else
#define ccs_intercept_peaseNTT_67 peaseNTT
...
// butterFly 42 INLINE
#define ccs_intercept_butterFly_42 butterFly
// cpyVec 52 INLINE
#define ccs_intercept_cpyVec_52 cpyVec
