...
directive set /modulo_dev/core/core:rlp/main CSTEPS_FROM {{. == 13} {.. == 0}}
...
directive set /modulo_dev/core/core:rlp/main/result:io_write(return:rsc.@) CSTEPS_FROM {{.. == 12}}

# Sync operation constraints

# Real operation constraints
directive set /modulo_dev/core/core:rlp/main/result:rem CSTEPS_FROM {{.. == 1}}
