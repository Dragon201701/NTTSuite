...
library set /LIBS/mgc_Xilinx-VIRTEX-uplus-3_beh/MODS/mgc_mul_pipe/PARAMETERS/width_b -- -CHAR_RANGE {8, 18 to 18, 27 to 27, 35 to 35, 44 to 44, 52 to 52, 61 to 61, 69 to 69}
library set /LIBS/mgc_Xilinx-VIRTEX-uplus-3_beh/MODS/mgc_mul_pipe/PARAMETERS/signd_b -- -CHAR_RANGE {0, 1 to 1}
library set /LIBS/mgc_Xilinx-VIRTEX-uplus-3_beh/MODS/mgc_mul_pipe/PARAMETERS/width_z -- -CHAR_RANGE {8, 36 to 36, 45 to 45, 53 to 53, 54 to 54, 62 to 62, 70 to 70, 71 to 71, 79 to 79, 87 to 87, 88 to 88, 96 to 96, 104 to 104, 105 to 105, 113 to 113, 121 to 121, 122 to 122, 130 to 130, 136 to 136, 138 to 138}
