...
## Multi-cycle component nangate-45nm_beh.mgc_rem (modulo_dev_result_rem_cmp) [cycles: 25]
set_multicycle_path 25 -through [get_pins {{inPlaceNTT_DIF_core_inst/modulo_dev_result_rem_cmp/z[*]}}]
