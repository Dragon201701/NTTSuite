...
## Multi-cycle component nangate-45nm_beh.mgc_rem (modulo_dev_result_rem_cmp) [cycles: 13]
set_multicycle_path 13 -through [get_pins {{inPlaceNTT_DIF_core_inst/modulo_dev_result_rem_cmp/z[*]}}]
set_min_delay 0 -from [get_pins {{inPlaceNTT_DIF_core_inst/modulo_dev_result_rem_cmp/a[*]} {inPlaceNTT_DIF_core_inst/modulo_dev_result_rem_cmp/b[*]}}] -to [get_pins {{inPlaceNTT_DIF_core_inst/modulo_dev_result_rem_cmp/z[*]}}]
