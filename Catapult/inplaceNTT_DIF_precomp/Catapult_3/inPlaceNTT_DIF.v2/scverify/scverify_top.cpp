...
public:
  ...
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_staller_inst_core_wen;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_re_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_we_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_rrdy;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_wrdy;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_s_raddr_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_s_waddr_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_rsci_inst_inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst_twiddle_rsci_s_re_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_rsci_inst_inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst_twiddle_rsci_s_rrdy;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_rsci_inst_inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_dp_inst_twiddle_rsci_s_raddr_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst_twiddle_h_rsci_s_re_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst_twiddle_h_rsci_s_rrdy;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_dp_inst_twiddle_h_rsci_s_raddr_core_sct;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 184522, 184522, 0)
    , catapult_monitor_INST("Monitor", clk, true, 184522LL, 184522LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    inPlaceNTT_DIF_INST.vec_rsc_s_tdone(TLS_vec_rsc_s_tdone);
    inPlaceNTT_DIF_INST.vec_rsc_tr_write_done(TLS_vec_rsc_tr_write_done);
    inPlaceNTT_DIF_INST.vec_rsc_RREADY(TLS_vec_rsc_RREADY);
    inPlaceNTT_DIF_INST.vec_rsc_RVALID(TLS_vec_rsc_RVALID);
    inPlaceNTT_DIF_INST.vec_rsc_RUSER(TLS_vec_rsc_RUSER);
    inPlaceNTT_DIF_INST.vec_rsc_RLAST(TLS_vec_rsc_RLAST);
    inPlaceNTT_DIF_INST.vec_rsc_RRESP(TLS_vec_rsc_RRESP);
    inPlaceNTT_DIF_INST.vec_rsc_RDATA(TLS_vec_rsc_RDATA);
    inPlaceNTT_DIF_INST.vec_rsc_RID(TLS_vec_rsc_RID);
    inPlaceNTT_DIF_INST.vec_rsc_ARREADY(TLS_vec_rsc_ARREADY);
    inPlaceNTT_DIF_INST.vec_rsc_ARVALID(TLS_vec_rsc_ARVALID);
    inPlaceNTT_DIF_INST.vec_rsc_ARUSER(TLS_vec_rsc_ARUSER);
    inPlaceNTT_DIF_INST.vec_rsc_ARREGION(TLS_vec_rsc_ARREGION);
    inPlaceNTT_DIF_INST.vec_rsc_ARQOS(TLS_vec_rsc_ARQOS);
    inPlaceNTT_DIF_INST.vec_rsc_ARPROT(TLS_vec_rsc_ARPROT);
    inPlaceNTT_DIF_INST.vec_rsc_ARCACHE(TLS_vec_rsc_ARCACHE);
    inPlaceNTT_DIF_INST.vec_rsc_ARLOCK(TLS_vec_rsc_ARLOCK);
    inPlaceNTT_DIF_INST.vec_rsc_ARBURST(TLS_vec_rsc_ARBURST);
    inPlaceNTT_DIF_INST.vec_rsc_ARSIZE(TLS_vec_rsc_ARSIZE);
    inPlaceNTT_DIF_INST.vec_rsc_ARLEN(TLS_vec_rsc_ARLEN);
    inPlaceNTT_DIF_INST.vec_rsc_ARADDR(TLS_vec_rsc_ARADDR);
    inPlaceNTT_DIF_INST.vec_rsc_ARID(TLS_vec_rsc_ARID);
    inPlaceNTT_DIF_INST.vec_rsc_BREADY(TLS_vec_rsc_BREADY);
    inPlaceNTT_DIF_INST.vec_rsc_BVALID(TLS_vec_rsc_BVALID);
    inPlaceNTT_DIF_INST.vec_rsc_BUSER(TLS_vec_rsc_BUSER);
    inPlaceNTT_DIF_INST.vec_rsc_BRESP(TLS_vec_rsc_BRESP);
    inPlaceNTT_DIF_INST.vec_rsc_BID(TLS_vec_rsc_BID);
    inPlaceNTT_DIF_INST.vec_rsc_WREADY(TLS_vec_rsc_WREADY);
    inPlaceNTT_DIF_INST.vec_rsc_WVALID(TLS_vec_rsc_WVALID);
    inPlaceNTT_DIF_INST.vec_rsc_WUSER(TLS_vec_rsc_WUSER);
    inPlaceNTT_DIF_INST.vec_rsc_WLAST(TLS_vec_rsc_WLAST);
    inPlaceNTT_DIF_INST.vec_rsc_WSTRB(TLS_vec_rsc_WSTRB);
    inPlaceNTT_DIF_INST.vec_rsc_WDATA(TLS_vec_rsc_WDATA);
    inPlaceNTT_DIF_INST.vec_rsc_AWREADY(TLS_vec_rsc_AWREADY);
    inPlaceNTT_DIF_INST.vec_rsc_AWVALID(TLS_vec_rsc_AWVALID);
    inPlaceNTT_DIF_INST.vec_rsc_AWUSER(TLS_vec_rsc_AWUSER);
    inPlaceNTT_DIF_INST.vec_rsc_AWREGION(TLS_vec_rsc_AWREGION);
    inPlaceNTT_DIF_INST.vec_rsc_AWQOS(TLS_vec_rsc_AWQOS);
    inPlaceNTT_DIF_INST.vec_rsc_AWPROT(TLS_vec_rsc_AWPROT);
    inPlaceNTT_DIF_INST.vec_rsc_AWCACHE(TLS_vec_rsc_AWCACHE);
    inPlaceNTT_DIF_INST.vec_rsc_AWLOCK(TLS_vec_rsc_AWLOCK);
    inPlaceNTT_DIF_INST.vec_rsc_AWBURST(TLS_vec_rsc_AWBURST);
    inPlaceNTT_DIF_INST.vec_rsc_AWSIZE(TLS_vec_rsc_AWSIZE);
    inPlaceNTT_DIF_INST.vec_rsc_AWLEN(TLS_vec_rsc_AWLEN);
    inPlaceNTT_DIF_INST.vec_rsc_AWADDR(TLS_vec_rsc_AWADDR);
    inPlaceNTT_DIF_INST.vec_rsc_AWID(TLS_vec_rsc_AWID);
    ...
    inPlaceNTT_DIF_INST.twiddle_rsc_s_tdone(TLS_twiddle_rsc_s_tdone);
    inPlaceNTT_DIF_INST.twiddle_rsc_tr_write_done(TLS_twiddle_rsc_tr_write_done);
    inPlaceNTT_DIF_INST.twiddle_rsc_RREADY(TLS_twiddle_rsc_RREADY);
    inPlaceNTT_DIF_INST.twiddle_rsc_RVALID(TLS_twiddle_rsc_RVALID);
    inPlaceNTT_DIF_INST.twiddle_rsc_RUSER(TLS_twiddle_rsc_RUSER);
    inPlaceNTT_DIF_INST.twiddle_rsc_RLAST(TLS_twiddle_rsc_RLAST);
    inPlaceNTT_DIF_INST.twiddle_rsc_RRESP(TLS_twiddle_rsc_RRESP);
    inPlaceNTT_DIF_INST.twiddle_rsc_RDATA(TLS_twiddle_rsc_RDATA);
    inPlaceNTT_DIF_INST.twiddle_rsc_RID(TLS_twiddle_rsc_RID);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARREADY(TLS_twiddle_rsc_ARREADY);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARVALID(TLS_twiddle_rsc_ARVALID);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARUSER(TLS_twiddle_rsc_ARUSER);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARREGION(TLS_twiddle_rsc_ARREGION);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARQOS(TLS_twiddle_rsc_ARQOS);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARPROT(TLS_twiddle_rsc_ARPROT);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARCACHE(TLS_twiddle_rsc_ARCACHE);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARLOCK(TLS_twiddle_rsc_ARLOCK);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARBURST(TLS_twiddle_rsc_ARBURST);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARSIZE(TLS_twiddle_rsc_ARSIZE);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARLEN(TLS_twiddle_rsc_ARLEN);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARADDR(TLS_twiddle_rsc_ARADDR);
    inPlaceNTT_DIF_INST.twiddle_rsc_ARID(TLS_twiddle_rsc_ARID);
    inPlaceNTT_DIF_INST.twiddle_rsc_BREADY(TLS_twiddle_rsc_BREADY);
    inPlaceNTT_DIF_INST.twiddle_rsc_BVALID(TLS_twiddle_rsc_BVALID);
    inPlaceNTT_DIF_INST.twiddle_rsc_BUSER(TLS_twiddle_rsc_BUSER);
    inPlaceNTT_DIF_INST.twiddle_rsc_BRESP(TLS_twiddle_rsc_BRESP);
    inPlaceNTT_DIF_INST.twiddle_rsc_BID(TLS_twiddle_rsc_BID);
    inPlaceNTT_DIF_INST.twiddle_rsc_WREADY(TLS_twiddle_rsc_WREADY);
    inPlaceNTT_DIF_INST.twiddle_rsc_WVALID(TLS_twiddle_rsc_WVALID);
    inPlaceNTT_DIF_INST.twiddle_rsc_WUSER(TLS_twiddle_rsc_WUSER);
    inPlaceNTT_DIF_INST.twiddle_rsc_WLAST(TLS_twiddle_rsc_WLAST);
    inPlaceNTT_DIF_INST.twiddle_rsc_WSTRB(TLS_twiddle_rsc_WSTRB);
    inPlaceNTT_DIF_INST.twiddle_rsc_WDATA(TLS_twiddle_rsc_WDATA);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWREADY(TLS_twiddle_rsc_AWREADY);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWVALID(TLS_twiddle_rsc_AWVALID);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWUSER(TLS_twiddle_rsc_AWUSER);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWREGION(TLS_twiddle_rsc_AWREGION);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWQOS(TLS_twiddle_rsc_AWQOS);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWPROT(TLS_twiddle_rsc_AWPROT);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWCACHE(TLS_twiddle_rsc_AWCACHE);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWLOCK(TLS_twiddle_rsc_AWLOCK);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWBURST(TLS_twiddle_rsc_AWBURST);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWSIZE(TLS_twiddle_rsc_AWSIZE);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWLEN(TLS_twiddle_rsc_AWLEN);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWADDR(TLS_twiddle_rsc_AWADDR);
    inPlaceNTT_DIF_INST.twiddle_rsc_AWID(TLS_twiddle_rsc_AWID);
    inPlaceNTT_DIF_INST.twiddle_rsc_triosy_lz(TLS_twiddle_rsc_triosy_lz);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_s_tdone(TLS_twiddle_h_rsc_s_tdone);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_tr_write_done(TLS_twiddle_h_rsc_tr_write_done);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_RREADY(TLS_twiddle_h_rsc_RREADY);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_RVALID(TLS_twiddle_h_rsc_RVALID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_RUSER(TLS_twiddle_h_rsc_RUSER);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_RLAST(TLS_twiddle_h_rsc_RLAST);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_RRESP(TLS_twiddle_h_rsc_RRESP);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_RDATA(TLS_twiddle_h_rsc_RDATA);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_RID(TLS_twiddle_h_rsc_RID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARREADY(TLS_twiddle_h_rsc_ARREADY);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARVALID(TLS_twiddle_h_rsc_ARVALID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARUSER(TLS_twiddle_h_rsc_ARUSER);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARREGION(TLS_twiddle_h_rsc_ARREGION);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARQOS(TLS_twiddle_h_rsc_ARQOS);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARPROT(TLS_twiddle_h_rsc_ARPROT);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARCACHE(TLS_twiddle_h_rsc_ARCACHE);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARLOCK(TLS_twiddle_h_rsc_ARLOCK);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARBURST(TLS_twiddle_h_rsc_ARBURST);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARSIZE(TLS_twiddle_h_rsc_ARSIZE);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARLEN(TLS_twiddle_h_rsc_ARLEN);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARADDR(TLS_twiddle_h_rsc_ARADDR);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_ARID(TLS_twiddle_h_rsc_ARID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_BREADY(TLS_twiddle_h_rsc_BREADY);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_BVALID(TLS_twiddle_h_rsc_BVALID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_BUSER(TLS_twiddle_h_rsc_BUSER);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_BRESP(TLS_twiddle_h_rsc_BRESP);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_BID(TLS_twiddle_h_rsc_BID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_WREADY(TLS_twiddle_h_rsc_WREADY);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_WVALID(TLS_twiddle_h_rsc_WVALID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_WUSER(TLS_twiddle_h_rsc_WUSER);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_WLAST(TLS_twiddle_h_rsc_WLAST);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_WSTRB(TLS_twiddle_h_rsc_WSTRB);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_WDATA(TLS_twiddle_h_rsc_WDATA);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWREADY(TLS_twiddle_h_rsc_AWREADY);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWVALID(TLS_twiddle_h_rsc_AWVALID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWUSER(TLS_twiddle_h_rsc_AWUSER);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWREGION(TLS_twiddle_h_rsc_AWREGION);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWQOS(TLS_twiddle_h_rsc_AWQOS);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWPROT(TLS_twiddle_h_rsc_AWPROT);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWCACHE(TLS_twiddle_h_rsc_AWCACHE);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWLOCK(TLS_twiddle_h_rsc_AWLOCK);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWBURST(TLS_twiddle_h_rsc_AWBURST);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWSIZE(TLS_twiddle_h_rsc_AWSIZE);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWLEN(TLS_twiddle_h_rsc_AWLEN);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWADDR(TLS_twiddle_h_rsc_AWADDR);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_AWID(TLS_twiddle_h_rsc_AWID);
    inPlaceNTT_DIF_INST.twiddle_h_rsc_triosy_lz(TLS_twiddle_h_rsc_triosy_lz);
...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_staller_inst_core_wen, /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_staller_inst/core_wen);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_re_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_vec_rsci_inst/inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_s_re_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_we_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_vec_rsci_inst/inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_s_we_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_rrdy,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_vec_rsci_inst/inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_s_rrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_wrdy,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_vec_rsci_inst/inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_s_wrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_s_raddr_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_vec_rsci_inst/inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_dp_inst/vec_rsci_s_raddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_vec_rsci_inst_inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_s_waddr_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_vec_rsci_inst/inPlaceNTT_DIF_core_vec_rsci_vec_rsc_wait_dp_inst/vec_rsci_s_waddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_rsci_inst_inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst_twiddle_rsci_s_re_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_twiddle_rsci_inst/inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst/twiddle_rsci_s_re_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_rsci_inst_inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst_twiddle_rsci_s_rrdy,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_twiddle_rsci_inst/inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst/twiddle_rsci_s_rrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_rsci_inst_inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_dp_inst_twiddle_rsci_s_raddr_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_twiddle_rsci_inst/inPlaceNTT_DIF_core_twiddle_rsci_twiddle_rsc_wait_dp_inst/twiddle_rsci_s_raddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst_twiddle_h_rsci_s_re_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_twiddle_h_rsci_inst/inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst/twiddle_h_rsci_s_re_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst_twiddle_h_rsci_s_rrdy,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_twiddle_h_rsci_inst/inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst/twiddle_h_rsci_s_rrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_core_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_inst_inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_dp_inst_twiddle_h_rsci_s_raddr_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_core_inst/inPlaceNTT_DIF_core_twiddle_h_rsci_inst/inPlaceNTT_DIF_core_twiddle_h_rsci_twiddle_h_rsc_wait_dp_inst/twiddle_h_rsci_s_raddr_core_sct);
#endif
#endif
}
