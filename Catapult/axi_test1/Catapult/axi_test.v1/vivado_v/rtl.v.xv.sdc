...
set_output_delay -clock [get_clocks {clk}] 1.235 [get_ports {b_rsc_adra[*]}]
set_max_delay 10.0 -from [all_inputs] -to [all_outputs]
set_output_delay -clock [get_clocks {clk}] 1.235 [get_ports {b_rsc_da[*]}]
set_output_delay -clock [get_clocks {clk}] 1.235 [get_ports {b_rsc_wea}]
set_input_delay -clock [get_clocks {clk}] 2.04 [get_ports {b_rsc_qa[*]}]
set_output_delay -clock [get_clocks {clk}] 1.235 [get_ports {b_rsc_adrb[*]}]
set_output_delay -clock [get_clocks {clk}] 1.235 [get_ports {b_rsc_db[*]}]
set_output_delay -clock [get_clocks {clk}] 1.235 [get_ports {b_rsc_web}]
set_input_delay -clock [get_clocks {clk}] 2.04 [get_ports {b_rsc_qb[*]}]
