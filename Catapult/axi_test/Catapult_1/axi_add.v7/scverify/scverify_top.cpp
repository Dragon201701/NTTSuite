...
public:
  ...
  sc_signal<sc_lv<512> >                                                      TLS_a_rsc_dat;
  sc_signal<sc_logic>                                                         TLS_a_rsc_triosy_lz;
  sc_signal<sc_lv<512> >                                                      TLS_b_rsc_dat;
  ...
  ccs_in_trans_rsc_v1<1,512 >                                                 a_rsc_INST;
  ccs_out_trans_rsc_v1<1,512 >                                                b_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , transactor_a("transactor_a", 0, 512, 0, true)
    ...
    , transactor_b("transactor_b", 0, 512, 0)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    axi_add_INST.a_rsc_dat(TLS_a_rsc_dat);
    axi_add_INST.a_rsc_triosy_lz(TLS_a_rsc_triosy_lz);
    axi_add_INST.b_rsc_dat(TLS_b_rsc_dat);
