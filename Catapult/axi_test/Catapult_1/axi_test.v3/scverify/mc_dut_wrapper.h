...
public:
  ...
  sc_in<sc_lv<32> > a_rsc_cfgTimeout;
  sc_in<sc_lv<32> > a_rsc_cfgrBurstSize;
  sc_in<sc_lv<32> > a_rsc_cfgwBurstSize;
  sc_in<sc_lv<32> > a_rsc_cfgrBaseAddress;
  sc_in<sc_lv<32> > a_rsc_cfgwBaseAddress;
  ...
  sc_in<sc_lv<32> > b_rsc_cfgTimeout;
  sc_in<sc_lv<32> > b_rsc_cfgrBurstSize;
  sc_in<sc_lv<32> > b_rsc_cfgwBurstSize;
  sc_in<sc_lv<32> > b_rsc_cfgrBaseAddress;
  sc_in<sc_lv<32> > b_rsc_cfgwBaseAddress;
