...
public:
  ...
  sc_signal<sc_lv<32> >                                                       TLS_a_rsc_cfgTimeout;
  sc_signal<sc_lv<32> >                                                       TLS_a_rsc_cfgrBurstSize;
  sc_signal<sc_lv<32> >                                                       TLS_a_rsc_cfgwBurstSize;
  sc_signal<sc_lv<32> >                                                       TLS_a_rsc_cfgrBaseAddress;
  sc_signal<sc_lv<32> >                                                       TLS_a_rsc_cfgwBaseAddress;
  ...
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_cfgTimeout;
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_cfgrBurstSize;
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_cfgwBurstSize;
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_cfgrBaseAddress;
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_cfgwBaseAddress;
  ...
  ccs_axi4_master_core_trans_rsc<16,32,32,4,0,32,32,1,1,1,0,0,0,0,0,0 >       a_rsc_INST;
  ...
  ccs_axi4_master_core_trans_rsc<16,32,32,4,0,32,32,1,1,1,0,0,0,0,0,0 >       b_rsc_INST;
  ...
  sc_signal<sc_logic>                                                         OFS_axi_test_core_inst_axi_test_core_b_rsci_inst_axi_test_core_b_rsci_b_rsc_wait_dp_inst_b_rsci_m_waddr_core_sct;
  sc_signal<sc_logic>                                                         OFS_axi_test_core_inst_axi_test_core_b_rsci_inst_axi_test_core_b_rsci_b_rsc_wait_ctrl_inst_b_rsci_m_we_core_sct;
  sc_signal<sc_logic>                                                         OFS_axi_test_core_inst_axi_test_core_b_rsci_inst_axi_test_core_b_rsci_b_rsc_wait_ctrl_inst_b_rsci_m_wrdy;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , rst_driver("rst_driver", 104.000000, false)
    , TLS_rst("TLS_rst")
    ...
    , TLS_a_rsc_cfgTimeout("TLS_a_rsc_cfgTimeout")
    , TLS_a_rsc_cfgrBurstSize("TLS_a_rsc_cfgrBurstSize")
    , TLS_a_rsc_cfgwBurstSize("TLS_a_rsc_cfgwBurstSize")
    , TLS_a_rsc_cfgrBaseAddress("TLS_a_rsc_cfgrBaseAddress")
    , TLS_a_rsc_cfgwBaseAddress("TLS_a_rsc_cfgwBaseAddress")
    ...
    , TLS_b_rsc_cfgTimeout("TLS_b_rsc_cfgTimeout")
    , TLS_b_rsc_cfgrBurstSize("TLS_b_rsc_cfgrBurstSize")
    , TLS_b_rsc_cfgwBurstSize("TLS_b_rsc_cfgwBurstSize")
    , TLS_b_rsc_cfgrBaseAddress("TLS_b_rsc_cfgrBaseAddress")
    , TLS_b_rsc_cfgwBaseAddress("TLS_b_rsc_cfgwBaseAddress")
    ...
    , transactor_run("transactor_run", 0, 1, 0, true)
    ...
    , transactor_a("transactor_a", 0, 32, 0, true)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 52, 52, 0)
    , catapult_monitor_INST("Monitor", clk, true, 52LL, 51LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    axi_test_INST.a_rsc_cfgTimeout(TLS_a_rsc_cfgTimeout);
    axi_test_INST.a_rsc_cfgrBurstSize(TLS_a_rsc_cfgrBurstSize);
    axi_test_INST.a_rsc_cfgwBurstSize(TLS_a_rsc_cfgwBurstSize);
    axi_test_INST.a_rsc_cfgrBaseAddress(TLS_a_rsc_cfgrBaseAddress);
    axi_test_INST.a_rsc_cfgwBaseAddress(TLS_a_rsc_cfgwBaseAddress);
    ...
    axi_test_INST.b_rsc_m_wstate(TLS_b_rsc_m_wstate);
    axi_test_INST.b_rsc_m_wCaughtUp(TLS_b_rsc_m_wCaughtUp);
    axi_test_INST.b_rsc_cfgTimeout(TLS_b_rsc_cfgTimeout);
    axi_test_INST.b_rsc_cfgrBurstSize(TLS_b_rsc_cfgrBurstSize);
    axi_test_INST.b_rsc_cfgwBurstSize(TLS_b_rsc_cfgwBurstSize);
    axi_test_INST.b_rsc_cfgrBaseAddress(TLS_b_rsc_cfgrBaseAddress);
    axi_test_INST.b_rsc_cfgwBaseAddress(TLS_b_rsc_cfgwBaseAddress);
    axi_test_INST.b_rsc_RREADY(TLS_b_rsc_RREADY);
    axi_test_INST.b_rsc_RVALID(TLS_b_rsc_RVALID);
    axi_test_INST.b_rsc_RUSER(TLS_b_rsc_RUSER);
    axi_test_INST.b_rsc_RLAST(TLS_b_rsc_RLAST);
    axi_test_INST.b_rsc_RRESP(TLS_b_rsc_RRESP);
    axi_test_INST.b_rsc_RDATA(TLS_b_rsc_RDATA);
    axi_test_INST.b_rsc_RID(TLS_b_rsc_RID);
    axi_test_INST.b_rsc_ARREADY(TLS_b_rsc_ARREADY);
    axi_test_INST.b_rsc_ARVALID(TLS_b_rsc_ARVALID);
    axi_test_INST.b_rsc_ARUSER(TLS_b_rsc_ARUSER);
    axi_test_INST.b_rsc_ARREGION(TLS_b_rsc_ARREGION);
    axi_test_INST.b_rsc_ARQOS(TLS_b_rsc_ARQOS);
    axi_test_INST.b_rsc_ARPROT(TLS_b_rsc_ARPROT);
    axi_test_INST.b_rsc_ARCACHE(TLS_b_rsc_ARCACHE);
    axi_test_INST.b_rsc_ARLOCK(TLS_b_rsc_ARLOCK);
    axi_test_INST.b_rsc_ARBURST(TLS_b_rsc_ARBURST);
    axi_test_INST.b_rsc_ARSIZE(TLS_b_rsc_ARSIZE);
    axi_test_INST.b_rsc_ARLEN(TLS_b_rsc_ARLEN);
    axi_test_INST.b_rsc_ARADDR(TLS_b_rsc_ARADDR);
    axi_test_INST.b_rsc_ARID(TLS_b_rsc_ARID);
    axi_test_INST.b_rsc_BREADY(TLS_b_rsc_BREADY);
    axi_test_INST.b_rsc_BVALID(TLS_b_rsc_BVALID);
    axi_test_INST.b_rsc_BUSER(TLS_b_rsc_BUSER);
    axi_test_INST.b_rsc_BRESP(TLS_b_rsc_BRESP);
    axi_test_INST.b_rsc_BID(TLS_b_rsc_BID);
    axi_test_INST.b_rsc_WREADY(TLS_b_rsc_WREADY);
    axi_test_INST.b_rsc_WVALID(TLS_b_rsc_WVALID);
    axi_test_INST.b_rsc_WUSER(TLS_b_rsc_WUSER);
    axi_test_INST.b_rsc_WLAST(TLS_b_rsc_WLAST);
    axi_test_INST.b_rsc_WSTRB(TLS_b_rsc_WSTRB);
    axi_test_INST.b_rsc_WDATA(TLS_b_rsc_WDATA);
    axi_test_INST.b_rsc_AWREADY(TLS_b_rsc_AWREADY);
    axi_test_INST.b_rsc_AWVALID(TLS_b_rsc_AWVALID);
    axi_test_INST.b_rsc_AWUSER(TLS_b_rsc_AWUSER);
    axi_test_INST.b_rsc_AWREGION(TLS_b_rsc_AWREGION);
    axi_test_INST.b_rsc_AWQOS(TLS_b_rsc_AWQOS);
    axi_test_INST.b_rsc_AWPROT(TLS_b_rsc_AWPROT);
    axi_test_INST.b_rsc_AWCACHE(TLS_b_rsc_AWCACHE);
    axi_test_INST.b_rsc_AWLOCK(TLS_b_rsc_AWLOCK);
    axi_test_INST.b_rsc_AWBURST(TLS_b_rsc_AWBURST);
    axi_test_INST.b_rsc_AWSIZE(TLS_b_rsc_AWSIZE);
    axi_test_INST.b_rsc_AWLEN(TLS_b_rsc_AWLEN);
    axi_test_INST.b_rsc_AWADDR(TLS_b_rsc_AWADDR);
    axi_test_INST.b_rsc_AWID(TLS_b_rsc_AWID);
    axi_test_INST.b_rsc_triosy_lz(TLS_b_rsc_triosy_lz);
    ...
    a_rsc_INST.cfgwBaseAddress(TLS_a_rsc_cfgwBaseAddress);
    a_rsc_INST.cfgrBaseAddress(TLS_a_rsc_cfgrBaseAddress);
    a_rsc_INST.cfgwBurstSize(TLS_a_rsc_cfgwBurstSize);
    a_rsc_INST.cfgrBurstSize(TLS_a_rsc_cfgrBurstSize);
    a_rsc_INST.cfgTimeout(TLS_a_rsc_cfgTimeout);
    ...
    b_rsc_INST.cfgwBaseAddress(TLS_b_rsc_cfgwBaseAddress);
    b_rsc_INST.cfgrBaseAddress(TLS_b_rsc_cfgrBaseAddress);
    b_rsc_INST.cfgwBurstSize(TLS_b_rsc_cfgwBurstSize);
    b_rsc_INST.cfgrBurstSize(TLS_b_rsc_cfgrBurstSize);
    b_rsc_INST.cfgTimeout(TLS_b_rsc_cfgTimeout);
    b_rsc_INST.m_wCaughtUp(TLS_b_rsc_m_wCaughtUp);
    b_rsc_INST.m_wstate(TLS_b_rsc_m_wstate);
    b_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_3)));
...
void scverify_top::generate_reset() {
  ...
  if (activate_reset || sc_time_stamp() == SC_ZERO_TIME) {
    ...
    generate_reset_event.notify(104.000000 , SC_NS);
  } else {
    if (toggle_hw_reset) {
...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_axi_test_core_inst_axi_test_core_b_rsci_inst_axi_test_core_b_rsci_b_rsc_wait_dp_inst_b_rsci_m_waddr_core_sct,
      /scverify_top/rtl/axi_test_core_inst/axi_test_core_b_rsci_inst/axi_test_core_b_rsci_b_rsc_wait_dp_inst/b_rsci_m_waddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_axi_test_core_inst_axi_test_core_b_rsci_inst_axi_test_core_b_rsci_b_rsc_wait_ctrl_inst_b_rsci_m_we_core_sct,
      /scverify_top/rtl/axi_test_core_inst/axi_test_core_b_rsci_inst/axi_test_core_b_rsci_b_rsc_wait_ctrl_inst/b_rsci_m_we_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_axi_test_core_inst_axi_test_core_b_rsci_inst_axi_test_core_b_rsci_b_rsc_wait_ctrl_inst_b_rsci_m_wrdy,
      /scverify_top/rtl/axi_test_core_inst/axi_test_core_b_rsci_inst/axi_test_core_b_rsci_b_rsc_wait_ctrl_inst/b_rsci_m_wrdy);
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(848, SC_NS);
    } else {
