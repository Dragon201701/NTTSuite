...
set_input_delay -clock [get_clocks {clk}] 0.634615 [get_ports {a_rsc_cfgTimeout[*]}]
set_input_delay -clock [get_clocks {clk}] 0.634615 [get_ports {a_rsc_cfgrBurstSize[*]}]
set_input_delay -clock [get_clocks {clk}] 0.102564 [get_ports {a_rsc_cfgwBurstSize[*]}]
set_input_delay -clock [get_clocks {clk}] 0.634615 [get_ports {a_rsc_cfgrBaseAddress[*]}]
set_input_delay -clock [get_clocks {clk}] 0.102564 [get_ports {a_rsc_cfgwBaseAddress[*]}]
...
set_input_delay -clock [get_clocks {clk}] 0.634615 [get_ports {b_rsc_cfgTimeout[*]}]
set_input_delay -clock [get_clocks {clk}] 0.634615 [get_ports {b_rsc_cfgrBurstSize[*]}]
set_input_delay -clock [get_clocks {clk}] 0.102564 [get_ports {b_rsc_cfgwBurstSize[*]}]
set_input_delay -clock [get_clocks {clk}] 0.634615 [get_ports {b_rsc_cfgrBaseAddress[*]}]
set_input_delay -clock [get_clocks {clk}] 0.102564 [get_ports {b_rsc_cfgwBaseAddress[*]}]
