...
#include "/opt/mentorgraphics/Catapult_10.5c/Mgc_home/pkgs/siflibs/ccs_ram_sync_singleport_trans_rsc.h"
...
public:
  ...
  sc_signal<sc_lv<4> >                                                        TLS_a_rsc_adr;
  ...
  sc_signal<sc_lv<4> >                                                        TLS_b_rsc_adr;
  ...
  ccs_ram_sync_singleport_trans_rsc<32,4,16 >                                 a_rsc_INST;
  ccs_ram_sync_singleport_trans_rsc<32,4,16 >                                 b_rsc_INST;
  ...
  sc_signal<sc_logic>                                                         OFS_axi_add_core_inst_axi_add_core_complete_rsci_inst_axi_add_core_complete_rsci_complete_wait_ctrl_inst_complete_rsci_ivld_core_sct;
  sc_signal<sc_logic>                                                         OFS_axi_add_core_inst_axi_add_core_complete_rsci_inst_axi_add_core_complete_rsci_complete_wait_ctrl_inst_complete_rsci_irdy;
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    axi_add_INST.run_rsc_rdy(TLS_run_rsc_rdy);
    axi_add_INST.run_rsc_vld(TLS_run_rsc_vld);
    axi_add_INST.a_rsc_adr(TLS_a_rsc_adr);
    axi_add_INST.a_rsc_d(TLS_a_rsc_d);
    axi_add_INST.a_rsc_we(TLS_a_rsc_we);
    axi_add_INST.a_rsc_q(TLS_a_rsc_q);
    axi_add_INST.a_rsc_triosy_lz(TLS_a_rsc_triosy_lz);
    axi_add_INST.b_rsc_adr(TLS_b_rsc_adr);
    axi_add_INST.b_rsc_d(TLS_b_rsc_d);
    axi_add_INST.b_rsc_we(TLS_b_rsc_we);
    axi_add_INST.b_rsc_q(TLS_b_rsc_q);
    axi_add_INST.b_rsc_triosy_lz(TLS_b_rsc_triosy_lz);
    axi_add_INST.complete_rsc_rdy(TLS_complete_rsc_rdy);
    axi_add_INST.complete_rsc_vld(TLS_complete_rsc_vld);
...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_axi_add_core_inst_axi_add_core_complete_rsci_inst_axi_add_core_complete_rsci_complete_wait_ctrl_inst_complete_rsci_ivld_core_sct,
      /scverify_top/rtl/axi_add_core_inst/axi_add_core_complete_rsci_inst/axi_add_core_complete_rsci_complete_wait_ctrl_inst/complete_rsci_ivld_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_axi_add_core_inst_axi_add_core_complete_rsci_inst_axi_add_core_complete_rsci_complete_wait_ctrl_inst_complete_rsci_irdy,
      /scverify_top/rtl/axi_add_core_inst/axi_add_core_complete_rsci_inst/axi_add_core_complete_rsci_complete_wait_ctrl_inst/complete_rsci_irdy);
