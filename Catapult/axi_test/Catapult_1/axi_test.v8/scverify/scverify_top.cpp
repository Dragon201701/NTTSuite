...
#include "/opt/mentorgraphics/Catapult_10.5c/Mgc_home/pkgs/ccs_xilinx/hdl/BLOCK_SPRAM_RBW_trans_rsc.h"
#include "/opt/mentorgraphics/Catapult_10.5c/Mgc_home/pkgs/ccs_xilinx/hdl/BLOCK_SPRAM_WBR_trans_rsc.h"
...
public:
  ...
  BLOCK_SPRAM_RBW_trans_rsc<4,32,16 >                                         a_rsc_INST;
  BLOCK_SPRAM_WBR_trans_rsc<4,32,16 >                                         b_rsc_INST;
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    axi_test_INST.a_rsc_adr(TLS_a_rsc_adr);
    axi_test_INST.a_rsc_d(TLS_a_rsc_d);
    axi_test_INST.a_rsc_we(TLS_a_rsc_we);
    axi_test_INST.a_rsc_q(TLS_a_rsc_q);
    axi_test_INST.a_rsc_triosy_lz(TLS_a_rsc_triosy_lz);
    axi_test_INST.b_rsc_adr(TLS_b_rsc_adr);
    axi_test_INST.b_rsc_d(TLS_b_rsc_d);
    axi_test_INST.b_rsc_we(TLS_b_rsc_we);
    axi_test_INST.b_rsc_q(TLS_b_rsc_q);
    ...
    a_rsc_INST.clk(clk);
    a_rsc_INST.clken(SIG_SC_LOGIC_1);
    ...
    b_rsc_INST.clk(clk);
    b_rsc_INST.clken(SIG_SC_LOGIC_1);
