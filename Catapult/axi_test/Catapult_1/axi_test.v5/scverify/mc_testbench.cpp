...
// Generated date: Sun Jan 02 21:05:23 EST 2022
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void axi_test( ac_sync &run,  ac_int<32, false > a[16],  ac_int<32, false > b[16],  ac_sync &complete);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_axi_test( ac_sync &run,  ac_int<32, false > a[16],  ac_int<32, false > b[16],  ac_sync &complete) {
   return mc_testbench::exec_axi_test(run, a, b, complete);
}
#endif
...
void mc_testbench::exec_axi_test( ac_sync &run,  ac_int<32, false > a[16],  ac_int<32, false > b[16],  ac_sync &complete)
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(run, a, b, complete);
   axi_test(run, a, b, complete);
