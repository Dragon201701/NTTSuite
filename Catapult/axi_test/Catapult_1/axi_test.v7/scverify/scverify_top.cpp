...
public:
  ...
  sc_signal<sc_lv<4> >                                                        TLS_b_rsc_adra;
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_da;
  sc_signal<sc_logic>                                                         TLS_b_rsc_wea;
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_qa;
  sc_signal<sc_lv<4> >                                                        TLS_b_rsc_adrb;
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_db;
  sc_signal<sc_logic>                                                         TLS_b_rsc_web;
  sc_signal<sc_lv<32> >                                                       TLS_b_rsc_qb;
  ...
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<4,32,16 >                                    b_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_b_rsc_adra("TLS_b_rsc_adra")
    , TLS_b_rsc_da("TLS_b_rsc_da")
    , TLS_b_rsc_wea("TLS_b_rsc_wea")
    , TLS_b_rsc_qa("TLS_b_rsc_qa")
    , TLS_b_rsc_adrb("TLS_b_rsc_adrb")
    , TLS_b_rsc_db("TLS_b_rsc_db")
    , TLS_b_rsc_web("TLS_b_rsc_web")
    , TLS_b_rsc_qb("TLS_b_rsc_qb")
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    axi_test_INST.b_rsc_adra(TLS_b_rsc_adra);
    axi_test_INST.b_rsc_da(TLS_b_rsc_da);
    axi_test_INST.b_rsc_wea(TLS_b_rsc_wea);
    axi_test_INST.b_rsc_qa(TLS_b_rsc_qa);
    axi_test_INST.b_rsc_adrb(TLS_b_rsc_adrb);
    axi_test_INST.b_rsc_db(TLS_b_rsc_db);
    axi_test_INST.b_rsc_web(TLS_b_rsc_web);
    axi_test_INST.b_rsc_qb(TLS_b_rsc_qb);
    ...
    b_rsc_INST.qb(TLS_b_rsc_qb);
    b_rsc_INST.web(TLS_b_rsc_web);
    b_rsc_INST.db(TLS_b_rsc_db);
    b_rsc_INST.adrb(TLS_b_rsc_adrb);
    b_rsc_INST.qa(TLS_b_rsc_qa);
    b_rsc_INST.wea(TLS_b_rsc_wea);
    b_rsc_INST.da(TLS_b_rsc_da);
    b_rsc_INST.adra(TLS_b_rsc_adra);
    b_rsc_INST.clka(clk);
    b_rsc_INST.clka_en(SIG_SC_LOGIC_1);
    b_rsc_INST.clkb(clk);
    b_rsc_INST.clkb_en(SIG_SC_LOGIC_1);
