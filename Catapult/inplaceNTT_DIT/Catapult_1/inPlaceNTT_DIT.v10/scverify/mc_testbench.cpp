...
// Generated date: Thu Aug 05 00:25:00 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void inPlaceNTT_DIT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_inPlaceNTT_DIT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r) {
...
void mc_testbench::exec_inPlaceNTT_DIT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r)
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(vec, p, r);
