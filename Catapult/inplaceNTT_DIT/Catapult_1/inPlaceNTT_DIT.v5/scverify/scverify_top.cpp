...
public:
  ...
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_adr;
  ...
  BLOCK_SPRAM_RBW_trans_rsc<10,64,1024 >                                       vec_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_rst("TLS_rst")
    , TLS_vec_rsc_adr("TLS_vec_rsc_adr")
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    inPlaceNTT_DIT_INST.vec_rsc_adr(TLS_vec_rsc_adr);
    inPlaceNTT_DIT_INST.vec_rsc_d(TLS_vec_rsc_d);
    inPlaceNTT_DIT_INST.vec_rsc_we(TLS_vec_rsc_we);
    inPlaceNTT_DIT_INST.vec_rsc_q(TLS_vec_rsc_q);
    ...
    vec_rsc_INST.adr(TLS_vec_rsc_adr);
