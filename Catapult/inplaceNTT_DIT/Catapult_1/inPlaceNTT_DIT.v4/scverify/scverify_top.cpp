...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 221807, 221807, 0)
    , catapult_monitor_INST("Monitor", clk, true, 221807LL, 221807LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    inPlaceNTT_DIT_INST.vec_rsc_adra(TLS_vec_rsc_adra);
    inPlaceNTT_DIT_INST.vec_rsc_da(TLS_vec_rsc_da);
    inPlaceNTT_DIT_INST.vec_rsc_wea(TLS_vec_rsc_wea);
    inPlaceNTT_DIT_INST.vec_rsc_qa(TLS_vec_rsc_qa);
    inPlaceNTT_DIT_INST.vec_rsc_adrb(TLS_vec_rsc_adrb);
    inPlaceNTT_DIT_INST.vec_rsc_db(TLS_vec_rsc_db);
    inPlaceNTT_DIT_INST.vec_rsc_web(TLS_vec_rsc_web);
    inPlaceNTT_DIT_INST.vec_rsc_qb(TLS_vec_rsc_qb);
    inPlaceNTT_DIT_INST.vec_rsc_triosy_lz(TLS_vec_rsc_triosy_lz);
