...
public:
  ...
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          vec_rsc_0__0__INST;
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          vec_rsc_0__1__INST;
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          vec_rsc_0__2__INST;
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          vec_rsc_0__3__INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 219620, 219620, 0)
    , catapult_monitor_INST("Monitor", clk, true, 219620LL, 219620LL)
