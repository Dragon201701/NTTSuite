...
public:
  ...
  sc_signal<sc_lv<11> >                                                        TLS_vec_rsc_0_0_adra;
  ...
  sc_signal<sc_lv<11> >                                                        TLS_vec_rsc_0_1_adra;
  ...
  sc_signal<sc_lv<11> >                                                        TLS_vec_rsc_0__0__adrb;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_0__0__qb;
  BLOCK_2R1W_RBW_DUAL_trans_rsc<11,64,2048 >                                   vec_rsc_0__0__INST;
  sc_signal<sc_lv<11> >                                                        TLS_vec_rsc_0__1__adrb;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_0__1__qb;
  BLOCK_2R1W_RBW_DUAL_trans_rsc<11,64,2048 >                                   vec_rsc_0__1__INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 516296, 516296, 0)
    , catapult_monitor_INST("Monitor", clk, true, 516296LL, 516296LL)
