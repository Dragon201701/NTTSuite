...
go libraries
directive set -CLOCKS {clk {-CLOCK_PERIOD 12.5 -CLOCK_EDGE rising -CLOCK_UNCERTAINTY 0.0 -CLOCK_HIGH_TIME 6.25 -RESET_SYNC_NAME rst -RESET_ASYNC_NAME arst_n -RESET_KIND sync -RESET_SYNC_ACTIVE high -RESET_ASYNC_ACTIVE low -ENABLE_ACTIVE high}}
go assembly
directive set -SCHED_USE_MULTICYCLE true
directive set /inPlaceNTT_DIT/core/COMP_LOOP -PIPELINE_INIT_INTERVAL 0
directive set /inPlaceNTT_DIT/core/modExp#1:while -PIPELINE_INIT_INTERVAL 0
directive set /inPlaceNTT_DIT/core/modExp:while -PIPELINE_INIT_INTERVAL 0
directive set /inPlaceNTT_DIT/vec:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_2R1W_RBW_DUAL
directive set /inPlaceNTT_DIT/core/STAGE_LOOP -PIPELINE_INIT_INTERVAL 0
directive set /inPlaceNTT_DIT/core/VEC_LOOP -PIPELINE_INIT_INTERVAL 0
directive set /inPlaceNTT_DIT/core/COMP_LOOP -UNROLL 2
directive set /inPlaceNTT_DIT/vec:rsc -INTERLEAVE 4
directive set /inPlaceNTT_DIT/core/VEC_LOOP -UNROLL 2
directive set /inPlaceNTT_DIT/vec:rsc -BLOCK_SIZE 1024
go architect
go extract
