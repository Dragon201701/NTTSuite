...
library set /LIBS/mgc_Xilinx-VIRTEX-7-2_beh/MODS/mgc_div/PARAMETERS/width_a -- -CHAR_RANGE {4 to 16, 68}
library set /LIBS/mgc_Xilinx-VIRTEX-7-2_beh/MODS/mgc_rem/PARAMETERS/width_a -- -CHAR_RANGE {4 to 16, 64}
library set /LIBS/mgc_Xilinx-VIRTEX-7-2_beh/MODS/mgc_rem/PARAMETERS/width_b -- -CHAR_RANGE {4 to 16, 64}
library set /LIBS/mgc_Xilinx-VIRTEX-7-2_beh/MODS/mgc_mux1hot/PARAMETERS/width -- -CHAR_RANGE {4 to 32, 68}
