...
public:
  ...
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_0_0_adra;
  ...
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_0_1_adra;
  ...
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_0_2_adra;
  ...
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_0_3_adra;
  ...
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_0__0__adrb;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_0__0__qb;
  BLOCK_2R1W_RBW_DUAL_trans_rsc<10,64,1024 >                                   vec_rsc_0__0__INST;
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_0__1__adrb;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_0__1__qb;
  BLOCK_2R1W_RBW_DUAL_trans_rsc<10,64,1024 >                                   vec_rsc_0__1__INST;
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_0__2__adrb;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_0__2__qb;
  BLOCK_2R1W_RBW_DUAL_trans_rsc<10,64,1024 >                                   vec_rsc_0__2__INST;
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_0__3__adrb;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_0__3__qb;
  BLOCK_2R1W_RBW_DUAL_trans_rsc<10,64,1024 >                                   vec_rsc_0__3__INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , CCS_CLK_CTOR(clk, "clk", 11.63, SC_NS, 0.5, 0, SC_NS, false)
    , rst_driver("rst_driver", 127.930000, false)
    , TLS_rst("TLS_rst")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 498548, 498548, 0)
    , catapult_monitor_INST("Monitor", clk, true, 498548LL, 498548LL)
...
void scverify_top::generate_reset() {
  ...
  if (activate_reset || sc_time_stamp() == SC_ZERO_TIME) {
    ...
    generate_reset_event.notify(127.930000 , SC_NS);
  } else {
    if (toggle_hw_reset) {
