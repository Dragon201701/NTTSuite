...
// Generated date: Mon May 17 21:39:18 EDT 2021
//
// ----------------------------------------------------------------------------
#ifdef CCS_SCVERIFY
...
public:
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_int<64, false >,4096> , MaskPacket< 0, 64 > > *vec_comp;
   
   // Interface Ports
   sc_in< bool > clk;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<64, false >,4096> > > ccs_vec_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_vec_IN;
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_int<64, false >,4096> > > ccs_vec;
   ...
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_int<64, false >,4096>, MaskPacket<0, 64> > > vec_golden;
   bool _capture_vec;
      ...
      , vec_golden("vec_golden",-1)
   {
      ...
      vec_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_int<64, false >,4096> , MaskPacket< 0, 64 > > (
         "vec_comp",
         "vec",
         0,
         0,
   ...
   public:
      void reset_request() ;
   public:
      void capture_vec_IN( ac_int<64, false > vec[4096]) ;
   public:
   ...
   public:
      static void capture_IN( ac_int<64, false > vec[4096], ac_int<64, false > p, ac_int<64, false > r) ;
   public:
      static void capture_OUT( ac_int<64, false > vec[4096], ac_int<64, false > p, ac_int<64, false > r) ;
   public:
      static void exec_inPlaceNTT_DIT( ac_int<64, false > vec[4096], ac_int<64, false > p, ac_int<64, false > r) ;
   protected:
