...
//  Generated date: Fri Sep 10 00:39:57 2021
// ----------------------------------------------------------------------
...
module peaseNTT_core (
  ...
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      INNER_LOOP3_stage_0 <= ~((~(INNER_LOOP3_stage_0 & (~ (z_out_9[7])))) & (fsm_output[5]));
      INNER_LOOP3_r_9_2_sva_6_0 <= MUX_v_7_2_2(7'b0000000, (z_out_9[6:0]), (fsm_output[5]));
  ...
  always @(posedge clk) begin
    ...
    else if ( core_wen & ((INNER_LOOP3_stage_0 & (~ (z_out_9[7]))) | and_dcpl_48)
        ) begin
      INNER_LOOP3_r_slc_INNER_LOOP3_r_9_2_6_0_44_itm <= (z_out_9[0]) & (fsm_output[5]);
    end
  end
  always @(posedge clk) begin
  ...
  assign operator_20_false_mux1h_2_nl = MUX1HOT_v_7_4_2(INNER_LOOP1_r_9_2_sva_6_0,
      INNER_LOOP2_r_9_2_sva_6_0, INNER_LOOP3_r_9_2_sva_6_0, INNER_LOOP4_r_9_2_sva_6_0,
      {(fsm_output[2]) , (fsm_output[4]) , (fsm_output[5]) , (fsm_output[6])});
