...
go libraries
directive set -CLOCKS {clk {-CLOCK_PERIOD 5.13 -CLOCK_EDGE rising -CLOCK_UNCERTAINTY 0.0 -CLOCK_HIGH_TIME 2.565 -RESET_SYNC_NAME rst -RESET_ASYNC_NAME arst_n -RESET_KIND sync -RESET_SYNC_ACTIVE high -RESET_ASYNC_ACTIVE low -ENABLE_ACTIVE high}}
go assembly
directive set /peaseNTT/core/INNER_LOOP2 -MERGEABLE false
directive set /peaseNTT/core/INNER_LOOP1 -MERGEABLE false
...
directive set /peaseNTT/xt:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_2R1W_RBW
directive set /peaseNTT/xt:rsc -INTERLEAVE 8
directive set /peaseNTT/core/yt:rsc -INTERLEAVE 8
directive set /peaseNTT/twiddle:rsc -MAP_TO_MODULE amba.ccs_axi4_slave_mem
directive set /peaseNTT/twiddle_h:rsc -MAP_TO_MODULE amba.ccs_axi4_slave_mem
directive set /peaseNTT/core/STAGE_LOOP -MERGEABLE false
directive set /peaseNTT/twiddle:rsc -INTERLEAVE 4
directive set /peaseNTT/twiddle_h:rsc -INTERLEAVE 4
directive set /peaseNTT/core/yt:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_2R1W_RBW_DUAL
...
directive set /peaseNTT/core/yt:rsc -BLOCK_SIZE 1024
directive set /peaseNTT/xt:rsc -BLOCK_SIZE 1024
go architect
go schedule
