...
public:
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,16384> , MaskPacket< 0, 32 > > *xt_comp;
   
   // Interface Ports
   sc_in< bool > clk;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,16384> > > ccs_xt_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_xt_IN;
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_int<32, false >,16384> > > ccs_xt;
   ...
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,16384>, MaskPacket<0, 32> > > xt_golden;
   bool _capture_xt;
      ...
      , xt_golden("xt_golden",-1)
   {
      ...
      xt_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,16384> , MaskPacket< 0, 32 > > (
         "xt_comp",
         "xt",
         0,
         0,
   ...
   public:
      void reset_request() ;
   public:
      void capture_xt_IN( ac_int<32, false > xt[16384]) ;
   public:
      void capture_xt( ac_int<32, false > xt[16384]) ;
   public:
   ...
   public:
      static void capture_IN( ac_int<32, false > xt[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384]) ;
   public:
      static void capture_OUT( ac_int<32, false > xt[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384]) ;
   public:
      static void exec_peaseNTT( ac_int<32, false > xt[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384]) ;
   protected:
