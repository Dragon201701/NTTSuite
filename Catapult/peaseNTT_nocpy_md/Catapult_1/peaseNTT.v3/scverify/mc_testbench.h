...
// Generated date: Fri Sep 10 09:48:29 EDT 2021
//
// ----------------------------------------------------------------------------
#ifdef CCS_SCVERIFY
...
public:
   ...
   public:
      static void capture_IN( ac_int<32, false > xt[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096]) ;
   public:
      static void capture_OUT( ac_int<32, false > xt[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096]) ;
   public:
      static void exec_peaseNTT( ac_int<32, false > xt[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096]) ;
   protected:
