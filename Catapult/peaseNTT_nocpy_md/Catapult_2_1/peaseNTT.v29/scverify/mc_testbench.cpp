...
// Generated date: Sun Sep 12 02:32:09 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_peaseNTT( ac_int<32, false > xt[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024]) {
...
void mc_testbench::capture_IN( ac_int<32, false > xt[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024])
{
...
void mc_testbench::capture_OUT( ac_int<32, false > xt[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024])
{
   that->capture_xt(xt);
}
// ============================================
...
void mc_testbench::exec_peaseNTT( ac_int<32, false > xt[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
