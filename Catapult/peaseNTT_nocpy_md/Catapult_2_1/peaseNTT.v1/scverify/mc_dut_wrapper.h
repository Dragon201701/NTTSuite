...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_in<sc_logic> xt_rsc_s_tdone;
  sc_in<sc_logic> xt_rsc_tr_write_done;
  sc_in<sc_logic> xt_rsc_RREADY;
  sc_out<sc_logic> xt_rsc_RVALID;
  sc_out<sc_logic> xt_rsc_RUSER;
  sc_out<sc_logic> xt_rsc_RLAST;
  sc_out<sc_lv<2> > xt_rsc_RRESP;
  sc_out<sc_lv<32> > xt_rsc_RDATA;
  sc_out<sc_logic> xt_rsc_RID;
  sc_out<sc_logic> xt_rsc_ARREADY;
  sc_in<sc_logic> xt_rsc_ARVALID;
  sc_in<sc_logic> xt_rsc_ARUSER;
  sc_in<sc_lv<4> > xt_rsc_ARREGION;
  sc_in<sc_lv<4> > xt_rsc_ARQOS;
  sc_in<sc_lv<3> > xt_rsc_ARPROT;
  sc_in<sc_lv<4> > xt_rsc_ARCACHE;
  sc_in<sc_logic> xt_rsc_ARLOCK;
  sc_in<sc_lv<2> > xt_rsc_ARBURST;
  sc_in<sc_lv<3> > xt_rsc_ARSIZE;
  sc_in<sc_lv<8> > xt_rsc_ARLEN;
  sc_in<sc_lv<12> > xt_rsc_ARADDR;
  sc_in<sc_logic> xt_rsc_ARID;
  sc_in<sc_logic> xt_rsc_BREADY;
  sc_out<sc_logic> xt_rsc_BVALID;
  sc_out<sc_logic> xt_rsc_BUSER;
  sc_out<sc_lv<2> > xt_rsc_BRESP;
  sc_out<sc_logic> xt_rsc_BID;
  sc_out<sc_logic> xt_rsc_WREADY;
  sc_in<sc_logic> xt_rsc_WVALID;
  sc_in<sc_logic> xt_rsc_WUSER;
  sc_in<sc_logic> xt_rsc_WLAST;
  sc_in<sc_lv<4> > xt_rsc_WSTRB;
  sc_in<sc_lv<32> > xt_rsc_WDATA;
  sc_out<sc_logic> xt_rsc_AWREADY;
  sc_in<sc_logic> xt_rsc_AWVALID;
  sc_in<sc_logic> xt_rsc_AWUSER;
  sc_in<sc_lv<4> > xt_rsc_AWREGION;
  sc_in<sc_lv<4> > xt_rsc_AWQOS;
  sc_in<sc_lv<3> > xt_rsc_AWPROT;
  sc_in<sc_lv<4> > xt_rsc_AWCACHE;
  sc_in<sc_logic> xt_rsc_AWLOCK;
  sc_in<sc_lv<2> > xt_rsc_AWBURST;
  sc_in<sc_lv<3> > xt_rsc_AWSIZE;
  sc_in<sc_lv<8> > xt_rsc_AWLEN;
  sc_in<sc_lv<12> > xt_rsc_AWADDR;
  sc_in<sc_logic> xt_rsc_AWID;
