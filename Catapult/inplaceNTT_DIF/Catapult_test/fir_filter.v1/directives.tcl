...
solution options set /Flows/SCVerify/INVOKE_ARGS {/opt/mentorgraphics/Catapult_10.5c/Mgc_home/shared/training/ondemand/module4/coefficients.csv /opt/mentorgraphics/Catapult_10.5c/Mgc_home/shared/training/ondemand/module4/samples.csv /opt/mentorgraphics/Catapult_10.5c/Mgc_home/shared/training/ondemand/module4/filter_output.csv}
solution file add {$MGC_HOME/shared/training/ondemand/module4/src/fir_filter.cpp} -type C++
solution file add {$MGC_HOME/shared/training/ondemand/module4/src/fir_filter_tb.cpp} -type C++ -exclude true
solution file add {$MGC_HOME/shared/training/ondemand/module4/src/csvparser.cpp} -type C++ -exclude true
