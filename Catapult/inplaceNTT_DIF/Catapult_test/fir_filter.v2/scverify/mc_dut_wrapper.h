...
public:
  ...
  sc_in<sc_logic> b_rsc_s_tdone;
  sc_in<sc_logic> b_rsc_tr_write_done;
  sc_in<sc_logic> b_rsc_RREADY;
  sc_out<sc_logic> b_rsc_RVALID;
  sc_out<sc_logic> b_rsc_RUSER;
  sc_out<sc_logic> b_rsc_RLAST;
  sc_out<sc_lv<2> > b_rsc_RRESP;
  sc_out<sc_lv<16> > b_rsc_RDATA;
  sc_out<sc_logic> b_rsc_RID;
  sc_out<sc_logic> b_rsc_ARREADY;
  sc_in<sc_logic> b_rsc_ARVALID;
  sc_in<sc_logic> b_rsc_ARUSER;
  sc_in<sc_lv<4> > b_rsc_ARREGION;
  sc_in<sc_lv<4> > b_rsc_ARQOS;
  sc_in<sc_lv<3> > b_rsc_ARPROT;
  sc_in<sc_lv<4> > b_rsc_ARCACHE;
  sc_in<sc_logic> b_rsc_ARLOCK;
  sc_in<sc_lv<2> > b_rsc_ARBURST;
  sc_in<sc_lv<3> > b_rsc_ARSIZE;
  sc_in<sc_lv<8> > b_rsc_ARLEN;
  sc_in<sc_lv<12> > b_rsc_ARADDR;
  sc_in<sc_logic> b_rsc_ARID;
  sc_in<sc_logic> b_rsc_BREADY;
  sc_out<sc_logic> b_rsc_BVALID;
  sc_out<sc_logic> b_rsc_BUSER;
  sc_out<sc_lv<2> > b_rsc_BRESP;
  sc_out<sc_logic> b_rsc_BID;
  sc_out<sc_logic> b_rsc_WREADY;
  sc_in<sc_logic> b_rsc_WVALID;
  sc_in<sc_logic> b_rsc_WUSER;
  sc_in<sc_logic> b_rsc_WLAST;
  sc_in<sc_lv<2> > b_rsc_WSTRB;
  sc_in<sc_lv<16> > b_rsc_WDATA;
  sc_out<sc_logic> b_rsc_AWREADY;
  sc_in<sc_logic> b_rsc_AWVALID;
  sc_in<sc_logic> b_rsc_AWUSER;
  sc_in<sc_lv<4> > b_rsc_AWREGION;
  sc_in<sc_lv<4> > b_rsc_AWQOS;
  sc_in<sc_lv<3> > b_rsc_AWPROT;
  sc_in<sc_lv<4> > b_rsc_AWCACHE;
  sc_in<sc_logic> b_rsc_AWLOCK;
  sc_in<sc_lv<2> > b_rsc_AWBURST;
  sc_in<sc_lv<3> > b_rsc_AWSIZE;
  sc_in<sc_lv<8> > b_rsc_AWLEN;
  sc_in<sc_lv<12> > b_rsc_AWADDR;
  sc_in<sc_logic> b_rsc_AWID;
