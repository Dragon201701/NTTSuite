...
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/COMP_LOOP-5:mul.itm REGISTER_NAME COMP_LOOP-1:modExp_dev#1:while:mul.mut
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/COMP_LOOP-6:mul.itm REGISTER_NAME COMP_LOOP-1:modExp_dev#1:while:mul.mut
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/COMP_LOOP-7:mul.itm REGISTER_NAME COMP_LOOP-1:modExp_dev#1:while:mul.mut
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/COMP_LOOP-8:mul.itm REGISTER_NAME COMP_LOOP-1:modExp_dev#1:while:mul.mut
...
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/COMP_LOOP:COMP_LOOP:and#11.itm REGISTER_NAME COMP_LOOP-2:operator<<64,false>:slc(operator<<64,false>:acc)(63).itm
