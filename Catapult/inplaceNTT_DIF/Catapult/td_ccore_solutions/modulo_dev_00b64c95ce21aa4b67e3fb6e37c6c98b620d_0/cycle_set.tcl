...
directive set /modulo_dev/core/core:rlp/main CSTEPS_FROM {{. == 14} {.. == 0}}
...
directive set /modulo_dev/core/core:rlp/main/io_write(return:rsc.@) CSTEPS_FROM {{.. == 13}}

# Sync operation constraints

# Real operation constraints
directive set /modulo_dev/core/core:rlp/main/rem CSTEPS_FROM {{.. == 1}}
directive set /modulo_dev/core/core:rlp/main/qelse:acc CSTEPS_FROM {{.. == 13}}
directive set /modulo_dev/core/core:rlp/main/mux#2 CSTEPS_FROM {{.. == 13}}
