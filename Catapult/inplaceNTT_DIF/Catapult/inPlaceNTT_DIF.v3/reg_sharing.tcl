...
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#1.sva(8:1) REGISTER_NAME modExp_dev:exp#1.sva(8:1)
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#2.sva(8:1) REGISTER_NAME modExp_dev:exp#1.sva(8:1)
