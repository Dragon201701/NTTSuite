...
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#1.sva(8:2) REGISTER_NAME COMP_LOOP:acc.psp.sva
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#2.sva(8:2) REGISTER_NAME COMP_LOOP:acc.psp.sva
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#3.sva(8:2) REGISTER_NAME COMP_LOOP:acc.psp.sva
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#4.sva(8:2) REGISTER_NAME COMP_LOOP:acc.psp.sva
...
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/COMP_LOOP-3:mul.itm REGISTER_NAME COMP_LOOP-1:modExp_dev#1:while:mul.mut
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/COMP_LOOP-4:mul.itm REGISTER_NAME COMP_LOOP-1:modExp_dev#1:while:mul.mut
...
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/tmp#4.lpi#4.dfm REGISTER_NAME tmp#2.lpi#4.dfm
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/tmp#6.lpi#4.dfm REGISTER_NAME tmp#2.lpi#4.dfm
...
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/operator<<64,false>:slc(operator<<64,false>:acc)(61).itm REGISTER_NAME operator<<64,false>:slc(operator<<64,false>:acc)(61).itm
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/operator><64,false>#1:slc(operator><64,false>#1:acc)(7).itm REGISTER_NAME operator<<64,false>:slc(operator<<64,false>:acc)(61).itm
...
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#1.sva(1:0) REGISTER_NAME modExp_dev:exp#1.sva(1:0)
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#2.sva(1:0) REGISTER_NAME modExp_dev:exp#1.sva(1:0)
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#3.sva(1:0) REGISTER_NAME modExp_dev:exp#1.sva(1:0)
directive set /inPlaceNTT_DIF/inPlaceNTT_DIF:core/core/modExp_dev:exp#4.sva(1:0) REGISTER_NAME modExp_dev:exp#1.sva(1:0)
