...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                      := /opt/mentorgraphics/modelsimSE106/modeltech/linux_x86_64
...
ifeq "$(SynplifyPro_SynthesisFlowType)" ""
SynplifyPro_SynthesisFlowType                       := fpga
export SynplifyPro_SynthesisFlowType
endif
ifeq "$(SynplifyPro_FlowSuffix)" ""
SynplifyPro_FlowSuffix                              := sp
export SynplifyPro_FlowSuffix
endif
ifeq "$(SynplifyPro_Path)" ""
SynplifyPro_Path                                    := 
export SynplifyPro_Path
endif
ifeq "$(SynplifyPro_ShellPrefix)" ""
SynplifyPro_ShellPrefix                             := 
export SynplifyPro_ShellPrefix
endif
ifeq "$(SynplifyPro_ShellExe)" ""
SynplifyPro_ShellExe                                := synplify_pro
export SynplifyPro_ShellExe
endif
ifeq "$(SynplifyPro_Flags)" ""
SynplifyPro_Flags                                   := 
export SynplifyPro_Flags
endif
ifeq "$(SynplifyPro_SYNPLIFY_HOME)" ""
SynplifyPro_SYNPLIFY_HOME                           := can't read "SYNPLIFY_HOME": no such variable
export SynplifyPro_SYNPLIFY_HOME
endif
ifeq "$(SynplifyPro_DISABLE_IO)" ""
SynplifyPro_DISABLE_IO                              := true
export SynplifyPro_DISABLE_IO
endif
ifeq "$(SynplifyPro_TimingReportingMode)" ""
SynplifyPro_TimingReportingMode                     := p2p
export SynplifyPro_TimingReportingMode
endif
ifeq "$(SynplifyPro_CustomScriptDirPath)" ""
SynplifyPro_CustomScriptDirPath                     := 
export SynplifyPro_CustomScriptDirPath
endif
ifeq "$(SynplifyPro_EnableRetiming)" ""
SynplifyPro_EnableRetiming                          := false
export SynplifyPro_EnableRetiming
endif
ifeq "$(SynplifyPro_LicenseWait)" ""
SynplifyPro_LicenseWait                             := false
export SynplifyPro_LicenseWait
endif
ifeq "$(SynplifyPro_ALLOW_MCP)" ""
SynplifyPro_ALLOW_MCP                               := false
export SynplifyPro_ALLOW_MCP
endif
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                          := /opt/mentorgraphics/modelsimSE106/modeltech/linux_x86_64
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                           := 
