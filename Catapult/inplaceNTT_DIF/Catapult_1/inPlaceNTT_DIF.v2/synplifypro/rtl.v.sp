...
# Quartus version 
   ...
   add_file -verilog $CATAPULT_HOME/pkgs/siflibs/mgc_io_sync_v2.v
   ...
   add_file -verilog ../../td_ccore_solutions/modulo_dev_78878aed0de3c5f55e010cb782736eec6212_0/rtl.v
   add_file -verilog $CATAPULT_HOME/pkgs/hls_pkgs/mgc_comps_src/mgc_div_beh.v
   add_file -verilog $CATAPULT_HOME/pkgs/siflibs/mgc_shift_l_beh_v5.v
   ...
   add_file -constraint ./rtl.v.sp.sdc
