...
# Quartus version 
   ...
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/siflibs/ccs_in_v1.vhd
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/siflibs/mgc_io_sync_v2.vhd
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/siflibs/mgc_out_dreg_v2.vhd
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/hls_pkgs/src/funcs.vhd
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/hls_pkgs/mgc_comps_src/mgc_comps.vhd
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/hls_pkgs/mgc_comps_src/mgc_rem_beh.vhd
   add_file -vhdl -lib work ../../td_ccore_solutions/modulo_dev_78878aed0de3c5f55e010cb782736eec6212_0/rtl.vhdl
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/hls_pkgs/mgc_comps_src/mgc_div_beh.vhd
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/siflibs/mgc_shift_comps_v5.vhd
   add_file -vhdl -lib mgc_hls $CATAPULT_HOME/pkgs/siflibs/mgc_shift_l_beh_v5.vhd
   add_file -vhdl -lib work ../rtl.vhdl

   # Source potential custom script
   source_custom_script analyze

   # SDC Timing Constraints
   add_file -constraint ./rtl.vhdl.sp.sdc
