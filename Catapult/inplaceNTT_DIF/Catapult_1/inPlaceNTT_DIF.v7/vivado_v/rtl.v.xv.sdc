...
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_4_wadr[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_4_d[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_4_we}]
...
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_5_wadr[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_5_d[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_5_we}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_5_radr[*]}]
set_input_delay -clock [get_clocks {clk}] 2.4 [get_ports {vec_rsc_0_5_q[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {vec_rsc_triosy_0_5_lz}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_6_wadr[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_6_d[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_6_we}]
...
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_7_wadr[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_7_d[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_7_we}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {vec_rsc_0_7_radr[*]}]
set_input_delay -clock [get_clocks {clk}] 2.4 [get_ports {vec_rsc_0_7_q[*]}]
