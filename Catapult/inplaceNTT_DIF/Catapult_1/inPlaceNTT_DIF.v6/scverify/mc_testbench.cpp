...
// Generated date: Tue Jul 27 16:03:59 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void inPlaceNTT_DIF( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_inPlaceNTT_DIF( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r) {
   return mc_testbench::exec_inPlaceNTT_DIF(vec, p, r);
}
#endif
...
void mc_testbench::capture_IN( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r)
{
...
void mc_testbench::capture_OUT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r)
{
...
void mc_testbench::exec_inPlaceNTT_DIF( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r)
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(vec, p, r);
   inPlaceNTT_DIF(vec, p, r);
