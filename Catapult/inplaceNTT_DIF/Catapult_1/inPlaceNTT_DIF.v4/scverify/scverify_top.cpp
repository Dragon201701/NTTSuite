...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 19634, 19634, 0)
    , catapult_monitor_INST("Monitor", clk, true, 19634LL, 19634LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    inPlaceNTT_DIF_INST.result_rsc_wadr(TLS_result_rsc_wadr);
    inPlaceNTT_DIF_INST.result_rsc_d(TLS_result_rsc_d);
    inPlaceNTT_DIF_INST.result_rsc_we(TLS_result_rsc_we);
    inPlaceNTT_DIF_INST.result_rsc_radr(TLS_result_rsc_radr);
    inPlaceNTT_DIF_INST.result_rsc_q(TLS_result_rsc_q);
    inPlaceNTT_DIF_INST.result_rsc_triosy_lz(TLS_result_rsc_triosy_lz);
