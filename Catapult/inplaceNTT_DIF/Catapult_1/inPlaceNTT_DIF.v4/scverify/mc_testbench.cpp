...
// Generated date: Wed Jun 09 00:32:57 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void inPlaceNTT_DIF( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_inPlaceNTT_DIF( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024]) {
   return mc_testbench::exec_inPlaceNTT_DIF(vec, p, r, result);
}
#endif
...
void mc_testbench::wait_on_input_required()
{
   ...
   while (atleast_one_active_input) {
      ...
      if (average_period > SC_ZERO_TIME && sc_time_stamp() != timeout)
         wait(average_period * 10, ccs_vec->ok_to_put() | ccs_p->ok_to_put() | ccs_r->ok_to_put() | ccs_result_IN->ok_to_put());
      else
         wait(ccs_vec->ok_to_put() | ccs_p->ok_to_put() | ccs_r->ok_to_put() | ccs_result_IN->ok_to_put());
      that->cpp_testbench_active.write(true);
      if (timed_out()) {
...
void mc_testbench::capture_IN( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024])
{
...
void mc_testbench::capture_OUT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024])
{
   that->capture_result(result);
}
// ============================================
// Function: exec_inPlaceNTT_DIF
// --------------------------------------------

void mc_testbench::exec_inPlaceNTT_DIF( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(vec, p, r, result);
   inPlaceNTT_DIF(vec, p, r, result);
