...
directive set /mult/core/core:rlp/main CSTEPS_FROM {{. == 6} {.. == 0}}
...
directive set /mult/core/core:rlp/main/VEC_LOOP:io_write(return:rsc.@) CSTEPS_FROM {{.. == 5}}
...
directive set /mult/core/core:rlp/main/z_:mul CSTEPS_FROM {{.. == 3}}
directive set /mult/core/core:rlp/main/res:acc CSTEPS_FROM {{.. == 5}}
directive set /mult/core/core:rlp/main/acc CSTEPS_FROM {{.. == 5}}
directive set /mult/core/core:rlp/main/if:acc CSTEPS_FROM {{.. == 5}}
directive set /mult/core/core:rlp/main/VEC_LOOP:mux#1 CSTEPS_FROM {{.. == 5}}
