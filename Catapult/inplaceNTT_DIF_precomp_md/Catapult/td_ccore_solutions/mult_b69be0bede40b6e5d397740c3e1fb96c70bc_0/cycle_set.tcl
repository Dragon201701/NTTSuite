...
directive set /mult/core/core:rlp/main CSTEPS_FROM {{. == 5} {.. == 0}}
...
directive set /mult/core/core:rlp/main/io_write(return:rsc.@) CSTEPS_FROM {{.. == 4}}
...
directive set /mult/core/core:rlp/main/res:acc CSTEPS_FROM {{.. == 4}}
directive set /mult/core/core:rlp/main/if:acc#1 CSTEPS_FROM {{.. == 4}}
directive set /mult/core/core:rlp/main/if:acc CSTEPS_FROM {{.. == 4}}
directive set /mult/core/core:rlp/main/mux#1 CSTEPS_FROM {{.. == 4}}
