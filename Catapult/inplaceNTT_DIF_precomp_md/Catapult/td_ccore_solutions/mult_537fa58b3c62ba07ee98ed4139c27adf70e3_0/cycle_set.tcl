...
directive set /mult/core/core:rlp/main CSTEPS_FROM {{. == 4} {.. == 0}}
...
directive set /mult/core/core:rlp/main/VEC_LOOP:io_write(return:rsc.@) CSTEPS_FROM {{.. == 3}}
...
directive set /mult/core/core:rlp/main/if:acc#1 CSTEPS_FROM {{.. == 2}}
directive set /mult/core/core:rlp/main/if:acc CSTEPS_FROM {{.. == 3}}
directive set /mult/core/core:rlp/main/VEC_LOOP:mux#1 CSTEPS_FROM {{.. == 3}}
