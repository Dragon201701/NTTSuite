...
directive set /inPlaceNTT_DIF_precomp/vec:rsc -INTERLEAVE 2
directive set /inPlaceNTT_DIF_precomp/twiddle:rsc -INTERLEAVE 2
directive set /inPlaceNTT_DIF_precomp/twiddle_h:rsc -INTERLEAVE 2
