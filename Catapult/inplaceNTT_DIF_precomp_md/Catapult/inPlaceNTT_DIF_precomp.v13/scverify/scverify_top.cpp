...
public:
  ...
  sc_signal<sc_lv<3> >                                                         TLS_vec_rsc_m_wstate;
  sc_signal<sc_logic>                                                          TLS_vec_rsc_m_wCaughtUp;
  ...
  sc_signal<sc_lv<32> >                                                        TLS_vec_rsc_ARADDR;
  ...
  sc_signal<sc_lv<32> >                                                        TLS_vec_rsc_AWADDR;
  ...
  ccs_sc_logic_to_sc_lv1_adapter                                               CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWID;
  sc_signal<sc_lv<1> >                                                         CCS_ADAPTOR_vec_rsc_AWUSER;
  ccs_sc_logic_to_sc_lv1_adapter                                               CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWUSER;
  sc_signal<sc_lv<1> >                                                         CCS_ADAPTOR_vec_rsc_WUSER;
  ccs_sc_logic_to_sc_lv1_adapter                                               CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_WUSER;
  sc_signal<sc_lv<1> >                                                         CCS_ADAPTOR_vec_rsc_BID;
  ccs_sc_lv1_to_sc_logic_adapter                                               CCS_ADAPTOR_TLS_vec_rsc_BID;
  sc_signal<sc_lv<1> >                                                         CCS_ADAPTOR_vec_rsc_BUSER;
  ccs_sc_lv1_to_sc_logic_adapter                                               CCS_ADAPTOR_TLS_vec_rsc_BUSER;
  sc_signal<sc_lv<1> >                                                         CCS_ADAPTOR_vec_rsc_ARID;
  ccs_sc_logic_to_sc_lv1_adapter                                               CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARID;
  sc_signal<sc_lv<1> >                                                         CCS_ADAPTOR_vec_rsc_ARUSER;
  ccs_sc_logic_to_sc_lv1_adapter                                               CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARUSER;
  sc_signal<sc_lv<1> >                                                         CCS_ADAPTOR_vec_rsc_RID;
  ccs_sc_lv1_to_sc_logic_adapter                                               CCS_ADAPTOR_TLS_vec_rsc_RID;
  sc_signal<sc_lv<1> >                                                         CCS_ADAPTOR_vec_rsc_RUSER;
  ccs_sc_lv1_to_sc_logic_adapter                                               CCS_ADAPTOR_TLS_vec_rsc_RUSER;
  ccs_axi4_master_trans_rsc<1024,32,32,10,0,0,0,32,32,1,1,1,0,0,0,0 >          vec_rsc_INST;
  ...
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_m_re_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_m_we_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_m_wrdy;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_m_rrdy;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_m_waddr_core_sct;
  sc_signal<sc_logic>                                                          OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_m_raddr_core_sct;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_vec_rsc_m_wstate("TLS_vec_rsc_m_wstate")
    , TLS_vec_rsc_m_wCaughtUp("TLS_vec_rsc_m_wCaughtUp")
    ...
    , CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWID("CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWID")
    , CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWUSER("CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWUSER")
    , CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_WUSER("CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_WUSER")
    , CCS_ADAPTOR_TLS_vec_rsc_BID("CCS_ADAPTOR_TLS_vec_rsc_BID")
    , CCS_ADAPTOR_TLS_vec_rsc_BUSER("CCS_ADAPTOR_TLS_vec_rsc_BUSER")
    , CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARID("CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARID")
    , CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARUSER("CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARUSER")
    , CCS_ADAPTOR_TLS_vec_rsc_RID("CCS_ADAPTOR_TLS_vec_rsc_RID")
    , CCS_ADAPTOR_TLS_vec_rsc_RUSER("CCS_ADAPTOR_TLS_vec_rsc_RUSER")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 112773, 112773, 0)
    , catapult_monitor_INST("Monitor", clk, true, 112773LL, 112773LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    inPlaceNTT_DIF_precomp_INST.vec_rsc_m_wstate(TLS_vec_rsc_m_wstate);
    inPlaceNTT_DIF_precomp_INST.vec_rsc_m_wCaughtUp(TLS_vec_rsc_m_wCaughtUp);
    ...
    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWID.inSCALAR(TLS_vec_rsc_AWID);
    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWID.outVECTOR(CCS_ADAPTOR_vec_rsc_AWID);

    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWUSER.inSCALAR(TLS_vec_rsc_AWUSER);
    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_AWUSER.outVECTOR(CCS_ADAPTOR_vec_rsc_AWUSER);

    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_WUSER.inSCALAR(TLS_vec_rsc_WUSER);
    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_WUSER.outVECTOR(CCS_ADAPTOR_vec_rsc_WUSER);

    CCS_ADAPTOR_TLS_vec_rsc_BID.inVECTOR(CCS_ADAPTOR_vec_rsc_BID);
    CCS_ADAPTOR_TLS_vec_rsc_BID.outSCALAR(TLS_vec_rsc_BID);

    CCS_ADAPTOR_TLS_vec_rsc_BUSER.inVECTOR(CCS_ADAPTOR_vec_rsc_BUSER);
    CCS_ADAPTOR_TLS_vec_rsc_BUSER.outSCALAR(TLS_vec_rsc_BUSER);

    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARID.inSCALAR(TLS_vec_rsc_ARID);
    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARID.outVECTOR(CCS_ADAPTOR_vec_rsc_ARID);

    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARUSER.inSCALAR(TLS_vec_rsc_ARUSER);
    CCS_ADAPTOR_CCS_ADAPTOR_vec_rsc_ARUSER.outVECTOR(CCS_ADAPTOR_vec_rsc_ARUSER);

    CCS_ADAPTOR_TLS_vec_rsc_RID.inVECTOR(CCS_ADAPTOR_vec_rsc_RID);
    CCS_ADAPTOR_TLS_vec_rsc_RID.outSCALAR(TLS_vec_rsc_RID);

    CCS_ADAPTOR_TLS_vec_rsc_RUSER.inVECTOR(CCS_ADAPTOR_vec_rsc_RUSER);
    CCS_ADAPTOR_TLS_vec_rsc_RUSER.outSCALAR(TLS_vec_rsc_RUSER);
    ...
    vec_rsc_INST.m_wCaughtUp(TLS_vec_rsc_m_wCaughtUp);
    vec_rsc_INST.m_wstate(TLS_vec_rsc_m_wstate);
    ...
    SC_METHOD(deadlock_watch);
      sensitive << clk;
      sensitive << OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_staller_inst_core_wen;
      dont_initialize();
...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_m_re_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_precomp_core_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_m_re_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_m_we_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_precomp_core_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_m_we_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_m_wrdy,
      /scverify_top/rtl/inPlaceNTT_DIF_precomp_core_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_m_wrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_m_rrdy,
      /scverify_top/rtl/inPlaceNTT_DIF_precomp_core_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_m_rrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_m_waddr_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_precomp_core_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_dp_inst/vec_rsci_m_waddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_inst_inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_m_raddr_core_sct,
      /scverify_top/rtl/inPlaceNTT_DIF_precomp_core_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_inst/inPlaceNTT_DIF_precomp_core_vec_rsci_vec_rsc_wait_dp_inst/vec_rsci_m_raddr_core_sct);
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      (OFS_inPlaceNTT_DIF_precomp_core_inst_inPlaceNTT_DIF_precomp_core_staller_inst_core_wen.read() == SC_LOGIC_0)
      && (OFS_run_rsc_vld.read() == SC_LOGIC_1)
      && (OFS_complete_rsc_rdy.read() == SC_LOGIC_1)
    ) {
      deadlocked.write(SC_LOGIC_1);
      deadlock_event.notify(10149130, SC_NS);
    } else {
