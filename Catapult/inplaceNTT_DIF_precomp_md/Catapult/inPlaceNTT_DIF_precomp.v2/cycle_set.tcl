...
directive set /inPlaceNTT_DIF_precomp/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/VEC_LOOP CSTEPS_FROM {{. == 7} {.. == 2}}
...
directive set /inPlaceNTT_DIF_precomp/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/VEC_LOOP/VEC_LOOP:write_mem(vec:rsc.@)#1 CSTEPS_FROM {{.. == 6}}
