...
public:
  ...
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<14,32,16384 >                                  vec_rsc_INST;
  ccs_in_trans_rsc_v1<1,32 >                                                    p_rsc_INST;
  ccs_in_trans_rsc_v1<1,32 >                                                    r_rsc_INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<14,32,16384 >                                  twiddle_rsc_INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<14,32,16384 >                                  twiddle_h_rsc_INST;
  ...
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<32, false >,16384> >                TLS_out_fifo_vec;
  tlm::tlm_fifo<mc_wait_ctrl>                                                   TLS_out_wait_ctrl_fifo_vec;
  mc_trios_inout_monitor                                                        trios_monitor_vec_rsc_triosy_lz_INST;
  mc_inout_transactor<mgc_sysc_ver_array1D<ac_int<32, false >,16384>,32,false>  transactor_vec;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 1865531, 1865531, 0)
    , catapult_monitor_INST("Monitor", clk, true, 1865531LL, 1865531LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    inPlaceNTT_DIF_precomp_INST.twiddle_rsc_adra(TLS_twiddle_rsc_adra);
    inPlaceNTT_DIF_precomp_INST.twiddle_rsc_da(TLS_twiddle_rsc_da);
    inPlaceNTT_DIF_precomp_INST.twiddle_rsc_wea(TLS_twiddle_rsc_wea);
    inPlaceNTT_DIF_precomp_INST.twiddle_rsc_qa(TLS_twiddle_rsc_qa);
    inPlaceNTT_DIF_precomp_INST.twiddle_rsc_adrb(TLS_twiddle_rsc_adrb);
    inPlaceNTT_DIF_precomp_INST.twiddle_rsc_db(TLS_twiddle_rsc_db);
    inPlaceNTT_DIF_precomp_INST.twiddle_rsc_web(TLS_twiddle_rsc_web);
    ...
    inPlaceNTT_DIF_precomp_INST.twiddle_h_rsc_adra(TLS_twiddle_h_rsc_adra);
    inPlaceNTT_DIF_precomp_INST.twiddle_h_rsc_da(TLS_twiddle_h_rsc_da);
    inPlaceNTT_DIF_precomp_INST.twiddle_h_rsc_wea(TLS_twiddle_h_rsc_wea);
    inPlaceNTT_DIF_precomp_INST.twiddle_h_rsc_qa(TLS_twiddle_h_rsc_qa);
    inPlaceNTT_DIF_precomp_INST.twiddle_h_rsc_adrb(TLS_twiddle_h_rsc_adrb);
    inPlaceNTT_DIF_precomp_INST.twiddle_h_rsc_db(TLS_twiddle_h_rsc_db);
    inPlaceNTT_DIF_precomp_INST.twiddle_h_rsc_web(TLS_twiddle_h_rsc_web);
