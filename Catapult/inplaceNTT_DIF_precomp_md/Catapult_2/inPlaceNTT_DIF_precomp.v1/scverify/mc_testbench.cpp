...
// Generated date: Mon Sep 13 22:39:33 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void inPlaceNTT_DIF_precomp( ac_sync &run,  ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_sync &complete);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_inPlaceNTT_DIF_precomp( ac_sync &run,  ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_sync &complete) {
   return mc_testbench::exec_inPlaceNTT_DIF_precomp(run, vec, p, r, twiddle, twiddle_h, complete);
}
#endif
...
void mc_testbench::capture_vec_IN( ac_int<32, false > vec[16384])
{
   ...
   if (_capture_vec_IN && !testbench::vec_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,16384> vec_IN_tmp;
...
void mc_testbench::capture_vec( ac_int<32, false > vec[16384])
{
   if (_capture_vec)
   {
      ...
      ++vec_iteration_count;
      mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,16384>, MaskPacket<0, 32> > vec_tmp(testbench::vec_ignore, false, vec_iteration_count);
      vec_tmp._data.mc_testbench_process_array_bounds("vec",testbench::vec_array_comp_first,testbench::vec_array_comp_last,16383,0);
...
void mc_testbench::capture_IN( ac_sync &run,  ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_sync &complete)
{
...
void mc_testbench::capture_OUT( ac_sync &run,  ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_sync &complete)
{
...
// ============================================
// Function: exec_inPlaceNTT_DIF_precomp
// --------------------------------------------

void mc_testbench::exec_inPlaceNTT_DIF_precomp( ac_sync &run,  ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_sync &complete)
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(run, vec, p, r, twiddle, twiddle_h, complete);
   inPlaceNTT_DIF_precomp(run, vec, p, r, twiddle, twiddle_h, complete);
