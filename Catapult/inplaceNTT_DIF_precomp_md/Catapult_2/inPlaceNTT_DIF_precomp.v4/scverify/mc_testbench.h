...
public:
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,16384> , MaskPacket< 0, 32 > > *vec_comp;
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,16384> > > ccs_vec_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_vec_IN;
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_int<32, false >,16384> > > ccs_vec;
   ...
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,16384>, MaskPacket<0, 32> > > vec_golden;
   bool _capture_vec;
      ...
      , complete_golden("complete_golden",-1)
   {
      ...
      vec_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,16384> , MaskPacket< 0, 32 > > (
         "vec_comp",
         "vec",
         0,
         0,
   ...
   public:
      void capture_vec_IN( ac_int<32, false > vec[16384]) ;
   public:
   ...
   public:
      static void capture_IN( ac_sync &run,  ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_sync &complete) ;
   public:
      static void capture_OUT( ac_sync &run,  ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_sync &complete) ;
   public:
      static void exec_inPlaceNTT_DIF_precomp( ac_sync &run,  ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_sync &complete) ;
   protected:
