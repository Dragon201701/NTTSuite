...
#include "/opt/mentorgraphics/Catapult_10.5c/Mgc_home/pkgs/ccs_xilinx/hdl/BLOCK_1R1W_RBW_DUAL_trans_rsc.h"
...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_twiddle_rsc_clkw_en("TLS_twiddle_rsc_clkw_en")
    ...
    , TLS_twiddle_h_rsc_clkw_en("TLS_twiddle_h_rsc_clkw_en")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 2089993, 2089993, 0)
    , catapult_monitor_INST("Monitor", clk, true, 2089993LL, 2089993LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    vec_rsc_INST.clkr(clk);
    vec_rsc_INST.clkr_en(SIG_SC_LOGIC_1);
    vec_rsc_INST.clkw(clk);
    vec_rsc_INST.clkw_en(SIG_SC_LOGIC_1);
    ...
    twiddle_rsc_INST.clkr(clk);
    twiddle_rsc_INST.clkr_en(SIG_SC_LOGIC_1);
    twiddle_rsc_INST.clkw(clk);
    twiddle_rsc_INST.clkw_en(TLS_twiddle_rsc_clkw_en);
    ...
    twiddle_h_rsc_INST.clkr(clk);
    twiddle_h_rsc_INST.clkr_en(SIG_SC_LOGIC_1);
    twiddle_h_rsc_INST.clkw(clk);
    twiddle_h_rsc_INST.clkw_en(TLS_twiddle_h_rsc_clkw_en);
