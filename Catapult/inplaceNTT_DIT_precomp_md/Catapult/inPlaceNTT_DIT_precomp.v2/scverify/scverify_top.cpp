...
public:
  ...
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<10,32,1024 >                                  twiddle_rsc_INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<10,32,1024 >                                  twiddle_h_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 123023, 123023, 0)
    , catapult_monitor_INST("Monitor", clk, true, 123023LL, 123023LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    run_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_7)));

    complete_rsc_INST.vld(TLS_complete_rsc_vld);
    complete_rsc_INST.rdy(TLS_complete_rsc_rdy);
    complete_rsc_INST.clk(clk);
    complete_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_13)));
    ...
    vec_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_8)));

    p_rsc_INST.dat(TLS_p_rsc_dat);
    p_rsc_INST.clk(clk);
    p_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_9)));

    r_rsc_INST.dat(TLS_r_rsc_dat);
    r_rsc_INST.clk(clk);
    r_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_10)));
    ...
    twiddle_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_11)));
    ...
    twiddle_h_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_12)));
