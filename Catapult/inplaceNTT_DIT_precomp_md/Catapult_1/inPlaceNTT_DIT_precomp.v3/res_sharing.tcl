...
directive set /inPlaceNTT_DIT_precomp/inPlaceNTT_DIT_precomp:core/inPlaceNTT_DIT_precomp:core:conc/VEC_LOOP:acc RESOURCE_NAME COMP_LOOP-2:VEC_LOOP:acc#9:rg
directive set /inPlaceNTT_DIT_precomp/inPlaceNTT_DIT_precomp:core/inPlaceNTT_DIT_precomp:core:conc/COMP_LOOP:slc(COMP_LOOP-2:COMP_LOOP:acc RESOURCE_NAME COMP_LOOP-2:VEC_LOOP:acc#9:rg
