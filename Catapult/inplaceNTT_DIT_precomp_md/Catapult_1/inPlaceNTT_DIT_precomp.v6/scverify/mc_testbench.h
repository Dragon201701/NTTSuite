...
public:
   ...
   public:
      static void exec_inPlaceNTT_DIT_precomp( ac_sync &run,  ac_int<32, false > vec[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096],  ac_sync &complete) ;
   protected:
