...
go architect
directive set /stockham_DIT/core/INNER_LOOP:write_mem(xt:rsc.@)#1 -IGNORE_DEPENDENCY_FROM {INNER_LOOP:write_mem(xt:rsc.@) INNER_LOOP:write_mem(xt:rsc.@)#1}
directive set /stockham_DIT/core/INNER_LOOP:write_mem(xt:rsc.@) -IGNORE_DEPENDENCY_FROM {INNER_LOOP:write_mem(xt:rsc.@) INNER_LOOP:write_mem(xt:rsc.@)#1}
go allocate
go extract
