...
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP CSTEPS_FROM {{. == 91} {.. == 0}}
...
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/INNER_LOOP:b:rem CSTEPS_FROM {{.. == 4}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/INNER_LOOP:INNER_LOOP:acc CSTEPS_FROM {{.. == 1}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/INNER_LOOP:acc#2 CSTEPS_FROM {{.. == 42}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/modulo_dev:result:rem CSTEPS_FROM {{.. == 42}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/modulo_dev:qelse:acc CSTEPS_FROM {{.. == 66}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/modulo_dev:mux CSTEPS_FROM {{.. == 66}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/INNER_LOOP:write_mem(xt:rsc.@) CSTEPS_FROM {{.. == 66}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/INNER_LOOP:write_mem(yt:rsc.@) CSTEPS_FROM {{.. == 66}}
...
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/INNER_LOOP:acc#5 CSTEPS_FROM {{.. == 42}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/modulo_dev#1:result:rem CSTEPS_FROM {{.. == 66}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/modulo_dev#1:qelse:acc CSTEPS_FROM {{.. == 90}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/modulo_dev#1:mux CSTEPS_FROM {{.. == 90}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/INNER_LOOP:write_mem(xt:rsc.@)#1 CSTEPS_FROM {{.. == 90}}
directive set /stockham_DIT/core/core:rlp/main/OUTER_LOOP/INNER_LOOP/INNER_LOOP:write_mem(yt:rsc.@)#1 CSTEPS_FROM {{.. == 90}}
