...
public:
  ...
  sc_signal<sc_lv<8> >                                                         TLS_xt_rsc_0_0_wadr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_0_0_d;
  sc_signal<sc_logic>                                                          TLS_xt_rsc_0_0_we;
  sc_signal<sc_lv<8> >                                                         TLS_xt_rsc_0_0_radr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_0_0_q;
  sc_signal<sc_logic>                                                          TLS_xt_rsc_triosy_0_0_lz;
  sc_signal<sc_lv<8> >                                                         TLS_xt_rsc_0_1_wadr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_0_1_d;
  sc_signal<sc_logic>                                                          TLS_xt_rsc_0_1_we;
  sc_signal<sc_lv<8> >                                                         TLS_xt_rsc_0_1_radr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_0_1_q;
  sc_signal<sc_logic>                                                          TLS_xt_rsc_triosy_0_1_lz;
  sc_signal<sc_lv<8> >                                                         TLS_xt_rsc_0_2_wadr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_0_2_d;
  sc_signal<sc_logic>                                                          TLS_xt_rsc_0_2_we;
  sc_signal<sc_lv<8> >                                                         TLS_xt_rsc_0_2_radr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_0_2_q;
  sc_signal<sc_logic>                                                          TLS_xt_rsc_triosy_0_2_lz;
  sc_signal<sc_lv<8> >                                                         TLS_xt_rsc_0_3_wadr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_0_3_d;
  sc_signal<sc_logic>                                                          TLS_xt_rsc_0_3_we;
  sc_signal<sc_lv<8> >                                                         TLS_xt_rsc_0_3_radr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_0_3_q;
  ...
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          xt_rsc_0__0__INST;
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          xt_rsc_0__1__INST;
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          xt_rsc_0__2__INST;
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          xt_rsc_0__3__INST;
  ...
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          twiddle_rsc_0__0__INST;
  ...
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          twiddle_rsc_0__1__INST;
  ...
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          twiddle_rsc_0__2__INST;
  ...
  BLOCK_1R1W_RBW_trans_rsc<8,64,256 >                                          twiddle_rsc_0__3__INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_rst("TLS_rst")
    , TLS_xt_rsc_0_0_wadr("TLS_xt_rsc_0_0_wadr")
    , TLS_xt_rsc_0_0_d("TLS_xt_rsc_0_0_d")
    , TLS_xt_rsc_0_0_we("TLS_xt_rsc_0_0_we")
    , TLS_xt_rsc_0_0_radr("TLS_xt_rsc_0_0_radr")
    , TLS_xt_rsc_0_0_q("TLS_xt_rsc_0_0_q")
    , TLS_xt_rsc_triosy_0_0_lz("TLS_xt_rsc_triosy_0_0_lz")
    , TLS_xt_rsc_0_1_wadr("TLS_xt_rsc_0_1_wadr")
    , TLS_xt_rsc_0_1_d("TLS_xt_rsc_0_1_d")
    , TLS_xt_rsc_0_1_we("TLS_xt_rsc_0_1_we")
    , TLS_xt_rsc_0_1_radr("TLS_xt_rsc_0_1_radr")
    , TLS_xt_rsc_0_1_q("TLS_xt_rsc_0_1_q")
    , TLS_xt_rsc_triosy_0_1_lz("TLS_xt_rsc_triosy_0_1_lz")
    , TLS_xt_rsc_0_2_wadr("TLS_xt_rsc_0_2_wadr")
    , TLS_xt_rsc_0_2_d("TLS_xt_rsc_0_2_d")
    , TLS_xt_rsc_0_2_we("TLS_xt_rsc_0_2_we")
    , TLS_xt_rsc_0_2_radr("TLS_xt_rsc_0_2_radr")
    , TLS_xt_rsc_0_2_q("TLS_xt_rsc_0_2_q")
    , TLS_xt_rsc_triosy_0_2_lz("TLS_xt_rsc_triosy_0_2_lz")
    , TLS_xt_rsc_0_3_wadr("TLS_xt_rsc_0_3_wadr")
    , TLS_xt_rsc_0_3_d("TLS_xt_rsc_0_3_d")
    , TLS_xt_rsc_0_3_we("TLS_xt_rsc_0_3_we")
    , TLS_xt_rsc_0_3_radr("TLS_xt_rsc_0_3_radr")
    , TLS_xt_rsc_0_3_q("TLS_xt_rsc_0_3_q")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 170516, 170516, 0)
    , catapult_monitor_INST("Monitor", clk, true, 170516LL, 170516LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    stockham_DIT_INST.xt_rsc_0_0_wadr(TLS_xt_rsc_0_0_wadr);
    stockham_DIT_INST.xt_rsc_0_0_d(TLS_xt_rsc_0_0_d);
    stockham_DIT_INST.xt_rsc_0_0_we(TLS_xt_rsc_0_0_we);
    stockham_DIT_INST.xt_rsc_0_0_radr(TLS_xt_rsc_0_0_radr);
    stockham_DIT_INST.xt_rsc_0_0_q(TLS_xt_rsc_0_0_q);
    stockham_DIT_INST.xt_rsc_triosy_0_0_lz(TLS_xt_rsc_triosy_0_0_lz);
    stockham_DIT_INST.xt_rsc_0_1_wadr(TLS_xt_rsc_0_1_wadr);
    stockham_DIT_INST.xt_rsc_0_1_d(TLS_xt_rsc_0_1_d);
    stockham_DIT_INST.xt_rsc_0_1_we(TLS_xt_rsc_0_1_we);
    stockham_DIT_INST.xt_rsc_0_1_radr(TLS_xt_rsc_0_1_radr);
    stockham_DIT_INST.xt_rsc_0_1_q(TLS_xt_rsc_0_1_q);
    stockham_DIT_INST.xt_rsc_triosy_0_1_lz(TLS_xt_rsc_triosy_0_1_lz);
    stockham_DIT_INST.xt_rsc_0_2_wadr(TLS_xt_rsc_0_2_wadr);
    stockham_DIT_INST.xt_rsc_0_2_d(TLS_xt_rsc_0_2_d);
    stockham_DIT_INST.xt_rsc_0_2_we(TLS_xt_rsc_0_2_we);
    stockham_DIT_INST.xt_rsc_0_2_radr(TLS_xt_rsc_0_2_radr);
    stockham_DIT_INST.xt_rsc_0_2_q(TLS_xt_rsc_0_2_q);
    stockham_DIT_INST.xt_rsc_triosy_0_2_lz(TLS_xt_rsc_triosy_0_2_lz);
    stockham_DIT_INST.xt_rsc_0_3_wadr(TLS_xt_rsc_0_3_wadr);
    stockham_DIT_INST.xt_rsc_0_3_d(TLS_xt_rsc_0_3_d);
    stockham_DIT_INST.xt_rsc_0_3_we(TLS_xt_rsc_0_3_we);
    stockham_DIT_INST.xt_rsc_0_3_radr(TLS_xt_rsc_0_3_radr);
    stockham_DIT_INST.xt_rsc_0_3_q(TLS_xt_rsc_0_3_q);
    ...
    stockham_DIT_INST.twiddle_rsc_0_0_radr(TLS_twiddle_rsc_0_0_radr);
    stockham_DIT_INST.twiddle_rsc_0_0_q(TLS_twiddle_rsc_0_0_q);
    stockham_DIT_INST.twiddle_rsc_triosy_0_0_lz(TLS_twiddle_rsc_triosy_0_0_lz);
    stockham_DIT_INST.twiddle_rsc_0_1_radr(TLS_twiddle_rsc_0_1_radr);
    stockham_DIT_INST.twiddle_rsc_0_1_q(TLS_twiddle_rsc_0_1_q);
    stockham_DIT_INST.twiddle_rsc_triosy_0_1_lz(TLS_twiddle_rsc_triosy_0_1_lz);
    stockham_DIT_INST.twiddle_rsc_0_2_radr(TLS_twiddle_rsc_0_2_radr);
    stockham_DIT_INST.twiddle_rsc_0_2_q(TLS_twiddle_rsc_0_2_q);
    stockham_DIT_INST.twiddle_rsc_triosy_0_2_lz(TLS_twiddle_rsc_triosy_0_2_lz);
    stockham_DIT_INST.twiddle_rsc_0_3_radr(TLS_twiddle_rsc_0_3_radr);
    stockham_DIT_INST.twiddle_rsc_0_3_q(TLS_twiddle_rsc_0_3_q);
    stockham_DIT_INST.twiddle_rsc_triosy_0_3_lz(TLS_twiddle_rsc_triosy_0_3_lz);

    xt_rsc_0__0__INST.q(TLS_xt_rsc_0_0_q);
    xt_rsc_0__0__INST.radr(TLS_xt_rsc_0_0_radr);
    xt_rsc_0__0__INST.we(TLS_xt_rsc_0_0_we);
    xt_rsc_0__0__INST.d(TLS_xt_rsc_0_0_d);
    xt_rsc_0__0__INST.wadr(TLS_xt_rsc_0_0_wadr);
    ...
    xt_rsc_0__1__INST.q(TLS_xt_rsc_0_1_q);
    xt_rsc_0__1__INST.radr(TLS_xt_rsc_0_1_radr);
    xt_rsc_0__1__INST.we(TLS_xt_rsc_0_1_we);
    xt_rsc_0__1__INST.d(TLS_xt_rsc_0_1_d);
    xt_rsc_0__1__INST.wadr(TLS_xt_rsc_0_1_wadr);
    ...
    xt_rsc_0__2__INST.q(TLS_xt_rsc_0_2_q);
    xt_rsc_0__2__INST.radr(TLS_xt_rsc_0_2_radr);
    xt_rsc_0__2__INST.we(TLS_xt_rsc_0_2_we);
    xt_rsc_0__2__INST.d(TLS_xt_rsc_0_2_d);
    xt_rsc_0__2__INST.wadr(TLS_xt_rsc_0_2_wadr);
    ...
    xt_rsc_0__3__INST.q(TLS_xt_rsc_0_3_q);
    xt_rsc_0__3__INST.radr(TLS_xt_rsc_0_3_radr);
    xt_rsc_0__3__INST.we(TLS_xt_rsc_0_3_we);
    xt_rsc_0__3__INST.d(TLS_xt_rsc_0_3_d);
    xt_rsc_0__3__INST.wadr(TLS_xt_rsc_0_3_wadr);
    ...
    g_rsc_INST.clk(clk);
    g_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_6)));
    ...
    twiddle_rsc_0__0__INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_18)));
    ...
    twiddle_rsc_0__1__INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_19)));
    ...
    twiddle_rsc_0__2__INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_20)));
    ...
    twiddle_rsc_0__3__INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_21)));
