...
public:
  ...
  sc_in<bool> clk;
  sc_in<sc_logic> rst;
  sc_out<sc_lv<10> > xt_rsc_wadr;
  sc_out<sc_lv<64> > xt_rsc_d;
  sc_out<sc_logic> xt_rsc_we;
  sc_out<sc_lv<10> > xt_rsc_radr;
  sc_in<sc_lv<64> > xt_rsc_q;
...
public:
  ...
  :
    ...
    clk("clk"), 
    rst("rst"), 
    xt_rsc_wadr("xt_rsc_wadr"), 
    xt_rsc_d("xt_rsc_d"), 
    xt_rsc_we("xt_rsc_we"), 
    xt_rsc_radr("xt_rsc_radr"), 
    xt_rsc_q("xt_rsc_q"), 
