...
public:
  ...
  sc_signal<sc_lv<10> >                                                        TLS_xt_rsc_wadr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_d;
  sc_signal<sc_logic>                                                          TLS_xt_rsc_we;
  sc_signal<sc_lv<10> >                                                        TLS_xt_rsc_radr;
  sc_signal<sc_lv<64> >                                                        TLS_xt_rsc_q;
  ...
  BLOCK_1R1W_RBW_trans_rsc<10,64,1024 >                                        xt_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_rst("TLS_rst")
    , TLS_xt_rsc_wadr("TLS_xt_rsc_wadr")
    , TLS_xt_rsc_d("TLS_xt_rsc_d")
    , TLS_xt_rsc_we("TLS_xt_rsc_we")
    , TLS_xt_rsc_radr("TLS_xt_rsc_radr")
    , TLS_xt_rsc_q("TLS_xt_rsc_q")
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    stockham_DIT_INST.xt_rsc_wadr(TLS_xt_rsc_wadr);
    stockham_DIT_INST.xt_rsc_d(TLS_xt_rsc_d);
    stockham_DIT_INST.xt_rsc_we(TLS_xt_rsc_we);
    stockham_DIT_INST.xt_rsc_radr(TLS_xt_rsc_radr);
    stockham_DIT_INST.xt_rsc_q(TLS_xt_rsc_q);
    ...
    xt_rsc_INST.q(TLS_xt_rsc_q);
    xt_rsc_INST.radr(TLS_xt_rsc_radr);
    xt_rsc_INST.we(TLS_xt_rsc_we);
    xt_rsc_INST.d(TLS_xt_rsc_d);
    xt_rsc_INST.wadr(TLS_xt_rsc_wadr);
    xt_rsc_INST.clk(clk);
    xt_rsc_INST.clken(SIG_SC_LOGIC_1);
    xt_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_4)));
    ...
    twiddle_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_7)));
