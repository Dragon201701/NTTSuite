...
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {xt_rsc_wadr[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {xt_rsc_d[*]}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {xt_rsc_we}]
set_output_delay -clock [get_clocks {clk}] 0.5 [get_ports {xt_rsc_radr[*]}]
set_input_delay -clock [get_clocks {clk}] 2.4 [get_ports {xt_rsc_q[*]}]
