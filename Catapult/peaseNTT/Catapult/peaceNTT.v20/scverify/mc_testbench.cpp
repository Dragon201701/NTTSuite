...
// Generated date: Wed Jun 16 23:23:02 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void peaceNTT( ac_int<64, false > vec[4096], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[4096],  ac_int<64, false > twiddle[4096]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_peaceNTT( ac_int<64, false > vec[4096], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[4096],  ac_int<64, false > twiddle[4096]) {
   return mc_testbench::exec_peaceNTT(vec, p, g, result, twiddle);
}
#endif
...
void mc_testbench::capture_vec( ac_int<64, false > vec[4096])
{
   ...
   if (_capture_vec && !testbench::vec_ignore)
   {
      ...
      ++vec_iteration_count;
      mgc_sysc_ver_array1D<ac_int<64, false >,4096> vec_tmp;
...
void mc_testbench::capture_result_IN( ac_int<64, false > result[4096])
{
   ...
   if (_capture_result_IN && !testbench::result_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<64, false >,4096> result_IN_tmp;
      int result_linear_idx = 0;
      for (int result_idx_0 = 0; result_idx_0 < 4096; ++result_idx_0)
         result_IN_tmp[result_linear_idx++] = result[result_idx_0];
...
void mc_testbench::capture_result( ac_int<64, false > result[4096])
{
   if (_capture_result)
   {
      int cur_iter = result_iteration_count;
      ++result_iteration_count;
      mc_golden_info< mgc_sysc_ver_array1D<ac_int<64, false >,4096>, MaskPacket<0, 64> > result_tmp(testbench::result_ignore, false, result_iteration_count);
      result_tmp._data.mc_testbench_process_array_bounds("result",testbench::result_array_comp_first,testbench::result_array_comp_last,4095,0);
      ...
      int result_linear_idx = 0;
      for (int result_idx_0 = 0; result_idx_0 < 4096; ++result_idx_0)
         result_tmp._data[result_linear_idx++] = result[result_idx_0];
...
void mc_testbench::capture_twiddle( ac_int<64, false > twiddle[4096])
{
   ...
   if (_capture_twiddle && !testbench::twiddle_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<64, false >,4096> twiddle_tmp;
...
void mc_testbench::wait_on_input_required()
{
   ...
   while (atleast_one_active_input) {
      ...
      if (average_period > SC_ZERO_TIME && sc_time_stamp() != timeout)
         wait(average_period * 10, ccs_vec->ok_to_put() | ccs_p->ok_to_put() | ccs_g->ok_to_put() | ccs_result_IN->ok_to_put() | ccs_twiddle->ok_to_put());
      else
         wait(ccs_vec->ok_to_put() | ccs_p->ok_to_put() | ccs_g->ok_to_put() | ccs_result_IN->ok_to_put() | ccs_twiddle->ok_to_put());
      that->cpp_testbench_active.write(true);
      if (timed_out()) {
...
void mc_testbench::capture_IN( ac_int<64, false > vec[4096], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[4096],  ac_int<64, false > twiddle[4096])
{
...
void mc_testbench::capture_OUT( ac_int<64, false > vec[4096], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[4096],  ac_int<64, false > twiddle[4096])
{
   that->capture_result(result);
}
// ============================================
// Function: exec_peaceNTT
// --------------------------------------------

void mc_testbench::exec_peaceNTT( ac_int<64, false > vec[4096], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[4096],  ac_int<64, false > twiddle[4096])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(vec, p, g, result, twiddle);
   peaceNTT(vec, p, g, result, twiddle);
   ...
   capture_OUT(vec, p, g, result, twiddle);
   #else
   #endif
}
// ============================================
