...
public:
  ...
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,4096> >                 TLS_in_fifo_COPY_LOOP_i;
  tlm::tlm_fifo<mc_wait_ctrl>                                    TLS_in_wait_ctrl_fifo_COPY_LOOP_i;
  ...
  mc_input_transactor<mgc_sysc_ver_array1D<int,4096>,64,false>   transactor_COPY_LOOP_i;
  tlm::tlm_fifo<int >                                            TLS_in_fifo_COPY_LOOP_i;
  tlm::tlm_fifo<mc_wait_ctrl>                                    TLS_in_wait_ctrl_fifo_COPY_LOOP_i;
  mc_trios_input_monitor                                         trios_monitor_p_rsc_triosy_lz_INST;
  mc_input_transactor<int,64,false>                              transactor_COPY_LOOP_i;
  tlm::tlm_fifo<int >                                            TLS_in_fifo_COPY_LOOP_i;
  tlm::tlm_fifo<mc_wait_ctrl>                                    TLS_in_wait_ctrl_fifo_COPY_LOOP_i;
  mc_trios_input_monitor                                         trios_monitor_p_rsc_triosy_lz_INST;
  mc_input_transactor<int,64,false>                              transactor_COPY_LOOP_i;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,4096> >                 TLS_in_fifo_COPY_LOOP_i;
  tlm::tlm_fifo<mc_wait_ctrl>                                    TLS_in_wait_ctrl_fifo_COPY_LOOP_i;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,4096> >                 TLS_out_fifo_COPY_LOOP_i;
  tlm::tlm_fifo<mc_wait_ctrl>                                    TLS_out_wait_ctrl_fifo_COPY_LOOP_i;
  mc_trios_inout_monitor                                         trios_monitor_p_rsc_triosy_lz_INST;
  mc_trios_inout_monitor                                         trios_monitor_g_rsc_triosy_lz_INST;
  ...
  mc_inout_transactor<mgc_sysc_ver_array1D<int,4096>,64,false>   transactor_COPY_LOOP_i;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<int,4096> >                 TLS_in_fifo_COPY_LOOP_i;
  tlm::tlm_fifo<mc_wait_ctrl>                                    TLS_in_wait_ctrl_fifo_COPY_LOOP_i;
  mc_trios_input_monitor                                         trios_monitor_p_rsc_triosy_lz_INST;
  mc_trios_input_monitor                                         trios_monitor_g_rsc_triosy_lz_INST;
  ...
  mc_trios_input_monitor                                         trios_monitor_result_rsc_triosy_0_0_lz_INST;
  mc_trios_input_monitor                                         trios_monitor_result_rsc_triosy_0_1_lz_INST;
  mc_input_transactor<mgc_sysc_ver_array1D<int,4096>,64,false>   transactor_COPY_LOOP_i;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , CCS_CLK_CTOR(clk, "clk", 13.33, SC_NS, 0.5, 0, SC_NS, false)
    , rst_driver("rst_driver", 133.300003, false)
    , TLS_rst("TLS_rst")
    ...
    , TLS_in_fifo_COPY_LOOP_i("TLS_in_fifo_COPY_LOOP_i", -1)
    , TLS_in_wait_ctrl_fifo_COPY_LOOP_i("TLS_in_wait_ctrl_fifo_COPY_LOOP_i", -1)
    ...
    , transactor_COPY_LOOP_i("transactor_COPY_LOOP_i", 0, 64, 0)
    , TLS_in_fifo_COPY_LOOP_i("TLS_in_fifo_COPY_LOOP_i", -1)
    , TLS_in_wait_ctrl_fifo_COPY_LOOP_i("TLS_in_wait_ctrl_fifo_COPY_LOOP_i", -1)
    , trios_monitor_p_rsc_triosy_lz_INST("trios_monitor_p_rsc_triosy_lz_INST")
    , transactor_COPY_LOOP_i("transactor_COPY_LOOP_i", 0, 64, 0)
    ...
    , TLS_in_fifo_COPY_LOOP_i("TLS_in_fifo_COPY_LOOP_i", -1)
    , TLS_in_wait_ctrl_fifo_COPY_LOOP_i("TLS_in_wait_ctrl_fifo_COPY_LOOP_i", -1)
    , TLS_out_fifo_COPY_LOOP_i("TLS_out_fifo_COPY_LOOP_i", -1)
    , TLS_out_wait_ctrl_fifo_COPY_LOOP_i("TLS_out_wait_ctrl_fifo_COPY_LOOP_i", -1)
    , trios_monitor_p_rsc_triosy_lz_INST("trios_monitor_p_rsc_triosy_lz_INST")
    , trios_monitor_g_rsc_triosy_lz_INST("trios_monitor_g_rsc_triosy_lz_INST")
    , trios_monitor_vec_rsc_triosy_0_0_lz_INST("trios_monitor_vec_rsc_triosy_0_0_lz_INST")
    , trios_monitor_vec_rsc_triosy_0_2_lz_INST("trios_monitor_vec_rsc_triosy_0_2_lz_INST")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 1214998, 1214998, 0)
    , catapult_monitor_INST("Monitor", clk, true, 1214998LL, 1214998LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    transactor_COPY_LOOP_i.in_fifo(TLS_in_fifo_COPY_LOOP_i);
    transactor_COPY_LOOP_i.in_wait_ctrl_fifo(TLS_in_wait_ctrl_fifo_COPY_LOOP_i);
    transactor_COPY_LOOP_i.bind_clk(clk, true, rst);
    transactor_COPY_LOOP_i.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_COPY_LOOP_i.register_block(&vec_rsc_0__0__INST, vec_rsc_0__0__INST.basename(), TLS_p_rsc_triosy_lz,
        0, 4088, 8);
    transactor_COPY_LOOP_i.register_block(&vec_rsc_0__2__INST, vec_rsc_0__2__INST.basename(), TLS_g_rsc_triosy_lz,
        2, 4090, 8);
    transactor_COPY_LOOP_i.register_block(&vec_rsc_0__4__INST, vec_rsc_0__4__INST.basename(), TLS_vec_rsc_triosy_0_0_lz,
        4, 4092, 8);
    transactor_COPY_LOOP_i.register_block(&vec_rsc_0__6__INST, vec_rsc_0__6__INST.basename(), TLS_vec_rsc_triosy_0_2_lz,
        6, 4094, 8);
    ...
    transactor_COPY_LOOP_i.bind_clk(clk, true, rst);
    transactor_COPY_LOOP_i.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_COPY_LOOP_i.register_block(&p_rsc_INST, p_rsc_INST.basename(), TLS_p_rsc_triosy_lz, 0, 0, 1);
    ...
    transactor_COPY_LOOP_i.bind_clk(clk, true, rst);
    transactor_COPY_LOOP_i.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_COPY_LOOP_i.register_block(&g_rsc_INST, g_rsc_INST.basename(), TLS_p_rsc_triosy_lz, 0, 0, 1);
    ...
    transactor_COPY_LOOP_i.in_fifo(TLS_in_fifo_COPY_LOOP_i);
    transactor_COPY_LOOP_i.in_wait_ctrl_fifo(TLS_in_wait_ctrl_fifo_COPY_LOOP_i);
    transactor_COPY_LOOP_i.out_fifo(TLS_out_fifo_COPY_LOOP_i);
    transactor_COPY_LOOP_i.out_wait_ctrl_fifo(TLS_out_wait_ctrl_fifo_COPY_LOOP_i);
    transactor_COPY_LOOP_i.bind_clk(clk, true, rst);
    transactor_COPY_LOOP_i.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_COPY_LOOP_i.register_block(&result_rsc_0__0__INST, result_rsc_0__0__INST.basename(), TLS_p_rsc_triosy_lz,
        0, 4088, 8);
    transactor_COPY_LOOP_i.register_block(&result_rsc_0__1__INST, result_rsc_0__1__INST.basename(), TLS_g_rsc_triosy_lz,
        1, 4089, 8);
    transactor_COPY_LOOP_i.register_block(&result_rsc_0__2__INST, result_rsc_0__2__INST.basename(), TLS_vec_rsc_triosy_0_0_lz,
        2, 4090, 8);
    transactor_COPY_LOOP_i.register_block(&result_rsc_0__3__INST, result_rsc_0__3__INST.basename(), TLS_vec_rsc_triosy_0_2_lz,
        3, 4091, 8);
    transactor_COPY_LOOP_i.register_block(&result_rsc_0__4__INST, result_rsc_0__4__INST.basename(), TLS_vec_rsc_triosy_0_4_lz,
        4, 4092, 8);
    transactor_COPY_LOOP_i.register_block(&result_rsc_0__5__INST, result_rsc_0__5__INST.basename(), TLS_vec_rsc_triosy_0_6_lz,
        5, 4093, 8);
    transactor_COPY_LOOP_i.register_block(&result_rsc_0__6__INST, result_rsc_0__6__INST.basename(), TLS_result_rsc_triosy_0_0_lz,
        6, 4094, 8);
    transactor_COPY_LOOP_i.register_block(&result_rsc_0__7__INST, result_rsc_0__7__INST.basename(), TLS_result_rsc_triosy_0_1_lz,
        7, 4095, 8);
    ...
    transactor_COPY_LOOP_i.bind_clk(clk, true, rst);
    transactor_COPY_LOOP_i.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_COPY_LOOP_i.register_block(&twiddle_rsc_0__0__INST, twiddle_rsc_0__0__INST.basename(), TLS_p_rsc_triosy_lz,
        0, 4088, 8);
    transactor_COPY_LOOP_i.register_block(&twiddle_rsc_0__1__INST, twiddle_rsc_0__1__INST.basename(), TLS_g_rsc_triosy_lz,
        1, 4089, 8);
    transactor_COPY_LOOP_i.register_block(&twiddle_rsc_0__2__INST, twiddle_rsc_0__2__INST.basename(), TLS_vec_rsc_triosy_0_0_lz,
        2, 4090, 8);
    transactor_COPY_LOOP_i.register_block(&twiddle_rsc_0__3__INST, twiddle_rsc_0__3__INST.basename(), TLS_vec_rsc_triosy_0_2_lz,
        3, 4091, 8);
    transactor_COPY_LOOP_i.register_block(&twiddle_rsc_0__4__INST, twiddle_rsc_0__4__INST.basename(), TLS_vec_rsc_triosy_0_4_lz,
        4, 4092, 8);
    transactor_COPY_LOOP_i.register_block(&twiddle_rsc_0__5__INST, twiddle_rsc_0__5__INST.basename(), TLS_vec_rsc_triosy_0_6_lz,
        5, 4093, 8);
    transactor_COPY_LOOP_i.register_block(&twiddle_rsc_0__6__INST, twiddle_rsc_0__6__INST.basename(), TLS_result_rsc_triosy_0_0_lz,
        6, 4094, 8);
    transactor_COPY_LOOP_i.register_block(&twiddle_rsc_0__7__INST, twiddle_rsc_0__7__INST.basename(), TLS_result_rsc_triosy_0_1_lz,
        7, 4095, 8);

    testbench_INST.clk(clk);
    testbench_INST.ccs_COPY_LOOP_i(TLS_in_fifo_COPY_LOOP_i);
    testbench_INST.ccs_wait_ctrl_COPY_LOOP_i(TLS_in_wait_ctrl_fifo_COPY_LOOP_i);
    testbench_INST.ccs_COPY_LOOP_i(TLS_in_fifo_COPY_LOOP_i);
    testbench_INST.ccs_wait_ctrl_COPY_LOOP_i(TLS_in_wait_ctrl_fifo_COPY_LOOP_i);
    testbench_INST.ccs_COPY_LOOP_i(TLS_in_fifo_COPY_LOOP_i);
    testbench_INST.ccs_wait_ctrl_COPY_LOOP_i(TLS_in_wait_ctrl_fifo_COPY_LOOP_i);
    testbench_INST.ccs_COPY_LOOP_i_IN(TLS_in_fifo_COPY_LOOP_i);
    testbench_INST.ccs_wait_ctrl_COPY_LOOP_i_IN(TLS_in_wait_ctrl_fifo_COPY_LOOP_i);
    testbench_INST.ccs_COPY_LOOP_i(TLS_out_fifo_COPY_LOOP_i);
    testbench_INST.ccs_wait_ctrl_COPY_LOOP_i(TLS_out_wait_ctrl_fifo_COPY_LOOP_i);
    testbench_INST.ccs_COPY_LOOP_i(TLS_in_fifo_COPY_LOOP_i);
    testbench_INST.ccs_wait_ctrl_COPY_LOOP_i(TLS_in_wait_ctrl_fifo_COPY_LOOP_i);
    ...
    testbench_INST._capture_vec = false;
    testbench_INST._capture_p = false;
    testbench_INST._capture_g = false;
    testbench_INST._capture_result = false;
    testbench_INST._capture_result_IN = false;
    testbench_INST._capture_twiddle = false;
...
void scverify_top::start_of_simulation() {
  ...
  if (SCVerify_AUTOWAIT) {
    ...
    transactor_COPY_LOOP_i.set_auto_wait_limit(l);
    transactor_COPY_LOOP_i.set_auto_wait_limit(l);
    transactor_COPY_LOOP_i.set_auto_wait_limit(l);
    transactor_COPY_LOOP_i.set_auto_wait_limit(l);
    transactor_COPY_LOOP_i.set_auto_wait_limit(l);
...
void scverify_top::setup_debug() {
  ...
  static int transactor_COPY_LOOP_i_flags = MC_DEFAULT_TRANSACTOR_LOG;
  static int transactor_COPY_LOOP_i_flags = MC_DEFAULT_TRANSACTOR_LOG;
  static int transactor_COPY_LOOP_i_flags = MC_DEFAULT_TRANSACTOR_LOG;
  static int transactor_COPY_LOOP_i_flags = MC_DEFAULT_TRANSACTOR_LOG;
  static int transactor_COPY_LOOP_i_flags = MC_DEFAULT_TRANSACTOR_LOG;
#else
  static int transactor_COPY_LOOP_i_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
  static int transactor_COPY_LOOP_i_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
  static int transactor_COPY_LOOP_i_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
  static int transactor_COPY_LOOP_i_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
  static int transactor_COPY_LOOP_i_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
#endif
  static int transactor_COPY_LOOP_i_count = -1;
  static int transactor_COPY_LOOP_i_count = -1;
  static int transactor_COPY_LOOP_i_count = -1;
  static int transactor_COPY_LOOP_i_count = -1;
  static int transactor_COPY_LOOP_i_count = -1;
  ...
  if (debug_cmds.is_open()) {
    ...
    debug("transactor_COPY_LOOP_i",transactor_COPY_LOOP_i_flags,transactor_COPY_LOOP_i_count);
    debug("transactor_COPY_LOOP_i",transactor_COPY_LOOP_i_flags,transactor_COPY_LOOP_i_count);
    debug("transactor_COPY_LOOP_i",transactor_COPY_LOOP_i_flags,transactor_COPY_LOOP_i_count);
    debug("transactor_COPY_LOOP_i",transactor_COPY_LOOP_i_flags,transactor_COPY_LOOP_i_count);
    debug("transactor_COPY_LOOP_i",transactor_COPY_LOOP_i_flags,transactor_COPY_LOOP_i_count);
...
void scverify_top::debug(const char* varname, int flags, int count) {
  ...
  if (strcmp(varname,"transactor_COPY_LOOP_i") == 0)
    xlator_p = &transactor_COPY_LOOP_i;
  if (strcmp(varname,"transactor_COPY_LOOP_i") == 0)
    xlator_p = &transactor_COPY_LOOP_i;
  if (strcmp(varname,"transactor_COPY_LOOP_i") == 0)
    xlator_p = &transactor_COPY_LOOP_i;
...
void scverify_top::generate_reset() {
  ...
  if (activate_reset || sc_time_stamp() == SC_ZERO_TIME) {
    ...
    generate_reset_event.notify(133.300003 , SC_NS);
  } else {
    if (toggle_hw_reset) {
      toggle_hw_reset = false;
      generate_reset_event.notify(133.300003 , SC_NS);
    } else {
      transactor_COPY_LOOP_i.reset_streams();
      transactor_COPY_LOOP_i.reset_streams();
      transactor_COPY_LOOP_i.reset_streams();
      transactor_COPY_LOOP_i.reset_streams();
      transactor_COPY_LOOP_i.reset_streams();
