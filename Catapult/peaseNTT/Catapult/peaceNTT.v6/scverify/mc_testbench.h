...
public:
   ...
   public:
      static void capture_IN( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[1024]) ;
   public:
      static void capture_OUT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[1024]) ;
   public:
      static void exec_peaceNTT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[1024]) ;
   protected:
