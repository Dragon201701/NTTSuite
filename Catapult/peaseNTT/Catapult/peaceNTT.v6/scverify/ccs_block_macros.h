...
extern void mc_testbench_capture_IN( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[1024]);
extern void mc_testbench_capture_OUT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[1024]);
extern void mc_testbench_wait_for_idle_sync();

#define ccs_intercept_peaceNTT_68 \
  ccs_real_peaceNTT(ac_int<64, false > vec[1024],ac_int<64, false > p,ac_int<64, false > g,ac_int<64, false > result[1024]);\
  void peaceNTT(ac_int<64, false > vec[1024],ac_int<64, false > p,ac_int<64, false > g,ac_int<64, false > result[1024])\
{\
    ...
    mc_testbench_capture_IN(vec,p,g,result);\
    ccs_real_peaceNTT(vec,p,g,result);\
    mc_testbench_capture_OUT(vec,p,g,result);\
}\
