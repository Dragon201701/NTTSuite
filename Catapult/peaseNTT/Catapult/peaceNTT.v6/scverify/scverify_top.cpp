...
#include "/opt/mentorgraphics/Catapult_10.5c/Mgc_home/pkgs/ccs_xilinx/hdl/BLOCK_2R1W_WBR_DUAL_trans_rsc.h"
...
public:
  ...
  BLOCK_2R1W_WBR_DUAL_trans_rsc<10,64,1024 >                                   vec_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 428326, 428326, 0)
    , catapult_monitor_INST("Monitor", clk, true, 428326LL, 428326LL)
