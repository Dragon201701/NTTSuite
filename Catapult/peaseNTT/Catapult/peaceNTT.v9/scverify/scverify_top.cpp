...
public:
  ...
  sc_signal<sc_lv<12> >                                                        TLS_result_rsc_wadr;
  sc_signal<sc_lv<64> >                                                        TLS_result_rsc_d;
  sc_signal<sc_logic>                                                          TLS_result_rsc_we;
  sc_signal<sc_lv<12> >                                                        TLS_result_rsc_radr;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 1289238, 1289238, 0)
    , catapult_monitor_INST("Monitor", clk, true, 1289238LL, 1289238LL)
