...
// Generated date: Sun Jan 23 15:13:46 EST 2022
//
// ----------------------------------------------------------------------------
#ifdef CCS_SCVERIFY
...
public:
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,16> , MaskPacket< 0, 32 > > *a_comp;
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,16> > > ccs_a_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_a_IN;
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_int<32, false >,16> > > ccs_a;
   ...
   bool _capture_a_IN;
   int a_IN_capture_count;
   int a_IN_iteration_count;
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,16>, MaskPacket<0, 32> > > a_golden;
   bool _capture_a;
   int a_capture_count;
   int a_iteration_count;
   ac_int<32, false > *a_IN_access_ptr;
   ...
   mc_testbench(
      ...
      , ccs_a_IN("ccs_a_IN")
      , ccs_wait_ctrl_a_IN("ccs_wait_ctrl_a_IN")
      , ccs_a("ccs_a")
      ...
      , complete_golden("complete_golden",-1)
   {
      ...
      a_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,16> , MaskPacket< 0, 32 > > (
         "a_comp",
         "a",
         0,
         0,
      ...
      a_comp->data_in(ccs_a);
      a_comp->data_golden(a_golden);
   ...
   public:
      void capture_a_IN( ac_int<32, false > a[16]) ;
   public:
   ...
   public:
      static void capture_IN( ac_sync &run,  ac_int<32, false > a[16],  ac_sync &complete) ;
   public:
      static void capture_OUT( ac_sync &run,  ac_int<32, false > a[16],  ac_sync &complete) ;
   public:
      static void exec_axi_test( ac_sync &run,  ac_int<32, false > a[16],  ac_sync &complete) ;
   protected:
