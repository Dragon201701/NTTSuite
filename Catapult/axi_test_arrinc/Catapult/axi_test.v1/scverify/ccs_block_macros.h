...
#define ccs_intercept_axi_test_4 \
  ccs_real_axi_test(ac_sync &run,ac_int<32, false > a[16],ac_int<32, false > b[16],ac_sync &complete);\
  void axi_test(ac_sync &run,ac_int<32, false > a[16],ac_int<32, false > b[16],ac_sync &complete)\
{\
    ...
    ccs_real_axi_test(run,a,b,complete);\
