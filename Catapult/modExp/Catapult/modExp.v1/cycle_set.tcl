...
directive set /modExp/core/core:rlp/main/exp_count:io_read(exp:rsc.@) CSTEPS_FROM {{.. == 1}}
...
directive set /modExp/core/core:rlp/main/while/while:io_write(result:rsc.@) CSTEPS_FROM {{.. == 25}}
