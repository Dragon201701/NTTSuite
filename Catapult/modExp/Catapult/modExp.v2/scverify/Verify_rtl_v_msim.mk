...
# Generated date: Mon Jul 05 14:37:12 EDT 2021
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   PROJECT_HOME  /home/yl7897/NTT_Xilinx/Catapult/modExp
#   SOLUTION_DIR  /home/yl7897/NTT_Xilinx/Catapult/modExp/Catapult/modExp.v2
#   WORKING_DIR   /home/yl7897/NTT_Xilinx/Catapult/modExp/Catapult/modExp.v2/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult/modExp.v2
PROJ2SOLN = ./Catapult/modExp.v2
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/yl7897/NTT_Xilinx/Catapult/modExp/Catapult/modExp.v2/rtl.v
endif
...
export SCVLIBS
export MODELSIM
TOP_HDL_ENTITY           := modExp
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./Catapult/modExp.v2/scverify_msim.tcl
...
VLOG_SRC += $(MGC_HOME)/pkgs/siflibs/ccs_in_v1.v/ccs_in_v1.v.vts $(MGC_HOME)/pkgs/siflibs/mgc_inout_prereg_en_v1.v/mgc_inout_prereg_en_v1.v.vts $(MGC_HOME)/pkgs/siflibs/mgc_io_sync_v2.v/mgc_io_sync_v2.v.vts $(MGC_HOME)/pkgs/hls_pkgs/mgc_comps_src/mgc_rem_beh.v/mgc_rem_beh.v.vts $(GATE_VLOG_DEP)
else
VHDL_SRC += 
VLOG_SRC += $(MGC_HOME)/pkgs/siflibs/ccs_in_v1.v/ccs_in_v1.v.vts $(MGC_HOME)/pkgs/siflibs/mgc_inout_prereg_en_v1.v/mgc_inout_prereg_en_v1.v.vts $(MGC_HOME)/pkgs/siflibs/mgc_io_sync_v2.v/mgc_io_sync_v2.v.vts $(MGC_HOME)/pkgs/hls_pkgs/mgc_comps_src/mgc_rem_beh.v/mgc_rem_beh.v.vts ./rtl.v/rtl.v.vts
endif
CXX_SRC  = ../../src/modExp_tb.cpp/modExp_tb.cpp.cxxts ../../src/modExp.cpp/modExp.cpp.cxxts ./scverify/mc_testbench.cpp/mc_testbench.cpp.cxxts ./scverify/scverify_top.cpp/scverify_top.cpp.cxxts
...
CXXFLAGS += -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_modExp -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
...
$(TARGET)/modExp_tb.cpp.cxxts: ../../src/modExp_tb.cpp
$(TARGET)/modExp.cpp.cxxts: ../../src/modExp.cpp
...
$(TARGET)/modExp.cpp.cxxts: CXX_OPTS=
$(TARGET)/scverify_top.cpp.cxxts: CXX_OPTS=
$(TARGET)/mc_testbench.cpp.cxxts: CXX_OPTS=$(F_WRAP_OPT)
$(TARGET)/modExp_tb.cpp.cxxts: CXX_OPTS=
# 
# Specify dependencies
$(TARGET)/modExp_tb.cpp.cxxts: .ccs_env_opts/SCVerify_USE_CCS_BLOCK.ts
$(TARGET)/modExp.cpp.cxxts: .ccs_env_opts/SCVerify_USE_CCS_BLOCK.ts
