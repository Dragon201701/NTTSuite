...
directive set /modExp/core/core:rlp/main/while CSTEPS_FROM {{. == 27} {.. == 2}}
...
directive set /modExp/core/core:rlp/main/while/while:io_write(result:rsc.@)#2 CSTEPS_FROM {{.. == 26}}
