...
public:
  ...
  mc_input_transactor<ac_int<64, false >,64,false>  transactor_result;
  tlm::tlm_fifo<ac_int<64, false > >                TLS_in_fifo_result;
  tlm::tlm_fifo<mc_wait_ctrl>                       TLS_in_wait_ctrl_fifo_result;
  mc_trios_input_monitor                            trios_monitor_base_rsc_triosy_lz_INST;
  mc_input_transactor<ac_int<64, false >,64,false>  transactor_result;
  ...
  mc_trios_inout_monitor                            trios_monitor_base_rsc_triosy_lz_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 31, 31, 0)
    , catapult_monitor_INST("Monitor", clk, true, 31LL, 30LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    transactor_result.register_block(&base_rsc_INST, base_rsc_INST.basename(), TLS_base_rsc_triosy_lz, 0, 0, 1);
    ...
    transactor_result.bind_clk(clk, true, rst);
    transactor_result.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_result.register_block(&exp_rsc_INST, exp_rsc_INST.basename(), TLS_base_rsc_triosy_lz, 0, 0, 1);
    ...
    transactor_result.bind_clk(clk, true, rst);
    transactor_result.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_result.register_block(&m_rsc_INST, m_rsc_INST.basename(), TLS_base_rsc_triosy_lz, 0, 0, 1);
    ...
    transactor_result.bind_clk(clk, true, rst);
    transactor_result.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_result.register_block(&result_rsc_INST, result_rsc_INST.basename(), TLS_base_rsc_triosy_lz, 0, 0,
        1);

    testbench_INST.clk(clk);
    testbench_INST.ccs_result(TLS_in_fifo_result);
    testbench_INST.ccs_wait_ctrl_result(TLS_in_wait_ctrl_fifo_result);
    testbench_INST.ccs_result(TLS_in_fifo_result);
    testbench_INST.ccs_wait_ctrl_result(TLS_in_wait_ctrl_fifo_result);
    testbench_INST.ccs_result(TLS_in_fifo_result);
    testbench_INST.ccs_wait_ctrl_result(TLS_in_wait_ctrl_fifo_result);
    ...
    testbench_INST._capture_base = false;
    testbench_INST._capture_exp = false;
    testbench_INST._capture_m = false;
