...
#library load /opt/mentorgraphics/Catapult_10.5c/Mgc_home/pkgs/ccs_xilinx/mgc_Xilinx-VIRTEX-7-1_beh.lib
library set /LIBS/mgc_Xilinx-VIRTEX-7-1_beh/MODS/mgc_mux1hot/PARAMETERS/ctrlw -- -CHAR_RANGE {1, 4 to 32}
library set /LIBS/mgc_Xilinx-VIRTEX-7-1_beh/MODS/mgc_mux1hot/PARAMETERS/width -- -CHAR_RANGE {1, 4 to 32}
