...
public:
  ...
  sc_out<sc_logic> vec_rsc_re;
  sc_in<sc_lv<64> > vec_rsc_q;
  ...
  sc_out<sc_lv<10> > result_rsc_radr;
  sc_out<sc_logic> result_rsc_re;
  sc_in<sc_lv<64> > result_rsc_q;
  sc_out<sc_lv<10> > result_rsc_wadr;
  sc_out<sc_lv<64> > result_rsc_d;
  sc_out<sc_logic> result_rsc_we;
  sc_out<sc_logic> result_rsc_triosy_lz;
  sc_out<sc_lv<10> > twiddle_rsc_radr;
  sc_out<sc_logic> twiddle_rsc_re;
...
public:
  ...
  :
    ...
    result_rsc_radr("result_rsc_radr"), 
    result_rsc_re("result_rsc_re"), 
    result_rsc_q("result_rsc_q"), 
    result_rsc_wadr("result_rsc_wadr"), 
    result_rsc_d("result_rsc_d"), 
    result_rsc_we("result_rsc_we"), 
    result_rsc_triosy_lz("result_rsc_triosy_lz"), 
    twiddle_rsc_radr("twiddle_rsc_radr"), 
    twiddle_rsc_re("twiddle_rsc_re"), 
