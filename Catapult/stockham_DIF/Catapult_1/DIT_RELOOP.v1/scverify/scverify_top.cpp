...
public:
  ...
  sc_signal<sc_lv<10> >                                                        TLS_result_rsc_radr;
  sc_signal<sc_logic>                                                          TLS_result_rsc_re;
  sc_signal<sc_lv<64> >                                                        TLS_result_rsc_q;
  sc_signal<sc_lv<10> >                                                        TLS_result_rsc_wadr;
  sc_signal<sc_lv<64> >                                                        TLS_result_rsc_d;
  sc_signal<sc_logic>                                                          TLS_result_rsc_we;
  ...
  ccs_ram_sync_1R1W_trans_rsc<64,10,1024 >                                     result_rsc_INST;
  ...
  mc_input_transactor<mgc_sysc_ver_array1D<ac_int<64, false >,1024>,64,false>  transactor_vec;
  ...
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<64, false >,1024> >                TLS_in_fifo_result;
  tlm::tlm_fifo<mc_wait_ctrl>                                                  TLS_in_wait_ctrl_fifo_result;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<64, false >,1024> >                TLS_out_fifo_result;
  tlm::tlm_fifo<mc_wait_ctrl>                                                  TLS_out_wait_ctrl_fifo_result;
  mc_trios_inout_monitor                                                       trios_monitor_result_rsc_triosy_lz_INST;
  mc_inout_transactor<mgc_sysc_ver_array1D<ac_int<64, false >,1024>,64,false>  transactor_result;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_result_rsc_radr("TLS_result_rsc_radr")
    , TLS_result_rsc_re("TLS_result_rsc_re")
    , TLS_result_rsc_q("TLS_result_rsc_q")
    , TLS_result_rsc_wadr("TLS_result_rsc_wadr")
    , TLS_result_rsc_d("TLS_result_rsc_d")
    , TLS_result_rsc_we("TLS_result_rsc_we")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 630388344, 630388344, 0)
    , catapult_monitor_INST("Monitor", clk, true, 630388344LL, 630388344LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    DIT_RELOOP_INST.vec_rsc_radr(TLS_vec_rsc_radr);
    DIT_RELOOP_INST.vec_rsc_re(TLS_vec_rsc_re);
    DIT_RELOOP_INST.vec_rsc_q(TLS_vec_rsc_q);
    DIT_RELOOP_INST.vec_rsc_triosy_lz(TLS_vec_rsc_triosy_lz);
    ...
    DIT_RELOOP_INST.result_rsc_radr(TLS_result_rsc_radr);
    DIT_RELOOP_INST.result_rsc_re(TLS_result_rsc_re);
    DIT_RELOOP_INST.result_rsc_q(TLS_result_rsc_q);
    DIT_RELOOP_INST.result_rsc_wadr(TLS_result_rsc_wadr);
    DIT_RELOOP_INST.result_rsc_d(TLS_result_rsc_d);
    DIT_RELOOP_INST.result_rsc_we(TLS_result_rsc_we);
    DIT_RELOOP_INST.result_rsc_triosy_lz(TLS_result_rsc_triosy_lz);
    DIT_RELOOP_INST.twiddle_rsc_radr(TLS_twiddle_rsc_radr);
    DIT_RELOOP_INST.twiddle_rsc_re(TLS_twiddle_rsc_re);
    DIT_RELOOP_INST.twiddle_rsc_q(TLS_twiddle_rsc_q);
    DIT_RELOOP_INST.twiddle_rsc_triosy_lz(TLS_twiddle_rsc_triosy_lz);
    ...
    vec_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_4)));
    ...
    result_rsc_INST.we(TLS_result_rsc_we);
    result_rsc_INST.d(TLS_result_rsc_d);
    result_rsc_INST.wadr(TLS_result_rsc_wadr);
    result_rsc_INST.q(TLS_result_rsc_q);
    result_rsc_INST.re(TLS_result_rsc_re);
    result_rsc_INST.radr(TLS_result_rsc_radr);
    result_rsc_INST.clk(clk);
    result_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_7)));
    ...
    twiddle_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_8)));
