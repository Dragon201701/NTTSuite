...
library set /LIBS/nangate-45nm_beh/MODS/mgc_rem/PARAMETERS/width_a -- -CHAR_RANGE {4 to 16, 128}
...
library set /LIBS/nangate-45nm_beh/MODS/mgc_mul/PARAMETERS/width_z -- -CHAR_RANGE {4 to 4, 8 to 8, 16 to 16, 32 to 32, 64 to 64, 128}
