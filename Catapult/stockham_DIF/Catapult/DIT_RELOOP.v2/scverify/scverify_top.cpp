...
public:
  ...
  BLOCK_1R1W_RBW_trans_rsc<10,64,1024 >                                        vec_rsc_INST;
  ccs_in_trans_rsc_v1<1,64 >                                                   p_rsc_INST;
  ccs_in_trans_rsc_v1<1,64 >                                                   r_rsc_INST;
  BLOCK_1R1W_RBW_trans_rsc<10,64,1024 >                                        result_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 399250844, 399250844, 0)
    , catapult_monitor_INST("Monitor", clk, true, 399250844LL, 399250844LL)
