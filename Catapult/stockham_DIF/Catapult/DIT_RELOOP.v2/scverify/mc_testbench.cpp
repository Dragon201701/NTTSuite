...
// Generated date: Thu Jul 29 11:01:12 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void DIT_RELOOP( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024],  ac_int<64, false > twiddle[1024]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_DIT_RELOOP( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024],  ac_int<64, false > twiddle[1024]) {
   return mc_testbench::exec_DIT_RELOOP(vec, p, r, result, twiddle);
}
#endif
...
void mc_testbench::capture_vec( ac_int<64, false > vec[1024])
{
   ...
   if (_capture_vec && !testbench::vec_ignore)
   {
      ...
      ++vec_iteration_count;
      mgc_sysc_ver_array1D<ac_int<64, false >,1024> vec_tmp;
...
void mc_testbench::capture_result_IN( ac_int<64, false > result[1024])
{
   ...
   if (_capture_result_IN && !testbench::result_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<64, false >,1024> result_IN_tmp;
      int result_linear_idx = 0;
      for (int result_idx_0 = 0; result_idx_0 < 1024; ++result_idx_0)
...
void mc_testbench::capture_result( ac_int<64, false > result[1024])
{
   if (_capture_result)
   {
      int cur_iter = result_iteration_count;
      ++result_iteration_count;
      mc_golden_info< mgc_sysc_ver_array1D<ac_int<64, false >,1024>, MaskPacket<0, 64> > result_tmp(testbench::result_ignore, false, result_iteration_count);
      result_tmp._data.mc_testbench_process_array_bounds("result",testbench::result_array_comp_first,testbench::result_array_comp_last,1023,0);
...
void mc_testbench::wait_on_input_required()
{
   ...
   while (atleast_one_active_input) {
      ...
      if (average_period > SC_ZERO_TIME && sc_time_stamp() != timeout)
         wait(average_period * 10, ccs_vec->ok_to_put() | ccs_p->ok_to_put() | ccs_r->ok_to_put() | ccs_result_IN->ok_to_put() | ccs_twiddle->ok_to_put());
      else
         wait(ccs_vec->ok_to_put() | ccs_p->ok_to_put() | ccs_r->ok_to_put() | ccs_result_IN->ok_to_put() | ccs_twiddle->ok_to_put());
      that->cpp_testbench_active.write(true);
      if (timed_out()) {
...
void mc_testbench::capture_IN( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024],  ac_int<64, false > twiddle[1024])
{
...
void mc_testbench::capture_OUT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024],  ac_int<64, false > twiddle[1024])
{
   that->capture_result(result);
}
// ============================================
// Function: exec_DIT_RELOOP
// --------------------------------------------

void mc_testbench::exec_DIT_RELOOP( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > result[1024],  ac_int<64, false > twiddle[1024])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(vec, p, r, result, twiddle);
   DIT_RELOOP(vec, p, r, result, twiddle);
   ...
   capture_OUT(vec, p, r, result, twiddle);
   #else
   #endif
}
// ============================================
