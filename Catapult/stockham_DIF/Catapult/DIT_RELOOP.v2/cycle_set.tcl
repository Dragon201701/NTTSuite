...
directive set /DIT_RELOOP/core/core:rlp/main/COPY_LOOP CSTEPS_FROM {{. == 3} {.. == 1}}
...
directive set /DIT_RELOOP/core/core:rlp/main/STAGE_LOOP/GROUP_LOOP/IDX_LOOP CSTEPS_FROM {{. == 38} {.. == 0}}
...
directive set /DIT_RELOOP/core/core:rlp/main/COPY_LOOP/COPY_LOOP:read_mem(vec:rsc.@) CSTEPS_FROM {{.. == 1}}
directive set /DIT_RELOOP/core/core:rlp/main/COPY_LOOP/COPY_LOOP:write_mem(result:rsc.@) CSTEPS_FROM {{.. == 2}}
directive set /DIT_RELOOP/core/core:rlp/main/COPY_LOOP/COPY_LOOP:acc#1 CSTEPS_FROM {{.. == 1}}
...
directive set /DIT_RELOOP/core/core:rlp/main/STAGE_LOOP/GROUP_LOOP/IDX_LOOP/IDX_LOOP:f1:read_mem(result:rsc.@) CSTEPS_FROM {{.. == 2}}
directive set /DIT_RELOOP/core/core:rlp/main/STAGE_LOOP/GROUP_LOOP/IDX_LOOP/IDX_LOOP:f2:read_mem(result:rsc.@) CSTEPS_FROM {{.. == 1}}
...
directive set /DIT_RELOOP/core/core:rlp/main/STAGE_LOOP/GROUP_LOOP/IDX_LOOP/IDX_LOOP:mul CSTEPS_FROM {{.. == 16}}
directive set /DIT_RELOOP/core/core:rlp/main/STAGE_LOOP/GROUP_LOOP/IDX_LOOP/IDX_LOOP:IDX_LOOP:rem#1 CSTEPS_FROM {{.. == 16}}
directive set /DIT_RELOOP/core/core:rlp/main/STAGE_LOOP/GROUP_LOOP/IDX_LOOP/IDX_LOOP:write_mem(result:rsc.@) CSTEPS_FROM {{.. == 36}}
...
directive set /DIT_RELOOP/core/core:rlp/main/STAGE_LOOP/GROUP_LOOP/IDX_LOOP/IDX_LOOP:write_mem(result:rsc.@)#1 CSTEPS_FROM {{.. == 37}}
