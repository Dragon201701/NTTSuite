...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 630385272, 630385272, 0)
    , catapult_monitor_INST("Monitor", clk, true, 630385272LL, 630385272LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    DIT_RELOOP_INST.vec_rsc_wadr(TLS_vec_rsc_wadr);
    DIT_RELOOP_INST.vec_rsc_d(TLS_vec_rsc_d);
    DIT_RELOOP_INST.vec_rsc_we(TLS_vec_rsc_we);
