...
// Generated date: Wed Aug 18 22:21:42 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void DIT_RELOOP( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > twiddle[1024]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_DIT_RELOOP( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > twiddle[1024]) {
   return mc_testbench::exec_DIT_RELOOP(vec, p, r, twiddle);
}
#endif
...
void mc_testbench::exec_DIT_RELOOP( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > r,  ac_int<64, false > twiddle[1024])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
   capture_IN(vec, p, r, twiddle);
   DIT_RELOOP(vec, p, r, twiddle);
