...
directive set /DIT_RELOOP/DIT_RELOOP:core/DIT_RELOOP:core:conc/STAGE_LOOP:gp:acc RESOURCE_NAME GROUP_LOOP:acc#1:rg
directive set /DIT_RELOOP/DIT_RELOOP:core/DIT_RELOOP:core:conc/IDX_LOOP:acc#4 RESOURCE_NAME GROUP_LOOP:acc#1:rg
