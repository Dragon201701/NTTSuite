...
public:
  ...
  ccs_ram_sync_1R1W_trans_rsc<64,9,512 >                                       vec_rsc_0__0__INST;
  ccs_ram_sync_1R1W_trans_rsc<64,9,512 >                                       vec_rsc_0__1__INST;
  ...
  ccs_ram_sync_1R1W_trans_rsc<64,9,512 >                                       twiddle_rsc_0__0__INST;
  ...
  ccs_ram_sync_1R1W_trans_rsc<64,9,512 >                                       twiddle_rsc_0__1__INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 347054772, 347054772, 0)
    , catapult_monitor_INST("Monitor", clk, true, 347054772LL, 347054772LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    twiddle_rsc_0__0__INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_11)));
    ...
    twiddle_rsc_0__1__INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_12)));
