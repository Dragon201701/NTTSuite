...
## Multi-cycle component nangate-45nm_beh.mgc_rem (rem_2_cmp) [cycles: 2]
set_multicycle_path  2 -through [get_pins {{modulo_dev_core_inst/rem_2_cmp/z[*]}}]
set_min_delay 0 -from [get_pins {{modulo_dev_core_inst/rem_2_cmp/a[*]} {modulo_dev_core_inst/rem_2_cmp/b[*]}}] -to [get_pins {{modulo_dev_core_inst/rem_2_cmp/z[*]}}]

## Multi-cycle component nangate-45nm_beh.mgc_rem (rem_2_cmp_1) [cycles: 2]
set_multicycle_path  2 -through [get_pins {{modulo_dev_core_inst/rem_2_cmp_1/z[*]}}]
set_min_delay 0 -from [get_pins {{modulo_dev_core_inst/rem_2_cmp_1/a[*]} {modulo_dev_core_inst/rem_2_cmp_1/b[*]}}] -to [get_pins {{modulo_dev_core_inst/rem_2_cmp_1/z[*]}}]
