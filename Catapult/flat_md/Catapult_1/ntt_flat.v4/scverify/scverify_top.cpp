...
public:
  ...
  sc_signal<sc_logic>                                                           TLS_result_rsc_s_tdone;
  sc_signal<sc_logic>                                                           TLS_result_rsc_tr_write_done;
  sc_signal<sc_logic>                                                           TLS_result_rsc_RREADY;
  sc_signal<sc_logic>                                                           TLS_result_rsc_RVALID;
  sc_signal<sc_logic>                                                           TLS_result_rsc_RUSER;
  sc_signal<sc_logic>                                                           TLS_result_rsc_RLAST;
  sc_signal<sc_lv<2> >                                                          TLS_result_rsc_RRESP;
  sc_signal<sc_lv<32> >                                                         TLS_result_rsc_RDATA;
  sc_signal<sc_logic>                                                           TLS_result_rsc_RID;
  sc_signal<sc_logic>                                                           TLS_result_rsc_ARREADY;
  sc_signal<sc_logic>                                                           TLS_result_rsc_ARVALID;
  sc_signal<sc_logic>                                                           TLS_result_rsc_ARUSER;
  sc_signal<sc_lv<4> >                                                          TLS_result_rsc_ARREGION;
  sc_signal<sc_lv<4> >                                                          TLS_result_rsc_ARQOS;
  sc_signal<sc_lv<3> >                                                          TLS_result_rsc_ARPROT;
  sc_signal<sc_lv<4> >                                                          TLS_result_rsc_ARCACHE;
  sc_signal<sc_logic>                                                           TLS_result_rsc_ARLOCK;
  sc_signal<sc_lv<2> >                                                          TLS_result_rsc_ARBURST;
  sc_signal<sc_lv<3> >                                                          TLS_result_rsc_ARSIZE;
  sc_signal<sc_lv<8> >                                                          TLS_result_rsc_ARLEN;
  sc_signal<sc_lv<16> >                                                         TLS_result_rsc_ARADDR;
  sc_signal<sc_logic>                                                           TLS_result_rsc_ARID;
  sc_signal<sc_logic>                                                           TLS_result_rsc_BREADY;
  sc_signal<sc_logic>                                                           TLS_result_rsc_BVALID;
  sc_signal<sc_logic>                                                           TLS_result_rsc_BUSER;
  sc_signal<sc_lv<2> >                                                          TLS_result_rsc_BRESP;
  sc_signal<sc_logic>                                                           TLS_result_rsc_BID;
  sc_signal<sc_logic>                                                           TLS_result_rsc_WREADY;
  sc_signal<sc_logic>                                                           TLS_result_rsc_WVALID;
  sc_signal<sc_logic>                                                           TLS_result_rsc_WUSER;
  sc_signal<sc_logic>                                                           TLS_result_rsc_WLAST;
  sc_signal<sc_lv<4> >                                                          TLS_result_rsc_WSTRB;
  sc_signal<sc_lv<32> >                                                         TLS_result_rsc_WDATA;
  sc_signal<sc_logic>                                                           TLS_result_rsc_AWREADY;
  sc_signal<sc_logic>                                                           TLS_result_rsc_AWVALID;
  sc_signal<sc_logic>                                                           TLS_result_rsc_AWUSER;
  sc_signal<sc_lv<4> >                                                          TLS_result_rsc_AWREGION;
  sc_signal<sc_lv<4> >                                                          TLS_result_rsc_AWQOS;
  sc_signal<sc_lv<3> >                                                          TLS_result_rsc_AWPROT;
  sc_signal<sc_lv<4> >                                                          TLS_result_rsc_AWCACHE;
  sc_signal<sc_logic>                                                           TLS_result_rsc_AWLOCK;
  sc_signal<sc_lv<2> >                                                          TLS_result_rsc_AWBURST;
  sc_signal<sc_lv<3> >                                                          TLS_result_rsc_AWSIZE;
  sc_signal<sc_lv<8> >                                                          TLS_result_rsc_AWLEN;
  sc_signal<sc_lv<16> >                                                         TLS_result_rsc_AWADDR;
  sc_signal<sc_logic>                                                           TLS_result_rsc_AWID;
  ...
  ccs_axi4_slave_mem_trans_rsc<4096,32,32,0,0,12,32,1,1,1,0,0 >                 vec_rsc_INST;
  ...
  ccs_axi4_slave_mem_trans_rsc<4096,32,32,0,0,12,32,1,1,1,0,0 >                 twiddle_rsc_INST;
  ...
  ccs_axi4_slave_mem_trans_rsc<4096,32,32,0,0,12,32,1,1,1,0,0 >                 twiddle_h_rsc_INST;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_AWID;
  ccs_sc_lv1_to_sc_logic_adapter                                                CCS_ADAPTOR_TLS_result_rsc_AWID;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_AWUSER;
  ccs_sc_lv1_to_sc_logic_adapter                                                CCS_ADAPTOR_TLS_result_rsc_AWUSER;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_WUSER;
  ccs_sc_lv1_to_sc_logic_adapter                                                CCS_ADAPTOR_TLS_result_rsc_WUSER;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_BID;
  ccs_sc_logic_to_sc_lv1_adapter                                                CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BID;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_BUSER;
  ccs_sc_logic_to_sc_lv1_adapter                                                CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BUSER;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_ARID;
  ccs_sc_lv1_to_sc_logic_adapter                                                CCS_ADAPTOR_TLS_result_rsc_ARID;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_ARUSER;
  ccs_sc_lv1_to_sc_logic_adapter                                                CCS_ADAPTOR_TLS_result_rsc_ARUSER;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_RID;
  ccs_sc_logic_to_sc_lv1_adapter                                                CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RID;
  sc_signal<sc_lv<1> >                                                          CCS_ADAPTOR_result_rsc_RUSER;
  ccs_sc_logic_to_sc_lv1_adapter                                                CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RUSER;
  ccs_axi4_slave_mem_trans_rsc<53248,32,32,0,0,16,32,1,1,1,0,0 >                result_rsc_INST;
  ...
  mc_input_transactor<mgc_sysc_ver_array1D<ac_int<32, false >,4096>,32,false>   transactor_vec;
  ...
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<32, false >,53248> >                TLS_in_fifo_result;
  tlm::tlm_fifo<mc_wait_ctrl>                                                   TLS_in_wait_ctrl_fifo_result;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<32, false >,53248> >                TLS_out_fifo_result;
  tlm::tlm_fifo<mc_wait_ctrl>                                                   TLS_out_wait_ctrl_fifo_result;
  mc_trios_inout_monitor                                                        trios_monitor_result_rsc_triosy_lz_INST;
  mc_inout_transactor<mgc_sysc_ver_array1D<ac_int<32, false >,53248>,32,false>  transactor_result;
  ...
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_staller_inst_core_wen;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_vec_rsci_inst_ntt_flat_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_re_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_vec_rsci_inst_ntt_flat_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_rrdy;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_vec_rsci_inst_ntt_flat_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_s_raddr_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_rsci_inst_ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst_twiddle_rsci_s_re_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_rsci_inst_ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst_twiddle_rsci_s_rrdy;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_rsci_inst_ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_dp_inst_twiddle_rsci_s_raddr_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_h_rsci_inst_ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst_twiddle_h_rsci_s_re_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_h_rsci_inst_ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst_twiddle_h_rsci_s_rrdy;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_h_rsci_inst_ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_dp_inst_twiddle_h_rsci_s_raddr_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst_result_rsci_s_re_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst_result_rsci_s_we_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst_result_rsci_s_rrdy;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst_result_rsci_s_wrdy;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_dp_inst_result_rsci_s_raddr_core_sct;
  sc_signal<sc_logic>                                                           OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_dp_inst_result_rsci_s_waddr_core_sct;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_result_rsc_s_tdone("TLS_result_rsc_s_tdone")
    , TLS_result_rsc_tr_write_done("TLS_result_rsc_tr_write_done")
    , TLS_result_rsc_RREADY("TLS_result_rsc_RREADY")
    , TLS_result_rsc_RVALID("TLS_result_rsc_RVALID")
    , TLS_result_rsc_RUSER("TLS_result_rsc_RUSER")
    , TLS_result_rsc_RLAST("TLS_result_rsc_RLAST")
    , TLS_result_rsc_RRESP("TLS_result_rsc_RRESP")
    , TLS_result_rsc_RDATA("TLS_result_rsc_RDATA")
    , TLS_result_rsc_RID("TLS_result_rsc_RID")
    , TLS_result_rsc_ARREADY("TLS_result_rsc_ARREADY")
    , TLS_result_rsc_ARVALID("TLS_result_rsc_ARVALID")
    , TLS_result_rsc_ARUSER("TLS_result_rsc_ARUSER")
    , TLS_result_rsc_ARREGION("TLS_result_rsc_ARREGION")
    , TLS_result_rsc_ARQOS("TLS_result_rsc_ARQOS")
    , TLS_result_rsc_ARPROT("TLS_result_rsc_ARPROT")
    , TLS_result_rsc_ARCACHE("TLS_result_rsc_ARCACHE")
    , TLS_result_rsc_ARLOCK("TLS_result_rsc_ARLOCK")
    , TLS_result_rsc_ARBURST("TLS_result_rsc_ARBURST")
    , TLS_result_rsc_ARSIZE("TLS_result_rsc_ARSIZE")
    , TLS_result_rsc_ARLEN("TLS_result_rsc_ARLEN")
    , TLS_result_rsc_ARADDR("TLS_result_rsc_ARADDR")
    , TLS_result_rsc_ARID("TLS_result_rsc_ARID")
    , TLS_result_rsc_BREADY("TLS_result_rsc_BREADY")
    , TLS_result_rsc_BVALID("TLS_result_rsc_BVALID")
    , TLS_result_rsc_BUSER("TLS_result_rsc_BUSER")
    , TLS_result_rsc_BRESP("TLS_result_rsc_BRESP")
    , TLS_result_rsc_BID("TLS_result_rsc_BID")
    , TLS_result_rsc_WREADY("TLS_result_rsc_WREADY")
    , TLS_result_rsc_WVALID("TLS_result_rsc_WVALID")
    , TLS_result_rsc_WUSER("TLS_result_rsc_WUSER")
    , TLS_result_rsc_WLAST("TLS_result_rsc_WLAST")
    , TLS_result_rsc_WSTRB("TLS_result_rsc_WSTRB")
    , TLS_result_rsc_WDATA("TLS_result_rsc_WDATA")
    , TLS_result_rsc_AWREADY("TLS_result_rsc_AWREADY")
    , TLS_result_rsc_AWVALID("TLS_result_rsc_AWVALID")
    , TLS_result_rsc_AWUSER("TLS_result_rsc_AWUSER")
    , TLS_result_rsc_AWREGION("TLS_result_rsc_AWREGION")
    , TLS_result_rsc_AWQOS("TLS_result_rsc_AWQOS")
    , TLS_result_rsc_AWPROT("TLS_result_rsc_AWPROT")
    , TLS_result_rsc_AWCACHE("TLS_result_rsc_AWCACHE")
    , TLS_result_rsc_AWLOCK("TLS_result_rsc_AWLOCK")
    , TLS_result_rsc_AWBURST("TLS_result_rsc_AWBURST")
    , TLS_result_rsc_AWSIZE("TLS_result_rsc_AWSIZE")
    , TLS_result_rsc_AWLEN("TLS_result_rsc_AWLEN")
    , TLS_result_rsc_AWADDR("TLS_result_rsc_AWADDR")
    , TLS_result_rsc_AWID("TLS_result_rsc_AWID")
    ...
    , CCS_ADAPTOR_TLS_result_rsc_AWID("CCS_ADAPTOR_TLS_result_rsc_AWID")
    , CCS_ADAPTOR_TLS_result_rsc_AWUSER("CCS_ADAPTOR_TLS_result_rsc_AWUSER")
    , CCS_ADAPTOR_TLS_result_rsc_WUSER("CCS_ADAPTOR_TLS_result_rsc_WUSER")
    , CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BID("CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BID")
    , CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BUSER("CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BUSER")
    , CCS_ADAPTOR_TLS_result_rsc_ARID("CCS_ADAPTOR_TLS_result_rsc_ARID")
    , CCS_ADAPTOR_TLS_result_rsc_ARUSER("CCS_ADAPTOR_TLS_result_rsc_ARUSER")
    , CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RID("CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RID")
    , CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RUSER("CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RUSER")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 57526, 57526, 0)
    , catapult_monitor_INST("Monitor", clk, true, 57526LL, 57526LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    ntt_flat_INST.vec_rsc_s_tdone(TLS_vec_rsc_s_tdone);
    ntt_flat_INST.vec_rsc_tr_write_done(TLS_vec_rsc_tr_write_done);
    ntt_flat_INST.vec_rsc_RREADY(TLS_vec_rsc_RREADY);
    ntt_flat_INST.vec_rsc_RVALID(TLS_vec_rsc_RVALID);
    ntt_flat_INST.vec_rsc_RUSER(TLS_vec_rsc_RUSER);
    ntt_flat_INST.vec_rsc_RLAST(TLS_vec_rsc_RLAST);
    ntt_flat_INST.vec_rsc_RRESP(TLS_vec_rsc_RRESP);
    ntt_flat_INST.vec_rsc_RDATA(TLS_vec_rsc_RDATA);
    ntt_flat_INST.vec_rsc_RID(TLS_vec_rsc_RID);
    ntt_flat_INST.vec_rsc_ARREADY(TLS_vec_rsc_ARREADY);
    ntt_flat_INST.vec_rsc_ARVALID(TLS_vec_rsc_ARVALID);
    ntt_flat_INST.vec_rsc_ARUSER(TLS_vec_rsc_ARUSER);
    ntt_flat_INST.vec_rsc_ARREGION(TLS_vec_rsc_ARREGION);
    ntt_flat_INST.vec_rsc_ARQOS(TLS_vec_rsc_ARQOS);
    ntt_flat_INST.vec_rsc_ARPROT(TLS_vec_rsc_ARPROT);
    ntt_flat_INST.vec_rsc_ARCACHE(TLS_vec_rsc_ARCACHE);
    ntt_flat_INST.vec_rsc_ARLOCK(TLS_vec_rsc_ARLOCK);
    ntt_flat_INST.vec_rsc_ARBURST(TLS_vec_rsc_ARBURST);
    ntt_flat_INST.vec_rsc_ARSIZE(TLS_vec_rsc_ARSIZE);
    ntt_flat_INST.vec_rsc_ARLEN(TLS_vec_rsc_ARLEN);
    ntt_flat_INST.vec_rsc_ARADDR(TLS_vec_rsc_ARADDR);
    ntt_flat_INST.vec_rsc_ARID(TLS_vec_rsc_ARID);
    ntt_flat_INST.vec_rsc_BREADY(TLS_vec_rsc_BREADY);
    ntt_flat_INST.vec_rsc_BVALID(TLS_vec_rsc_BVALID);
    ntt_flat_INST.vec_rsc_BUSER(TLS_vec_rsc_BUSER);
    ntt_flat_INST.vec_rsc_BRESP(TLS_vec_rsc_BRESP);
    ntt_flat_INST.vec_rsc_BID(TLS_vec_rsc_BID);
    ntt_flat_INST.vec_rsc_WREADY(TLS_vec_rsc_WREADY);
    ntt_flat_INST.vec_rsc_WVALID(TLS_vec_rsc_WVALID);
    ntt_flat_INST.vec_rsc_WUSER(TLS_vec_rsc_WUSER);
    ntt_flat_INST.vec_rsc_WLAST(TLS_vec_rsc_WLAST);
    ntt_flat_INST.vec_rsc_WSTRB(TLS_vec_rsc_WSTRB);
    ntt_flat_INST.vec_rsc_WDATA(TLS_vec_rsc_WDATA);
    ntt_flat_INST.vec_rsc_AWREADY(TLS_vec_rsc_AWREADY);
    ntt_flat_INST.vec_rsc_AWVALID(TLS_vec_rsc_AWVALID);
    ntt_flat_INST.vec_rsc_AWUSER(TLS_vec_rsc_AWUSER);
    ntt_flat_INST.vec_rsc_AWREGION(TLS_vec_rsc_AWREGION);
    ntt_flat_INST.vec_rsc_AWQOS(TLS_vec_rsc_AWQOS);
    ntt_flat_INST.vec_rsc_AWPROT(TLS_vec_rsc_AWPROT);
    ntt_flat_INST.vec_rsc_AWCACHE(TLS_vec_rsc_AWCACHE);
    ntt_flat_INST.vec_rsc_AWLOCK(TLS_vec_rsc_AWLOCK);
    ntt_flat_INST.vec_rsc_AWBURST(TLS_vec_rsc_AWBURST);
    ntt_flat_INST.vec_rsc_AWSIZE(TLS_vec_rsc_AWSIZE);
    ntt_flat_INST.vec_rsc_AWLEN(TLS_vec_rsc_AWLEN);
    ntt_flat_INST.vec_rsc_AWADDR(TLS_vec_rsc_AWADDR);
    ntt_flat_INST.vec_rsc_AWID(TLS_vec_rsc_AWID);
    ...
    ntt_flat_INST.twiddle_rsc_s_tdone(TLS_twiddle_rsc_s_tdone);
    ntt_flat_INST.twiddle_rsc_tr_write_done(TLS_twiddle_rsc_tr_write_done);
    ntt_flat_INST.twiddle_rsc_RREADY(TLS_twiddle_rsc_RREADY);
    ntt_flat_INST.twiddle_rsc_RVALID(TLS_twiddle_rsc_RVALID);
    ntt_flat_INST.twiddle_rsc_RUSER(TLS_twiddle_rsc_RUSER);
    ntt_flat_INST.twiddle_rsc_RLAST(TLS_twiddle_rsc_RLAST);
    ntt_flat_INST.twiddle_rsc_RRESP(TLS_twiddle_rsc_RRESP);
    ntt_flat_INST.twiddle_rsc_RDATA(TLS_twiddle_rsc_RDATA);
    ntt_flat_INST.twiddle_rsc_RID(TLS_twiddle_rsc_RID);
    ntt_flat_INST.twiddle_rsc_ARREADY(TLS_twiddle_rsc_ARREADY);
    ntt_flat_INST.twiddle_rsc_ARVALID(TLS_twiddle_rsc_ARVALID);
    ntt_flat_INST.twiddle_rsc_ARUSER(TLS_twiddle_rsc_ARUSER);
    ntt_flat_INST.twiddle_rsc_ARREGION(TLS_twiddle_rsc_ARREGION);
    ntt_flat_INST.twiddle_rsc_ARQOS(TLS_twiddle_rsc_ARQOS);
    ntt_flat_INST.twiddle_rsc_ARPROT(TLS_twiddle_rsc_ARPROT);
    ntt_flat_INST.twiddle_rsc_ARCACHE(TLS_twiddle_rsc_ARCACHE);
    ntt_flat_INST.twiddle_rsc_ARLOCK(TLS_twiddle_rsc_ARLOCK);
    ntt_flat_INST.twiddle_rsc_ARBURST(TLS_twiddle_rsc_ARBURST);
    ntt_flat_INST.twiddle_rsc_ARSIZE(TLS_twiddle_rsc_ARSIZE);
    ntt_flat_INST.twiddle_rsc_ARLEN(TLS_twiddle_rsc_ARLEN);
    ntt_flat_INST.twiddle_rsc_ARADDR(TLS_twiddle_rsc_ARADDR);
    ntt_flat_INST.twiddle_rsc_ARID(TLS_twiddle_rsc_ARID);
    ntt_flat_INST.twiddle_rsc_BREADY(TLS_twiddle_rsc_BREADY);
    ntt_flat_INST.twiddle_rsc_BVALID(TLS_twiddle_rsc_BVALID);
    ntt_flat_INST.twiddle_rsc_BUSER(TLS_twiddle_rsc_BUSER);
    ntt_flat_INST.twiddle_rsc_BRESP(TLS_twiddle_rsc_BRESP);
    ntt_flat_INST.twiddle_rsc_BID(TLS_twiddle_rsc_BID);
    ntt_flat_INST.twiddle_rsc_WREADY(TLS_twiddle_rsc_WREADY);
    ntt_flat_INST.twiddle_rsc_WVALID(TLS_twiddle_rsc_WVALID);
    ntt_flat_INST.twiddle_rsc_WUSER(TLS_twiddle_rsc_WUSER);
    ntt_flat_INST.twiddle_rsc_WLAST(TLS_twiddle_rsc_WLAST);
    ntt_flat_INST.twiddle_rsc_WSTRB(TLS_twiddle_rsc_WSTRB);
    ntt_flat_INST.twiddle_rsc_WDATA(TLS_twiddle_rsc_WDATA);
    ntt_flat_INST.twiddle_rsc_AWREADY(TLS_twiddle_rsc_AWREADY);
    ntt_flat_INST.twiddle_rsc_AWVALID(TLS_twiddle_rsc_AWVALID);
    ntt_flat_INST.twiddle_rsc_AWUSER(TLS_twiddle_rsc_AWUSER);
    ntt_flat_INST.twiddle_rsc_AWREGION(TLS_twiddle_rsc_AWREGION);
    ntt_flat_INST.twiddle_rsc_AWQOS(TLS_twiddle_rsc_AWQOS);
    ntt_flat_INST.twiddle_rsc_AWPROT(TLS_twiddle_rsc_AWPROT);
    ntt_flat_INST.twiddle_rsc_AWCACHE(TLS_twiddle_rsc_AWCACHE);
    ntt_flat_INST.twiddle_rsc_AWLOCK(TLS_twiddle_rsc_AWLOCK);
    ntt_flat_INST.twiddle_rsc_AWBURST(TLS_twiddle_rsc_AWBURST);
    ntt_flat_INST.twiddle_rsc_AWSIZE(TLS_twiddle_rsc_AWSIZE);
    ntt_flat_INST.twiddle_rsc_AWLEN(TLS_twiddle_rsc_AWLEN);
    ntt_flat_INST.twiddle_rsc_AWADDR(TLS_twiddle_rsc_AWADDR);
    ntt_flat_INST.twiddle_rsc_AWID(TLS_twiddle_rsc_AWID);
    ntt_flat_INST.twiddle_rsc_triosy_lz(TLS_twiddle_rsc_triosy_lz);
    ntt_flat_INST.twiddle_h_rsc_s_tdone(TLS_twiddle_h_rsc_s_tdone);
    ntt_flat_INST.twiddle_h_rsc_tr_write_done(TLS_twiddle_h_rsc_tr_write_done);
    ntt_flat_INST.twiddle_h_rsc_RREADY(TLS_twiddle_h_rsc_RREADY);
    ntt_flat_INST.twiddle_h_rsc_RVALID(TLS_twiddle_h_rsc_RVALID);
    ntt_flat_INST.twiddle_h_rsc_RUSER(TLS_twiddle_h_rsc_RUSER);
    ntt_flat_INST.twiddle_h_rsc_RLAST(TLS_twiddle_h_rsc_RLAST);
    ntt_flat_INST.twiddle_h_rsc_RRESP(TLS_twiddle_h_rsc_RRESP);
    ntt_flat_INST.twiddle_h_rsc_RDATA(TLS_twiddle_h_rsc_RDATA);
    ntt_flat_INST.twiddle_h_rsc_RID(TLS_twiddle_h_rsc_RID);
    ntt_flat_INST.twiddle_h_rsc_ARREADY(TLS_twiddle_h_rsc_ARREADY);
    ntt_flat_INST.twiddle_h_rsc_ARVALID(TLS_twiddle_h_rsc_ARVALID);
    ntt_flat_INST.twiddle_h_rsc_ARUSER(TLS_twiddle_h_rsc_ARUSER);
    ntt_flat_INST.twiddle_h_rsc_ARREGION(TLS_twiddle_h_rsc_ARREGION);
    ntt_flat_INST.twiddle_h_rsc_ARQOS(TLS_twiddle_h_rsc_ARQOS);
    ntt_flat_INST.twiddle_h_rsc_ARPROT(TLS_twiddle_h_rsc_ARPROT);
    ntt_flat_INST.twiddle_h_rsc_ARCACHE(TLS_twiddle_h_rsc_ARCACHE);
    ntt_flat_INST.twiddle_h_rsc_ARLOCK(TLS_twiddle_h_rsc_ARLOCK);
    ntt_flat_INST.twiddle_h_rsc_ARBURST(TLS_twiddle_h_rsc_ARBURST);
    ntt_flat_INST.twiddle_h_rsc_ARSIZE(TLS_twiddle_h_rsc_ARSIZE);
    ntt_flat_INST.twiddle_h_rsc_ARLEN(TLS_twiddle_h_rsc_ARLEN);
    ntt_flat_INST.twiddle_h_rsc_ARADDR(TLS_twiddle_h_rsc_ARADDR);
    ntt_flat_INST.twiddle_h_rsc_ARID(TLS_twiddle_h_rsc_ARID);
    ntt_flat_INST.twiddle_h_rsc_BREADY(TLS_twiddle_h_rsc_BREADY);
    ntt_flat_INST.twiddle_h_rsc_BVALID(TLS_twiddle_h_rsc_BVALID);
    ntt_flat_INST.twiddle_h_rsc_BUSER(TLS_twiddle_h_rsc_BUSER);
    ntt_flat_INST.twiddle_h_rsc_BRESP(TLS_twiddle_h_rsc_BRESP);
    ntt_flat_INST.twiddle_h_rsc_BID(TLS_twiddle_h_rsc_BID);
    ntt_flat_INST.twiddle_h_rsc_WREADY(TLS_twiddle_h_rsc_WREADY);
    ntt_flat_INST.twiddle_h_rsc_WVALID(TLS_twiddle_h_rsc_WVALID);
    ntt_flat_INST.twiddle_h_rsc_WUSER(TLS_twiddle_h_rsc_WUSER);
    ntt_flat_INST.twiddle_h_rsc_WLAST(TLS_twiddle_h_rsc_WLAST);
    ntt_flat_INST.twiddle_h_rsc_WSTRB(TLS_twiddle_h_rsc_WSTRB);
    ntt_flat_INST.twiddle_h_rsc_WDATA(TLS_twiddle_h_rsc_WDATA);
    ntt_flat_INST.twiddle_h_rsc_AWREADY(TLS_twiddle_h_rsc_AWREADY);
    ntt_flat_INST.twiddle_h_rsc_AWVALID(TLS_twiddle_h_rsc_AWVALID);
    ntt_flat_INST.twiddle_h_rsc_AWUSER(TLS_twiddle_h_rsc_AWUSER);
    ntt_flat_INST.twiddle_h_rsc_AWREGION(TLS_twiddle_h_rsc_AWREGION);
    ntt_flat_INST.twiddle_h_rsc_AWQOS(TLS_twiddle_h_rsc_AWQOS);
    ntt_flat_INST.twiddle_h_rsc_AWPROT(TLS_twiddle_h_rsc_AWPROT);
    ntt_flat_INST.twiddle_h_rsc_AWCACHE(TLS_twiddle_h_rsc_AWCACHE);
    ntt_flat_INST.twiddle_h_rsc_AWLOCK(TLS_twiddle_h_rsc_AWLOCK);
    ntt_flat_INST.twiddle_h_rsc_AWBURST(TLS_twiddle_h_rsc_AWBURST);
    ntt_flat_INST.twiddle_h_rsc_AWSIZE(TLS_twiddle_h_rsc_AWSIZE);
    ntt_flat_INST.twiddle_h_rsc_AWLEN(TLS_twiddle_h_rsc_AWLEN);
    ntt_flat_INST.twiddle_h_rsc_AWADDR(TLS_twiddle_h_rsc_AWADDR);
    ntt_flat_INST.twiddle_h_rsc_AWID(TLS_twiddle_h_rsc_AWID);
    ntt_flat_INST.twiddle_h_rsc_triosy_lz(TLS_twiddle_h_rsc_triosy_lz);
    ntt_flat_INST.result_rsc_s_tdone(TLS_result_rsc_s_tdone);
    ntt_flat_INST.result_rsc_tr_write_done(TLS_result_rsc_tr_write_done);
    ntt_flat_INST.result_rsc_RREADY(TLS_result_rsc_RREADY);
    ntt_flat_INST.result_rsc_RVALID(TLS_result_rsc_RVALID);
    ntt_flat_INST.result_rsc_RUSER(TLS_result_rsc_RUSER);
    ntt_flat_INST.result_rsc_RLAST(TLS_result_rsc_RLAST);
    ntt_flat_INST.result_rsc_RRESP(TLS_result_rsc_RRESP);
    ntt_flat_INST.result_rsc_RDATA(TLS_result_rsc_RDATA);
    ntt_flat_INST.result_rsc_RID(TLS_result_rsc_RID);
    ntt_flat_INST.result_rsc_ARREADY(TLS_result_rsc_ARREADY);
    ntt_flat_INST.result_rsc_ARVALID(TLS_result_rsc_ARVALID);
    ntt_flat_INST.result_rsc_ARUSER(TLS_result_rsc_ARUSER);
    ntt_flat_INST.result_rsc_ARREGION(TLS_result_rsc_ARREGION);
    ntt_flat_INST.result_rsc_ARQOS(TLS_result_rsc_ARQOS);
    ntt_flat_INST.result_rsc_ARPROT(TLS_result_rsc_ARPROT);
    ntt_flat_INST.result_rsc_ARCACHE(TLS_result_rsc_ARCACHE);
    ntt_flat_INST.result_rsc_ARLOCK(TLS_result_rsc_ARLOCK);
    ntt_flat_INST.result_rsc_ARBURST(TLS_result_rsc_ARBURST);
    ntt_flat_INST.result_rsc_ARSIZE(TLS_result_rsc_ARSIZE);
    ntt_flat_INST.result_rsc_ARLEN(TLS_result_rsc_ARLEN);
    ntt_flat_INST.result_rsc_ARADDR(TLS_result_rsc_ARADDR);
    ntt_flat_INST.result_rsc_ARID(TLS_result_rsc_ARID);
    ntt_flat_INST.result_rsc_BREADY(TLS_result_rsc_BREADY);
    ntt_flat_INST.result_rsc_BVALID(TLS_result_rsc_BVALID);
    ntt_flat_INST.result_rsc_BUSER(TLS_result_rsc_BUSER);
    ntt_flat_INST.result_rsc_BRESP(TLS_result_rsc_BRESP);
    ntt_flat_INST.result_rsc_BID(TLS_result_rsc_BID);
    ntt_flat_INST.result_rsc_WREADY(TLS_result_rsc_WREADY);
    ntt_flat_INST.result_rsc_WVALID(TLS_result_rsc_WVALID);
    ntt_flat_INST.result_rsc_WUSER(TLS_result_rsc_WUSER);
    ntt_flat_INST.result_rsc_WLAST(TLS_result_rsc_WLAST);
    ntt_flat_INST.result_rsc_WSTRB(TLS_result_rsc_WSTRB);
    ntt_flat_INST.result_rsc_WDATA(TLS_result_rsc_WDATA);
    ntt_flat_INST.result_rsc_AWREADY(TLS_result_rsc_AWREADY);
    ntt_flat_INST.result_rsc_AWVALID(TLS_result_rsc_AWVALID);
    ntt_flat_INST.result_rsc_AWUSER(TLS_result_rsc_AWUSER);
    ntt_flat_INST.result_rsc_AWREGION(TLS_result_rsc_AWREGION);
    ntt_flat_INST.result_rsc_AWQOS(TLS_result_rsc_AWQOS);
    ntt_flat_INST.result_rsc_AWPROT(TLS_result_rsc_AWPROT);
    ntt_flat_INST.result_rsc_AWCACHE(TLS_result_rsc_AWCACHE);
    ntt_flat_INST.result_rsc_AWLOCK(TLS_result_rsc_AWLOCK);
    ntt_flat_INST.result_rsc_AWBURST(TLS_result_rsc_AWBURST);
    ntt_flat_INST.result_rsc_AWSIZE(TLS_result_rsc_AWSIZE);
    ntt_flat_INST.result_rsc_AWLEN(TLS_result_rsc_AWLEN);
    ntt_flat_INST.result_rsc_AWADDR(TLS_result_rsc_AWADDR);
    ntt_flat_INST.result_rsc_AWID(TLS_result_rsc_AWID);
    ...
    CCS_ADAPTOR_TLS_result_rsc_AWID.inVECTOR(CCS_ADAPTOR_result_rsc_AWID);
    CCS_ADAPTOR_TLS_result_rsc_AWID.outSCALAR(TLS_result_rsc_AWID);

    CCS_ADAPTOR_TLS_result_rsc_AWUSER.inVECTOR(CCS_ADAPTOR_result_rsc_AWUSER);
    CCS_ADAPTOR_TLS_result_rsc_AWUSER.outSCALAR(TLS_result_rsc_AWUSER);

    CCS_ADAPTOR_TLS_result_rsc_WUSER.inVECTOR(CCS_ADAPTOR_result_rsc_WUSER);
    CCS_ADAPTOR_TLS_result_rsc_WUSER.outSCALAR(TLS_result_rsc_WUSER);

    CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BID.inSCALAR(TLS_result_rsc_BID);
    CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BID.outVECTOR(CCS_ADAPTOR_result_rsc_BID);

    CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BUSER.inSCALAR(TLS_result_rsc_BUSER);
    CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_BUSER.outVECTOR(CCS_ADAPTOR_result_rsc_BUSER);

    CCS_ADAPTOR_TLS_result_rsc_ARID.inVECTOR(CCS_ADAPTOR_result_rsc_ARID);
    CCS_ADAPTOR_TLS_result_rsc_ARID.outSCALAR(TLS_result_rsc_ARID);

    CCS_ADAPTOR_TLS_result_rsc_ARUSER.inVECTOR(CCS_ADAPTOR_result_rsc_ARUSER);
    CCS_ADAPTOR_TLS_result_rsc_ARUSER.outSCALAR(TLS_result_rsc_ARUSER);

    CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RID.inSCALAR(TLS_result_rsc_RID);
    CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RID.outVECTOR(CCS_ADAPTOR_result_rsc_RID);

    CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RUSER.inSCALAR(TLS_result_rsc_RUSER);
    CCS_ADAPTOR_CCS_ADAPTOR_result_rsc_RUSER.outVECTOR(CCS_ADAPTOR_result_rsc_RUSER);

    result_rsc_INST.ACLK(clk);
    result_rsc_INST.ARESETn(rst);
    result_rsc_INST.AWID(CCS_ADAPTOR_result_rsc_AWID);
    result_rsc_INST.AWADDR(TLS_result_rsc_AWADDR);
    result_rsc_INST.AWLEN(TLS_result_rsc_AWLEN);
    result_rsc_INST.AWSIZE(TLS_result_rsc_AWSIZE);
    result_rsc_INST.AWBURST(TLS_result_rsc_AWBURST);
    result_rsc_INST.AWLOCK(TLS_result_rsc_AWLOCK);
    result_rsc_INST.AWCACHE(TLS_result_rsc_AWCACHE);
    result_rsc_INST.AWPROT(TLS_result_rsc_AWPROT);
    result_rsc_INST.AWQOS(TLS_result_rsc_AWQOS);
    result_rsc_INST.AWREGION(TLS_result_rsc_AWREGION);
    result_rsc_INST.AWUSER(CCS_ADAPTOR_result_rsc_AWUSER);
    result_rsc_INST.AWVALID(TLS_result_rsc_AWVALID);
    result_rsc_INST.AWREADY(TLS_result_rsc_AWREADY);
    result_rsc_INST.WDATA(TLS_result_rsc_WDATA);
    result_rsc_INST.WSTRB(TLS_result_rsc_WSTRB);
    result_rsc_INST.WLAST(TLS_result_rsc_WLAST);
    result_rsc_INST.WUSER(CCS_ADAPTOR_result_rsc_WUSER);
    result_rsc_INST.WVALID(TLS_result_rsc_WVALID);
    result_rsc_INST.WREADY(TLS_result_rsc_WREADY);
    result_rsc_INST.BID(CCS_ADAPTOR_result_rsc_BID);
    result_rsc_INST.BRESP(TLS_result_rsc_BRESP);
    result_rsc_INST.BUSER(CCS_ADAPTOR_result_rsc_BUSER);
    result_rsc_INST.BVALID(TLS_result_rsc_BVALID);
    result_rsc_INST.BREADY(TLS_result_rsc_BREADY);
    result_rsc_INST.ARID(CCS_ADAPTOR_result_rsc_ARID);
    result_rsc_INST.ARADDR(TLS_result_rsc_ARADDR);
    result_rsc_INST.ARLEN(TLS_result_rsc_ARLEN);
    result_rsc_INST.ARSIZE(TLS_result_rsc_ARSIZE);
    result_rsc_INST.ARBURST(TLS_result_rsc_ARBURST);
    result_rsc_INST.ARLOCK(TLS_result_rsc_ARLOCK);
    result_rsc_INST.ARCACHE(TLS_result_rsc_ARCACHE);
    result_rsc_INST.ARPROT(TLS_result_rsc_ARPROT);
    result_rsc_INST.ARQOS(TLS_result_rsc_ARQOS);
    result_rsc_INST.ARREGION(TLS_result_rsc_ARREGION);
    result_rsc_INST.ARUSER(CCS_ADAPTOR_result_rsc_ARUSER);
    result_rsc_INST.ARVALID(TLS_result_rsc_ARVALID);
    result_rsc_INST.ARREADY(TLS_result_rsc_ARREADY);
    result_rsc_INST.RID(CCS_ADAPTOR_result_rsc_RID);
    result_rsc_INST.RDATA(TLS_result_rsc_RDATA);
    result_rsc_INST.RRESP(TLS_result_rsc_RRESP);
    result_rsc_INST.RLAST(TLS_result_rsc_RLAST);
    result_rsc_INST.RUSER(CCS_ADAPTOR_result_rsc_RUSER);
    result_rsc_INST.RVALID(TLS_result_rsc_RVALID);
    result_rsc_INST.RREADY(TLS_result_rsc_RREADY);
    result_rsc_INST.tr_write_done(TLS_result_rsc_tr_write_done);
    result_rsc_INST.s_tdone(TLS_result_rsc_s_tdone);
...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_staller_inst_core_wen, /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_staller_inst/core_wen);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_vec_rsci_inst_ntt_flat_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_re_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_vec_rsci_inst/ntt_flat_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_s_re_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_vec_rsci_inst_ntt_flat_core_vec_rsci_vec_rsc_wait_ctrl_inst_vec_rsci_s_rrdy,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_vec_rsci_inst/ntt_flat_core_vec_rsci_vec_rsc_wait_ctrl_inst/vec_rsci_s_rrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_vec_rsci_inst_ntt_flat_core_vec_rsci_vec_rsc_wait_dp_inst_vec_rsci_s_raddr_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_vec_rsci_inst/ntt_flat_core_vec_rsci_vec_rsc_wait_dp_inst/vec_rsci_s_raddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_rsci_inst_ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst_twiddle_rsci_s_re_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_twiddle_rsci_inst/ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst/twiddle_rsci_s_re_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_rsci_inst_ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst_twiddle_rsci_s_rrdy,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_twiddle_rsci_inst/ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_ctrl_inst/twiddle_rsci_s_rrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_rsci_inst_ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_dp_inst_twiddle_rsci_s_raddr_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_twiddle_rsci_inst/ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_dp_inst/twiddle_rsci_s_raddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_h_rsci_inst_ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst_twiddle_h_rsci_s_re_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_twiddle_h_rsci_inst/ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst/twiddle_h_rsci_s_re_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_h_rsci_inst_ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst_twiddle_h_rsci_s_rrdy,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_twiddle_h_rsci_inst/ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_ctrl_inst/twiddle_h_rsci_s_rrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_twiddle_h_rsci_inst_ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_dp_inst_twiddle_h_rsci_s_raddr_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_twiddle_h_rsci_inst/ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_dp_inst/twiddle_h_rsci_s_raddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst_result_rsci_s_re_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_result_rsci_inst/ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst/result_rsci_s_re_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst_result_rsci_s_we_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_result_rsci_inst/ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst/result_rsci_s_we_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst_result_rsci_s_rrdy,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_result_rsci_inst/ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst/result_rsci_s_rrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst_result_rsci_s_wrdy,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_result_rsci_inst/ntt_flat_core_result_rsci_result_rsc_wait_ctrl_inst/result_rsci_s_wrdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_dp_inst_result_rsci_s_raddr_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_result_rsci_inst/ntt_flat_core_result_rsci_result_rsc_wait_dp_inst/result_rsci_s_raddr_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_ntt_flat_core_inst_ntt_flat_core_result_rsci_inst_ntt_flat_core_result_rsci_result_rsc_wait_dp_inst_result_rsci_s_waddr_core_sct,
      /scverify_top/rtl/ntt_flat_core_inst/ntt_flat_core_result_rsci_inst/ntt_flat_core_result_rsci_result_rsc_wait_dp_inst/result_rsci_s_waddr_core_sct);
#endif
#endif
}
