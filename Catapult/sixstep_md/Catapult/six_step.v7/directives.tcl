...
go assembly
directive set /six_step/x:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_DPRAM_RBW_DUAL
directive set /six_step/x:rsc -BLOCK_SIZE 32
directive set /six_step/core/xx:rsc -BLOCK_SIZE 32
directive set /six_step/core/yy:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_2R1W_RBW_DUAL
...
directive set /six_step/core/S2_INNER_LOOP -PIPELINE_INIT_INTERVAL 0
directive set /six_step/core/S5_INNER_LOOP -PIPELINE_INIT_INTERVAL 0
directive set /six_step/core/xx:rsc -MAP_TO_MODULE Xilinx_RAMS.BLOCK_DPRAM_RBW_DUAL
directive set /six_step/core/S2_GROUP_LOOP -PIPELINE_INIT_INTERVAL 2
