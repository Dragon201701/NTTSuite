...
--               D:/NTT_Xilinx/NTT_Vivado/NTT_Vivado.srcs/sources_1/bd/NTT/ip/NTT_util_ds_buf_0/NTT_util_ds_buf_0_sim_netlist.vhdl
...
entity NTT_util_ds_buf_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of NTT_util_ds_buf_0_util_ds_buf : entity is 1;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of NTT_util_ds_buf_0_util_ds_buf : entity is "ibufdsgte2";
  attribute C_SIZE : integer;
  attribute C_SIZE of NTT_util_ds_buf_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of NTT_util_ds_buf_0_util_ds_buf : entity is "util_ds_buf";
end NTT_util_ds_buf_0_util_ds_buf;

architecture STRUCTURE of NTT_util_ds_buf_0_util_ds_buf is
...
entity NTT_util_ds_buf_0 is
  ...
  attribute NotValidForBitStream of NTT_util_ds_buf_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of NTT_util_ds_buf_0 : entity is "NTT_util_ds_buf_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of NTT_util_ds_buf_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of NTT_util_ds_buf_0 : entity is "util_ds_buf,Vivado 2019.1";
end NTT_util_ds_buf_0;

architecture STRUCTURE of NTT_util_ds_buf_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN NTT_util_ds_buf_0_IBUF_DS_ODIV2, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN NTT_util_ds_buf_0_IBUF_OUT, INSERT_VIP 0";
begin
U0: entity work.NTT_util_ds_buf_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
