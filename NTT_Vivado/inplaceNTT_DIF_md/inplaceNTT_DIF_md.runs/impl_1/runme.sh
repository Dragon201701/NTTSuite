...
HD_PWD='D:/NTT_Xilinx/NTT_Vivado/inplaceNTT_DIF_md/inplaceNTT_DIF_md.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inPlaceNTT_DIF_precomp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inPlaceNTT_DIF_precomp.tcl -notrace
