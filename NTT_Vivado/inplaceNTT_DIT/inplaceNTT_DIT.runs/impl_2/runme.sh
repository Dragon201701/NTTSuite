...
HD_PWD='D:/NTT_Xilinx/NTT_Vivado/inplaceNTT_DIT/inplaceNTT_DIT.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log inPlaceNTT_DIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inPlaceNTT_DIT.tcl -notrace
