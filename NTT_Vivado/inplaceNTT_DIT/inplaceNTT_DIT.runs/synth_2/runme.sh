...
HD_PWD='D:/NTT_Xilinx/NTT_Vivado/inplaceNTT_DIT/inplaceNTT_DIT.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log inPlaceNTT_DIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inPlaceNTT_DIT.tcl
