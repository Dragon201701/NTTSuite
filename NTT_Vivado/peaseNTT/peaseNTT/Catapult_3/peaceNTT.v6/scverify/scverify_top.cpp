...
public:
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    peaceNTT_INST.vec_rsc_radr(TLS_vec_rsc_radr);
    peaceNTT_INST.vec_rsc_q(TLS_vec_rsc_q);
    ...
    peaceNTT_INST.result_rsc_wadr(TLS_result_rsc_wadr);
    peaceNTT_INST.result_rsc_d(TLS_result_rsc_d);
    peaceNTT_INST.result_rsc_we(TLS_result_rsc_we);
    peaceNTT_INST.result_rsc_radr(TLS_result_rsc_radr);
    peaceNTT_INST.result_rsc_q(TLS_result_rsc_q);
