...
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP CSTEPS_FROM {{. == 183} {.. == 1}}
...
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/COMP_LOOP:acc#1 CSTEPS_FROM {{.. == 89}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/modulo_dev:result:rem CSTEPS_FROM {{.. == 135}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/modulo_dev:qelse:acc CSTEPS_FROM {{.. == 182}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/modulo_dev:mux CSTEPS_FROM {{.. == 182}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/COMP_LOOP:write_mem(result:rsc.@) CSTEPS_FROM {{.. == 182}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/COMP_LOOP:acc#3 CSTEPS_FROM {{.. == 89}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/modulo_dev#1:result:rem CSTEPS_FROM {{.. == 89}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/modulo_dev#1:qelse:acc CSTEPS_FROM {{.. == 136}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/modulo_dev#1:mux CSTEPS_FROM {{.. == 136}}
directive set /peaceNTT/core/core:rlp/main/STAGE_LOOP/COMP_LOOP/COMP_LOOP:write_mem(result:rsc.@)#1 CSTEPS_FROM {{.. == 136}}
