...
public:
  ...
  sc_out<sc_lv<64> > vec_rsc_da;
  sc_out<sc_logic> vec_rsc_wea;
  sc_in<sc_lv<64> > vec_rsc_qa;
  sc_out<sc_lv<10> > vec_rsc_adrb;
  sc_out<sc_lv<64> > vec_rsc_db;
  sc_out<sc_logic> vec_rsc_web;
  sc_in<sc_lv<64> > vec_rsc_qb;
  ...
  sc_out<sc_lv<10> > result_rsc_adra;
  sc_out<sc_lv<64> > result_rsc_da;
  sc_out<sc_logic> result_rsc_wea;
  sc_in<sc_lv<64> > result_rsc_qa;
  sc_out<sc_lv<10> > result_rsc_adrb;
  sc_out<sc_lv<64> > result_rsc_db;
  sc_out<sc_logic> result_rsc_web;
  sc_in<sc_lv<64> > result_rsc_qb;
  sc_out<sc_logic> result_rsc_triosy_lz;
  sc_out<sc_lv<10> > twiddle_rsc_radr;
  sc_in<sc_lv<64> > twiddle_rsc_q;
