...
#include "../../../../../../NTT_Xilinx/Catapult/peaseNTT/include/ntt.h"
#include "../../../../../../NTT_Xilinx/Catapult/peaseNTT/include/utils.h"
...
public:
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_int<64, false >,1024> , MaskPacket< 0, 64 > > *result_comp;
   
   // Interface Ports
   sc_in< bool > clk;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<64, false >,1024> > > ccs_vec;
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<64, false >,1024> > > ccs_result_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_result_IN;
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_int<64, false >,1024> > > ccs_result;
   ...
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_int<64, false >,1024>, MaskPacket<0, 64> > > result_golden;
      ...
      , result_golden("result_golden",-1)
   {
      ...
      result_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_int<64, false >,1024> , MaskPacket< 0, 64 > > (
         "result_comp",
         "result",
         0,
         0,
   ...
   public:
      void capture_result_IN( ac_int<64, false > result[1024]) ;
   public:
      void capture_result( ac_int<64, false > result[1024]) ;
   public:
      void capture_twiddle( ac_int<64, false > twiddle[1024]) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[1024],  ac_int<64, false > twiddle[1024]) ;
   public:
      static void capture_OUT( ac_int<64, false > vec[1024], ac_int<64, false > p, ac_int<64, false > g,  ac_int<64, false > result[1024],  ac_int<64, false > twiddle[1024]) ;
   public:
