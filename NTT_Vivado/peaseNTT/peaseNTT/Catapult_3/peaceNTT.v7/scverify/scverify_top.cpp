...
public:
  ...
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_da;
  sc_signal<sc_logic>                                                          TLS_vec_rsc_wea;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_qa;
  sc_signal<sc_lv<10> >                                                        TLS_vec_rsc_adrb;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_db;
  sc_signal<sc_logic>                                                          TLS_vec_rsc_web;
  sc_signal<sc_lv<64> >                                                        TLS_vec_rsc_qb;
  ...
  sc_signal<sc_lv<10> >                                                        TLS_result_rsc_adra;
  sc_signal<sc_lv<64> >                                                        TLS_result_rsc_da;
  sc_signal<sc_logic>                                                          TLS_result_rsc_wea;
  sc_signal<sc_lv<64> >                                                        TLS_result_rsc_qa;
  sc_signal<sc_lv<10> >                                                        TLS_result_rsc_adrb;
  sc_signal<sc_lv<64> >                                                        TLS_result_rsc_db;
  sc_signal<sc_logic>                                                          TLS_result_rsc_web;
  sc_signal<sc_lv<64> >                                                        TLS_result_rsc_qb;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 986134, 986134, 0)
    , catapult_monitor_INST("Monitor", clk, true, 986134LL, 986134LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    peaceNTT_INST.vec_rsc_adra(TLS_vec_rsc_adra);
    peaceNTT_INST.vec_rsc_da(TLS_vec_rsc_da);
    peaceNTT_INST.vec_rsc_wea(TLS_vec_rsc_wea);
    peaceNTT_INST.vec_rsc_qa(TLS_vec_rsc_qa);
    peaceNTT_INST.vec_rsc_adrb(TLS_vec_rsc_adrb);
    peaceNTT_INST.vec_rsc_db(TLS_vec_rsc_db);
    peaceNTT_INST.vec_rsc_web(TLS_vec_rsc_web);
    peaceNTT_INST.vec_rsc_qb(TLS_vec_rsc_qb);
    peaceNTT_INST.vec_rsc_triosy_lz(TLS_vec_rsc_triosy_lz);
    ...
    peaceNTT_INST.result_rsc_adra(TLS_result_rsc_adra);
    peaceNTT_INST.result_rsc_da(TLS_result_rsc_da);
    peaceNTT_INST.result_rsc_wea(TLS_result_rsc_wea);
    peaceNTT_INST.result_rsc_qa(TLS_result_rsc_qa);
    peaceNTT_INST.result_rsc_adrb(TLS_result_rsc_adrb);
    peaceNTT_INST.result_rsc_db(TLS_result_rsc_db);
    peaceNTT_INST.result_rsc_web(TLS_result_rsc_web);
    peaceNTT_INST.result_rsc_qb(TLS_result_rsc_qb);
    peaceNTT_INST.result_rsc_triosy_lz(TLS_result_rsc_triosy_lz);
    peaceNTT_INST.twiddle_rsc_radr(TLS_twiddle_rsc_radr);
    peaceNTT_INST.twiddle_rsc_q(TLS_twiddle_rsc_q);
    peaceNTT_INST.twiddle_rsc_triosy_lz(TLS_twiddle_rsc_triosy_lz);
    ...
    result_rsc_INST.clka(clk);
    result_rsc_INST.clka_en(SIG_SC_LOGIC_1);
    result_rsc_INST.clkb(clk);
    result_rsc_INST.clkb_en(SIG_SC_LOGIC_1);
    ...
    twiddle_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_5)));
