...
// Generated date: Thu Sep 16 18:53:18 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void peaseNTT( ac_int<32, false > xt[65536], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[65536],  ac_int<32, false > twiddle_h[65536]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_peaseNTT( ac_int<32, false > xt[65536], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[65536],  ac_int<32, false > twiddle_h[65536]) {
...
void mc_testbench::capture_xt_IN( ac_int<32, false > xt[65536])
{
   ...
   if (_capture_xt_IN && !testbench::xt_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,65536> xt_IN_tmp;
      int xt_linear_idx = 0;
      for (int xt_idx_0 = 0; xt_idx_0 < 65536; ++xt_idx_0)
...
void mc_testbench::capture_xt( ac_int<32, false > xt[65536])
{
   if (_capture_xt)
   {
      int cur_iter = xt_iteration_count;
      ++xt_iteration_count;
      mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,65536>, MaskPacket<0, 32> > xt_tmp(testbench::xt_ignore, false, xt_iteration_count);
      xt_tmp._data.mc_testbench_process_array_bounds("xt",testbench::xt_array_comp_first,testbench::xt_array_comp_last,65535,0);
...
void mc_testbench::capture_twiddle( ac_int<32, false > twiddle[65536])
{
   ...
   if (_capture_twiddle && !testbench::twiddle_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,65536> twiddle_tmp;
      int twiddle_linear_idx = 0;
      for (int twiddle_idx_0 = 0; twiddle_idx_0 < 65536; ++twiddle_idx_0)
...
void mc_testbench::capture_twiddle_h( ac_int<32, false > twiddle_h[65536])
{
   ...
   if (_capture_twiddle_h && !testbench::twiddle_h_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,65536> twiddle_h_tmp;
      int twiddle_h_linear_idx = 0;
      for (int twiddle_h_idx_0 = 0; twiddle_h_idx_0 < 65536; ++twiddle_h_idx_0)
...
void mc_testbench::capture_IN( ac_int<32, false > xt[65536], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[65536],  ac_int<32, false > twiddle_h[65536])
{
...
void mc_testbench::capture_OUT( ac_int<32, false > xt[65536], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[65536],  ac_int<32, false > twiddle_h[65536])
{
   that->capture_xt(xt);
}
// ============================================
...
void mc_testbench::exec_peaseNTT( ac_int<32, false > xt[65536], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[65536],  ac_int<32, false > twiddle_h[65536])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
