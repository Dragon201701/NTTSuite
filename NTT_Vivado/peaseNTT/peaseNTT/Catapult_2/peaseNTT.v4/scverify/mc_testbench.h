...
public:
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,65536> , MaskPacket< 0, 32 > > *xt_comp;
   
   // Interface Ports
   sc_in< bool > clk;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,65536> > > ccs_xt_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_xt_IN;
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_int<32, false >,65536> > > ccs_xt;
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,65536> > > ccs_twiddle;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_twiddle;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,65536> > > ccs_twiddle_h;
   ...
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,65536>, MaskPacket<0, 32> > > xt_golden;
   bool _capture_xt;
      ...
      , xt_golden("xt_golden",-1)
   {
      ...
      xt_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,65536> , MaskPacket< 0, 32 > > (
         "xt_comp",
         "xt",
         0,
         0,
   ...
   public:
      void reset_request() ;
   public:
      void capture_xt_IN( ac_int<32, false > xt[65536]) ;
   public:
      void capture_xt( ac_int<32, false > xt[65536]) ;
   public:
      void capture_p(ac_int<32, false > p) ;
   public:
      void capture_r(ac_int<32, false > r) ;
   public:
      void capture_twiddle( ac_int<32, false > twiddle[65536]) ;
   public:
      void capture_twiddle_h( ac_int<32, false > twiddle_h[65536]) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN( ac_int<32, false > xt[65536], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[65536],  ac_int<32, false > twiddle_h[65536]) ;
   public:
      static void capture_OUT( ac_int<32, false > xt[65536], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[65536],  ac_int<32, false > twiddle_h[65536]) ;
   public:
      static void exec_peaseNTT( ac_int<32, false > xt[65536], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[65536],  ac_int<32, false > twiddle_h[65536]) ;
   protected:
