...
HD_PWD='D:/NTT_Xilinx/NTT_Vivado/inplace_DIF_md_4096/inplace_DIF_md_4096.runs/top_blk_mem_gen_1_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_blk_mem_gen_1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_blk_mem_gen_1_2.tcl
