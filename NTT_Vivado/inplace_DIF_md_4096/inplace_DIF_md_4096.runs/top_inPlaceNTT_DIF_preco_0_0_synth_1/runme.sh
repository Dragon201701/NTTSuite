...
HD_PWD='D:/NTT_Xilinx/NTT_Vivado/inplace_DIF_md_4096/inplace_DIF_md_4096.runs/top_inPlaceNTT_DIF_preco_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_inPlaceNTT_DIF_preco_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_inPlaceNTT_DIF_preco_0_0.tcl
