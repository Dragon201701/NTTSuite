...
HD_PWD='D:/NTT_Xilinx/NTT_Vivado/inplace_DIT_md_16384/inplace_DIT_md_16384.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inPlaceNTT_DIT_precomp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inPlaceNTT_DIT_precomp.tcl
