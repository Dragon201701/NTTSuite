...
# Error: ntt.cpp(66):   MEMORYWRITE "butterFly:write_mem(result:rsc(0)(0).@)#1" ntt.cpp(66,4,14) (BASIC-25)
# Error: ntt.cpp(63):   MEMORYREAD "butterFly:f1:read_mem(result:rsc(0)(0).@)" ntt.cpp(63,19,12) (BASIC-25)
