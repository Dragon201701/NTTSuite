...
public:
  ...
  sc_signal<sc_lv<14> >                                                         TLS_result_rsc_ARADDR;
  ...
  sc_signal<sc_lv<14> >                                                         TLS_result_rsc_AWADDR;
  ...
  ccs_axi4_slave_mem_trans_rsc<11264,32,32,0,0,14,32,1,1,1,0,0 >                result_rsc_INST;
  ...
  mc_input_transactor<mgc_sysc_ver_array1D<ac_int<32, false >,1024>,32,false>   transactor_vec;
  ...
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<32, false >,11264> >                TLS_in_fifo_result;
  tlm::tlm_fifo<mc_wait_ctrl>                                                   TLS_in_wait_ctrl_fifo_result;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<32, false >,11264> >                TLS_out_fifo_result;
  tlm::tlm_fifo<mc_wait_ctrl>                                                   TLS_out_wait_ctrl_fifo_result;
  mc_trios_inout_monitor                                                        trios_monitor_result_rsc_triosy_lz_INST;
  mc_inout_transactor<mgc_sysc_ver_array1D<ac_int<32, false >,11264>,32,false>  transactor_result;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , CCS_CLK_CTOR(clk, "clk", 200, SC_NS, 0.5, 0, SC_NS, false)
    , rst_driver("rst_driver", 400.000000, false)
    , TLS_rst("TLS_rst")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 12340, 12340, 0)
    , catapult_monitor_INST("Monitor", clk, true, 12340LL, 12340LL)
...
void scverify_top::generate_reset() {
  ...
  if (activate_reset || sc_time_stamp() == SC_ZERO_TIME) {
    ...
    generate_reset_event.notify(400.000000 , SC_NS);
  } else {
    if (toggle_hw_reset) {
