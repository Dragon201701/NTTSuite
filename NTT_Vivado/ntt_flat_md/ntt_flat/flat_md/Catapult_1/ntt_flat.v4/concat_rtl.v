...
//  Generated date: Thu Sep  9 23:10:32 2021
// ----------------------------------------------------------------------
...
module ntt_flat_core_result_rsci_result_rsc_wait_dp (
  ...
  input [15:0] result_rsci_s_raddr_core;
  input [15:0] result_rsci_s_waddr_core;
  ...
  output [15:0] result_rsci_s_raddr;
  input result_rsci_s_raddr_core_sct;
  output [15:0] result_rsci_s_waddr;
  ...
  assign result_rsci_s_raddr = MUX_v_16_2_2(16'b0000000000000000, result_rsci_s_raddr_core,
      result_rsci_s_raddr_core_sct);
  assign result_rsci_s_waddr = MUX_v_16_2_2(16'b0000000000000000, result_rsci_s_waddr_core,
...
module ntt_flat_core_twiddle_h_rsci_twiddle_h_rsc_wait_dp (
  ...
  assign twiddle_h_rsci_wen_comp = (~ twiddle_h_rsci_oswt) | twiddle_h_rsci_biwt
      | twiddle_h_rsci_bcwt;
  assign twiddle_h_rsci_s_raddr = MUX_v_12_2_2(12'b000000000000, twiddle_h_rsci_s_raddr_core,
...
module ntt_flat_core_twiddle_rsci_twiddle_rsc_wait_dp (
  ...
  assign twiddle_rsci_s_raddr = MUX_v_12_2_2(12'b000000000000, twiddle_rsci_s_raddr_core,
...
module ntt_flat_core_vec_rsci_vec_rsc_wait_dp (
  ...
  input [11:0] vec_rsci_s_raddr_core;
  output [31:0] vec_rsci_s_din_mxwt;
  input vec_rsci_biwt;
  input vec_rsci_bdwt;
  output vec_rsci_bcwt;
  reg vec_rsci_bcwt;
  output [11:0] vec_rsci_s_raddr;
  ...
  assign vec_rsci_s_raddr = MUX_v_12_2_2(12'b000000000000, vec_rsci_s_raddr_core,
...
module ntt_flat_core_wait_dp (
  ...
  input [11:0] INNER_LOOP_tf_mul_cmp_z;
  input [14:0] INNER_LOOP_idx1_mul_cmp_z;
  input core_wen;
  input ensig_cgo;
  output mult_z_mul_cmp_en;
  input ensig_cgo_1;
  output mult_z_mul_cmp_en_1;
  output [11:0] INNER_LOOP_tf_mul_cmp_z_oreg;
  reg [11:0] INNER_LOOP_tf_mul_cmp_z_oreg;
  output [14:0] INNER_LOOP_idx1_mul_cmp_z_oreg;
  reg [14:0] INNER_LOOP_idx1_mul_cmp_z_oreg;
...
module ntt_flat_core_result_rsci (
  ...
  wire [15:0] result_rsci_s_raddr;
  wire [15:0] result_rsci_s_waddr;
...
module ntt_flat_core_twiddle_h_rsci (
  ...
  wire [11:0] twiddle_h_rsci_s_raddr;
...
module ntt_flat_core_twiddle_rsci (
  ...
  wire [11:0] twiddle_rsci_s_raddr;
...
module ntt_flat_core (
  ...
  input result_rsc_AWID;
  output result_rsc_triosy_lz;
  output [11:0] INNER_LOOP_tf_mul_cmp_a;
  reg [11:0] INNER_LOOP_tf_mul_cmp_a;
  output [11:0] INNER_LOOP_tf_mul_cmp_b;
  reg [11:0] INNER_LOOP_tf_mul_cmp_b;
  input [11:0] INNER_LOOP_tf_mul_cmp_z;
  output [10:0] INNER_LOOP_idx1_mul_cmp_a;
  reg [10:0] INNER_LOOP_idx1_mul_cmp_a;
  output [11:0] INNER_LOOP_idx1_mul_cmp_b;
  reg [11:0] INNER_LOOP_idx1_mul_cmp_b;
  input [14:0] INNER_LOOP_idx1_mul_cmp_z;
  ...
  reg [11:0] vec_rsci_s_raddr_core;
  ...
  wire [11:0] INNER_LOOP_tf_mul_cmp_z_oreg;
  wire [14:0] INNER_LOOP_idx1_mul_cmp_z_oreg;
  reg [3:0] result_rsci_s_raddr_core_15_12;
  reg [10:0] result_rsci_s_raddr_core_11_1;
  reg result_rsci_s_raddr_core_0;
  reg [3:0] result_rsci_s_waddr_core_15_12;
  reg [10:0] result_rsci_s_waddr_core_11_1;
  ...
  reg [11:0] reg_twiddle_rsci_s_raddr_core_cse;
  ...
  wire [11:0] operator_33_true_lshift_itm;
  wire [15:0] INNER_LOOP_k_lshift_itm_3;
  ...
  reg [15:0] INNER_LOOP_k_lshift_itm;
  ...
  reg [15:0] INNER_LOOP_k_15_0_sva_1;
  ...
  reg [10:0] butterFly_slc_INNER_LOOP_idx1_acc_psp_10_0_itm_1;
  reg [10:0] butterFly_slc_INNER_LOOP_idx1_acc_psp_10_0_itm_2;
  reg [10:0] butterFly_slc_INNER_LOOP_idx1_acc_psp_10_0_itm_3;
  reg [10:0] butterFly_slc_INNER_LOOP_idx1_acc_psp_10_0_itm_4;
  reg [10:0] butterFly_slc_INNER_LOOP_idx1_acc_psp_10_0_itm_5;
  reg INNER_LOOP_k_slc_INNER_LOOP_k_15_0_0_itm_1;
  reg INNER_LOOP_k_slc_INNER_LOOP_k_15_0_0_itm_2;
  reg INNER_LOOP_k_slc_INNER_LOOP_k_15_0_0_itm_3;
  reg INNER_LOOP_k_slc_INNER_LOOP_k_15_0_0_itm_4;
  reg INNER_LOOP_k_slc_INNER_LOOP_k_15_0_0_itm_5;
  ...
  reg [11:0] butterFly_slc_butterFly_idx2_15_0_11_0_itm_1;
  reg [11:0] butterFly_slc_butterFly_idx2_15_0_11_0_itm_2;
  reg [11:0] butterFly_slc_butterFly_idx2_15_0_11_0_itm_3;
  reg [11:0] butterFly_slc_butterFly_idx2_15_0_11_0_itm_4;
  reg [11:0] butterFly_slc_butterFly_idx2_15_0_11_0_itm_5;
  reg [10:0] INNER_LOOP_j_11_0_sva_10_0;
  wire [14:0] INNER_LOOP_idx1_acc_psp_sva_1;
  wire [15:0] nl_INNER_LOOP_idx1_acc_psp_sva_1;
  reg [11:0] butterFly_idx2_15_0_sva_11_0;
  ...
  wire[11:0] butterFly_f1_mux_3_nl;
  wire[3:0] butterFly_f1_mux_4_nl;
  wire[16:0] acc_2_nl;
  wire[17:0] nl_acc_2_nl;
  wire[15:0] INNER_LOOP_k_mux_7_nl;
  wire[0:0] INNER_LOOP_k_or_1_nl;
  wire[11:0] INNER_LOOP_k_mux_8_nl;
  wire[32:0] acc_3_nl;
  ...
  assign nl_INNER_LOOP_k_lshift_rg_a = z_out_1[10:0];
  ...
  assign nl_INNER_LOOP_g_rshift_rg_s = MUX_v_4_2_2(STAGE_LOOP_i_3_0_sva, operator_20_false_acc_psp_sva,
      fsm_output[4]);
  wire [15:0] nl_ntt_flat_core_result_rsci_inst_result_rsci_s_raddr_core;
  assign nl_ntt_flat_core_result_rsci_inst_result_rsci_s_raddr_core = {result_rsci_s_raddr_core_15_12
      , result_rsci_s_raddr_core_11_1 , result_rsci_s_raddr_core_0};
  wire [15:0] nl_ntt_flat_core_result_rsci_inst_result_rsci_s_waddr_core;
  assign nl_ntt_flat_core_result_rsci_inst_result_rsci_s_waddr_core = {result_rsci_s_waddr_core_15_12
      , result_rsci_s_waddr_core_11_1 , result_rsci_s_waddr_core_0};
  wire [0:0] nl_ntt_flat_core_core_fsm_inst_for_C_1_tr0;
  assign nl_ntt_flat_core_core_fsm_inst_for_C_1_tr0 = for_i_12_0_sva_1[12];
  ...
  .signd_a(32'sd0),
  .width_s(32'sd4),
  .width_z(32'sd12)) operator_33_true_lshift_rg (
      .a(1'b1),
      .s(z_out_2),
  ...
  ntt_flat_core_result_rsci ntt_flat_core_result_rsci_inst (
      ...
      .result_rsci_wen_comp_1(result_rsci_wen_comp_1),
      .result_rsci_s_raddr_core(nl_ntt_flat_core_result_rsci_inst_result_rsci_s_raddr_core[15:0]),
      .result_rsci_s_waddr_core(nl_ntt_flat_core_result_rsci_inst_result_rsci_s_waddr_core[15:0]),
      .result_rsci_s_din_mxwt(result_rsci_s_din_mxwt),
      .result_rsci_s_dout_core(result_rsci_s_dout_core)
    );
  ...
  assign nl_INNER_LOOP_idx1_acc_psp_sva_1 = INNER_LOOP_idx1_mul_cmp_z_oreg + (INNER_LOOP_k_15_0_sva_1[15:1]);
  ...
  assign nl_operator_20_false_acc_nl_1 = ({1'b1 , (~ z_out_2)}) + 5'b01101;
  ...
  always @(posedge clk) begin
    if ( core_wen ) begin
      vec_rsci_s_raddr_core <= MUX_v_12_2_2(12'b000000000000, (for_i_12_0_sva_1[11:0]),
          (fsm_output[2]));
      result_rsci_s_raddr_core_11_1 <= MUX_v_11_2_2((INNER_LOOP_idx1_acc_psp_sva_1[10:0]),
          (butterFly_idx2_15_0_sva_11_0[11:1]), fsm_output[5]);
      result_rsci_s_raddr_core_0 <= MUX_s_1_2_2((INNER_LOOP_k_15_0_sva_1[0]), (butterFly_idx2_15_0_sva_11_0[0]),
          fsm_output[5]);
      result_rsci_s_raddr_core_15_12 <= MUX_v_4_2_2((z_out[3:0]), butterFly_f2_acc_itm,
          fsm_output[5]);
      result_rsci_s_waddr_core_11_1 <= MUX1HOT_v_11_3_2((vec_rsci_s_raddr_core[11:1]),
          butterFly_slc_INNER_LOOP_idx1_acc_psp_10_0_itm_5, (butterFly_slc_butterFly_idx2_15_0_11_0_itm_5[11:1]),
          {(fsm_output[1]) , (fsm_output[4]) , (fsm_output[5])});
      result_rsci_s_waddr_core_0 <= MUX1HOT_s_1_3_2((vec_rsci_s_raddr_core[0]), INNER_LOOP_k_slc_INNER_LOOP_k_15_0_0_itm_5,
          (butterFly_slc_butterFly_idx2_15_0_11_0_itm_5[0]), {(fsm_output[1]) , (fsm_output[4])
          , (fsm_output[5])});
      result_rsci_s_waddr_core_15_12 <= MUX_v_4_2_2(4'b0000, operator_20_false_mux_5_nl,
          for_not_nl);
      result_rsci_s_dout_core <= MUX1HOT_v_32_4_2(vec_rsci_s_din_mxwt, modulo_add_mux_itm_4,
          z_out_4, mult_res_sva, {(fsm_output[1]) , (fsm_output[4]) , for_and_nl
          , for_and_1_nl});
      ...
      butterFly_f1_sva_1 <= MUX_v_32_2_2(butterFly_acc_1_nl, result_rsci_s_din_mxwt,
          fsm_output[5]);
      INNER_LOOP_k_15_0_sva_1 <= MUX_v_16_2_2(({5'b00000 , INNER_LOOP_j_11_0_sva_10_0}),
      ...
      operator_20_false_acc_itm <= MUX_v_4_2_2(operator_20_false_acc_nl, operator_20_false_acc_itm_4,
          fsm_output[5]);
      butterFly_idx2_15_0_sva_11_0 <= z_out_3[11:0];
    end
  end
  always @(posedge clk) begin
    if ( rst ) begin
      ...
      for_i_12_0_sva_1 <= 13'b0000000000000;
      INNER_LOOP_tf_asn_itm_1 <= 32'b00000000000000000000000000000000;
      INNER_LOOP_stage_0 <= 1'b0;
    end
    else if ( core_wen ) begin
      reg_vec_rsci_oswt_cse <= ~((~((fsm_output[0]) | (fsm_output[2]))) | ((for_i_12_0_sva_1[12])
          & (fsm_output[2])));
      ...
      INNER_LOOP_stage_0 <= (INNER_LOOP_stage_0 & (~(nor_6_cse | (INNER_LOOP_stage_0_1
          & (INNER_LOOP_j_11_0_sva_2[11]) & (fsm_output[4]))))) | (fsm_output[3]);
    end
  end
  always @(posedge clk) begin
    if ( INNER_LOOP_tf_and_cse ) begin
      ...
      INNER_LOOP_tf_mul_cmp_b <= z_out_3[11:0];
    end
  end
  always @(posedge clk) begin
    if ( INNER_LOOP_idx1_and_cse ) begin
      INNER_LOOP_idx1_mul_cmp_a <= z_out_1[10:0];
  ...
  assign nl_operator_20_false_acc_nl = STAGE_LOOP_i_3_0_sva + (INNER_LOOP_idx1_acc_psp_sva_1[14:11])
      + 4'b0001;
  ...
  assign nl_butterFly_f2_acc_itm  = STAGE_LOOP_i_3_0_sva + (z_out_3[15:12]);
  assign nl_operator_20_false_1_acc_itm  = STAGE_LOOP_i_3_0_sva + (z_out_3[15:12])
      + 4'b0001;
  assign butterFly_f1_mux_3_nl = MUX_v_12_2_2(({8'b00000000 , STAGE_LOOP_i_3_0_sva}),
      vec_rsci_s_raddr_core, fsm_output[1]);
  assign butterFly_f1_mux_4_nl = MUX_v_4_2_2((INNER_LOOP_idx1_acc_psp_sva_1[14:11]),
      4'b0001, fsm_output[1]);
  assign nl_z_out = conv_u2u_12_13(butterFly_f1_mux_3_nl) + conv_u2u_4_13(butterFly_f1_mux_4_nl);
  assign z_out = nl_z_out[12:0];
  assign nl_z_out_2 = STAGE_LOOP_i_3_0_sva + conv_s2u_2_4({(~ (fsm_output[6])) ,
      1'b1});
  assign z_out_2 = nl_z_out_2[3:0];
  assign INNER_LOOP_k_mux_7_nl = MUX_v_16_2_2((~ INNER_LOOP_k_lshift_itm), ({INNER_LOOP_idx1_acc_psp_sva_1
      , (INNER_LOOP_k_15_0_sva_1[0])}), fsm_output[4]);
  assign INNER_LOOP_k_or_1_nl = (fsm_output[5:4]!=2'b01);
  assign INNER_LOOP_k_mux_8_nl = MUX_v_12_2_2(({1'b0 , (INNER_LOOP_k_15_0_sva_1[10:0])}),
      operator_20_false_rshift_psp_sva, fsm_output[4]);
  assign nl_acc_2_nl = ({INNER_LOOP_k_mux_7_nl , INNER_LOOP_k_or_1_nl}) + conv_u2u_13_17({INNER_LOOP_k_mux_8_nl
      , 1'b1});
  assign acc_2_nl = nl_acc_2_nl[16:0];
  assign z_out_3 = readslicef_17_16_1(acc_2_nl);
  assign mult_if_mux_1_nl = MUX_v_32_2_2((~ p_sva), (~ mult_z_asn_itm_1), fsm_output[4]);
  assign nl_acc_3_nl = ({mult_res_sva , 1'b1}) + ({mult_if_mux_1_nl , 1'b1});
  ...
  assign butterFly_mux_10_nl = MUX_v_32_2_2((~ result_rsci_s_din_mxwt), (~ p_sva),
      fsm_output[5]);
  assign nl_acc_4_nl = ({butterFly_f1_sva_1 , 1'b1}) + ({butterFly_mux_10_nl , 1'b1});
...
module ntt_flat (
  ...
  // Interconnect Declarations
  wire [11:0] INNER_LOOP_tf_mul_cmp_a;
  wire [11:0] INNER_LOOP_tf_mul_cmp_b;
  wire [10:0] INNER_LOOP_idx1_mul_cmp_a;
  wire [11:0] INNER_LOOP_idx1_mul_cmp_b;


  // Interconnect Declarations for Component Instantiations 
  wire [11:0] nl_ntt_flat_core_inst_INNER_LOOP_tf_mul_cmp_z;
  assign nl_ntt_flat_core_inst_INNER_LOOP_tf_mul_cmp_z = conv_u2u_24_12(INNER_LOOP_tf_mul_cmp_a
      * INNER_LOOP_tf_mul_cmp_b);
  wire [14:0] nl_ntt_flat_core_inst_INNER_LOOP_idx1_mul_cmp_z;
  assign nl_ntt_flat_core_inst_INNER_LOOP_idx1_mul_cmp_z = conv_u2u_23_15(INNER_LOOP_idx1_mul_cmp_a
  ...
  ntt_flat_core ntt_flat_core_inst (
      ...
      .INNER_LOOP_tf_mul_cmp_z(nl_ntt_flat_core_inst_INNER_LOOP_tf_mul_cmp_z[11:0]),
      .INNER_LOOP_idx1_mul_cmp_a(INNER_LOOP_idx1_mul_cmp_a),
      .INNER_LOOP_idx1_mul_cmp_b(INNER_LOOP_idx1_mul_cmp_b),
      .INNER_LOOP_idx1_mul_cmp_z(nl_ntt_flat_core_inst_INNER_LOOP_idx1_mul_cmp_z[14:0])
    );

  function automatic [14:0] conv_u2u_23_15 ;
    input [22:0]  vector ;
  begin
    conv_u2u_23_15 = vector[14:0];
  end
  endfunction


  function automatic [11:0] conv_u2u_24_12 ;
    input [23:0]  vector ;
  begin
