...
directive set /ntt_flat/ntt_flat:core/core/INNER_LOOP:k(15:0).sva.1 REGISTER_NAME INNER_LOOP:k(15:0).sva.1
directive set /ntt_flat/ntt_flat:core/core/INNER_LOOP:j:slc(INNER_LOOP:j(11:0))(10-0).itm REGISTER_NAME INNER_LOOP:k(15:0).sva.1
