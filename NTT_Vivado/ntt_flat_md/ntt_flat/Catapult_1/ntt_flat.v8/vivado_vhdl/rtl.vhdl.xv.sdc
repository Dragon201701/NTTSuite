...
create_clock -name clk -period 5.95 -waveform { 0.0 2.975 } [get_ports {clk}]
set_clock_uncertainty 0.0 [get_clocks {clk}]

create_clock -name virtual_io_clk -period 5.95
...
set_max_delay 5.95 -from [all_inputs] -to [all_outputs]
