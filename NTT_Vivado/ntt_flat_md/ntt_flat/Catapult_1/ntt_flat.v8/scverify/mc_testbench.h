...
public:
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,245760> , MaskPacket< 0, 32 > > *result_comp;
   
   // Interface Ports
   sc_in< bool > clk;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,16384> > > ccs_vec;
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,16384> > > ccs_twiddle;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_twiddle;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,16384> > > ccs_twiddle_h;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_twiddle_h;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<32, false >,245760> > > ccs_result_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_result_IN;
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_int<32, false >,245760> > > ccs_result;
   ...
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,245760>, MaskPacket<0, 32> > > result_golden;
      ...
      , result_golden("result_golden",-1)
   {
      ...
      result_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_int<32, false >,245760> , MaskPacket< 0, 32 > > (
         "result_comp",
         "result",
         0,
         0,
   ...
   public:
      void reset_request() ;
   public:
      void capture_vec( ac_int<32, false > vec[16384]) ;
   public:
      void capture_p(ac_int<32, false > p) ;
   public:
      void capture_r(ac_int<32, false > r) ;
   public:
      void capture_twiddle( ac_int<32, false > twiddle[16384]) ;
   public:
      void capture_twiddle_h( ac_int<32, false > twiddle_h[16384]) ;
   public:
      void capture_result_IN( ac_int<32, false > result[15][16384]) ;
   public:
      void capture_result( ac_int<32, false > result[15][16384]) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN( ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_int<32, false > result[15][16384]) ;
   public:
      static void capture_OUT( ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_int<32, false > result[15][16384]) ;
   public:
      static void exec_ntt_flat( ac_int<32, false > vec[16384], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384],  ac_int<32, false > result[15][16384]) ;
   protected:
