...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(8)(0).@) CSTEPS_FROM {{.. == 8}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(8)(0).@)#1 CSTEPS_FROM {{.. == 10}}
