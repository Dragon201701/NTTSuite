...
// Generated date: Thu Sep 16 12:39:09 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void ntt_flat( ac_int<32, false > vec[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024],  ac_int<32, false > result[11][1024]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_ntt_flat( ac_int<32, false > vec[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024],  ac_int<32, false > result[11][1024]) {
...
void mc_testbench::capture_vec( ac_int<32, false > vec[1024])
{
   ...
   if (_capture_vec && !testbench::vec_ignore)
   {
      ...
      ++vec_iteration_count;
      mgc_sysc_ver_array1D<ac_int<32, false >,1024> vec_tmp;
      int vec_linear_idx = 0;
      for (int vec_idx_0 = 0; vec_idx_0 < 1024; ++vec_idx_0)
...
void mc_testbench::capture_twiddle( ac_int<32, false > twiddle[1024])
{
   ...
   if (_capture_twiddle && !testbench::twiddle_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,1024> twiddle_tmp;
...
void mc_testbench::capture_twiddle_h( ac_int<32, false > twiddle_h[1024])
{
   ...
   if (_capture_twiddle_h && !testbench::twiddle_h_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,1024> twiddle_h_tmp;
      int twiddle_h_linear_idx = 0;
      for (int twiddle_h_idx_0 = 0; twiddle_h_idx_0 < 1024; ++twiddle_h_idx_0)
...
void mc_testbench::capture_result_IN( ac_int<32, false > result[11][1024])
{
   ...
   if (_capture_result_IN && !testbench::result_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,11264> result_IN_tmp;
      int result_linear_idx = 0;
      for (int result_idx_0 = 0; result_idx_0 < 11; ++result_idx_0)
         for (int result_idx_1 = 0; result_idx_1 < 1024; ++result_idx_1)
...
void mc_testbench::capture_result( ac_int<32, false > result[11][1024])
{
   if (_capture_result)
   {
      int cur_iter = result_iteration_count;
      ++result_iteration_count;
      mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,11264>, MaskPacket<0, 32> > result_tmp(testbench::result_ignore, false, result_iteration_count);
      result_tmp._data.mc_testbench_process_array_bounds("result",testbench::result_array_comp_first,testbench::result_array_comp_last,11263,0);
...
void mc_testbench::capture_IN( ac_int<32, false > vec[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024],  ac_int<32, false > result[11][1024])
{
...
void mc_testbench::capture_OUT( ac_int<32, false > vec[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024],  ac_int<32, false > result[11][1024])
{
...
void mc_testbench::exec_ntt_flat( ac_int<32, false > vec[1024], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024],  ac_int<32, false > result[11][1024])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
