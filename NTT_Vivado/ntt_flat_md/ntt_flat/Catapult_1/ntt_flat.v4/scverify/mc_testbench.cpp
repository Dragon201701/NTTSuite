...
// Generated date: Thu Sep 16 11:18:26 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void ntt_flat( ac_int<32, false > vec[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096],  ac_int<32, false > result[13][4096]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_ntt_flat( ac_int<32, false > vec[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096],  ac_int<32, false > result[13][4096]) {
...
void mc_testbench::capture_vec( ac_int<32, false > vec[4096])
{
   ...
   if (_capture_vec && !testbench::vec_ignore)
   {
      ...
      ++vec_iteration_count;
      mgc_sysc_ver_array1D<ac_int<32, false >,4096> vec_tmp;
...
void mc_testbench::capture_result_IN( ac_int<32, false > result[13][4096])
{
   ...
   if (_capture_result_IN && !testbench::result_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,53248> result_IN_tmp;
      int result_linear_idx = 0;
      for (int result_idx_0 = 0; result_idx_0 < 13; ++result_idx_0)
         for (int result_idx_1 = 0; result_idx_1 < 4096; ++result_idx_1)
...
void mc_testbench::capture_result( ac_int<32, false > result[13][4096])
{
   if (_capture_result)
   {
      int cur_iter = result_iteration_count;
      ++result_iteration_count;
      mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,53248>, MaskPacket<0, 32> > result_tmp(testbench::result_ignore, false, result_iteration_count);
      result_tmp._data.mc_testbench_process_array_bounds("result",testbench::result_array_comp_first,testbench::result_array_comp_last,53247,0);
...
void mc_testbench::capture_IN( ac_int<32, false > vec[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096],  ac_int<32, false > result[13][4096])
{
...
void mc_testbench::capture_OUT( ac_int<32, false > vec[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096],  ac_int<32, false > result[13][4096])
{
...
void mc_testbench::exec_ntt_flat( ac_int<32, false > vec[4096], ac_int<32, false > p, ac_int<32, false > r,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096],  ac_int<32, false > result[13][4096])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
