...
create_clock -name clk -period 6.45 -waveform { 0.0 3.225 } [get_ports {clk}]
set_clock_uncertainty 0.0 [get_clocks {clk}]

create_clock -name virtual_io_clk -period 6.45
...
set_max_delay 6.45 -from [all_inputs] -to [all_outputs]
