...
directive set /ntt_flat/ntt_flat:core/core/INNER_LOOP:tf:asn.itm.2 REGISTER_NAME INNER_LOOP:tf:asn.itm.2
directive set /ntt_flat/ntt_flat:core/core/tmp#1.lpi#3.dfm REGISTER_NAME INNER_LOOP:tf:asn.itm.2
