...
directive set /ntt_flat/core/core:rlp/main/for/for:write_mem(result:rsc.@) CSTEPS_FROM {{.. == 2}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:f2:read_mem(result:rsc.@) CSTEPS_FROM {{.. == 3}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:acc#1 CSTEPS_FROM {{.. == 4}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc.@) CSTEPS_FROM {{.. == 5}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:acc#3 CSTEPS_FROM {{.. == 4}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/mult:z_:mul CSTEPS_FROM {{.. == 8}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc.@)#1 CSTEPS_FROM {{.. == 11}}
