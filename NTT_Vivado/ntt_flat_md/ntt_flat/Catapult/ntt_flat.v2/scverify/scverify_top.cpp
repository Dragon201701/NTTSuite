...
public:
  ...
  sc_signal<sc_lv<18> >                                                          TLS_result_rsc_wadr;
  sc_signal<sc_lv<32> >                                                          TLS_result_rsc_d;
  sc_signal<sc_logic>                                                            TLS_result_rsc_we;
  sc_signal<sc_lv<18> >                                                          TLS_result_rsc_radr;
  sc_signal<sc_lv<32> >                                                          TLS_result_rsc_q;
  ...
  BLOCK_1R1W_RBW_trans_rsc<18,32,245760 >                                        result_rsc_INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 1556510, 1556510, 0)
    , catapult_monitor_INST("Monitor", clk, true, 1556510LL, 1556510LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    ntt_flat_INST.result_rsc_wadr(TLS_result_rsc_wadr);
    ntt_flat_INST.result_rsc_d(TLS_result_rsc_d);
    ntt_flat_INST.result_rsc_we(TLS_result_rsc_we);
    ntt_flat_INST.result_rsc_radr(TLS_result_rsc_radr);
    ntt_flat_INST.result_rsc_q(TLS_result_rsc_q);
