...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP CSTEPS_FROM {{. == 14} {.. == 1}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:f1:read_mem(result:rsc(13)(0).@) CSTEPS_FROM {{.. == 3}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:f1:read_mem(result:rsc(14)(0).@) CSTEPS_FROM {{.. == 3}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(0)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(1)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(2)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(3)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(4)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(5)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(6)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(7)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(8)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(9)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(10)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(11)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(12)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(13)(0).@) CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(14)(0).@) CSTEPS_FROM {{.. == 11}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/INNER_LOOP:tf:read_mem(twiddle:rsc.@) CSTEPS_FROM {{.. == 3}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/mult:z:mul CSTEPS_FROM {{.. == 5}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/INNER_LOOP:tf_h:read_mem(twiddle_h:rsc.@) CSTEPS_FROM {{.. == 3}}
...
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/mult:res:acc CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/mult:if:acc#1 CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/mult:if:acc CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/mult:mux CSTEPS_FROM {{.. == 11}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:acc#4 CSTEPS_FROM {{.. == 3}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(0)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(1)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(2)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(3)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(4)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(5)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(6)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(7)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(8)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(9)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(10)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(11)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(12)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(13)(0).@)#1 CSTEPS_FROM {{.. == 13}}
directive set /ntt_flat/core/core:rlp/main/STAGE_LOOP/INNER_LOOP/butterFly:write_mem(result:rsc(14)(0).@)#1 CSTEPS_FROM {{.. == 13}}
