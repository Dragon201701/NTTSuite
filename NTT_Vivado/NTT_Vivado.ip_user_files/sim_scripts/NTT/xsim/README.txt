...
#
# Generated by export_simulation on Thu Apr 15 13:34:53 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './NTT.sh' script.
...
./NTT.sh -noclean_files

For more information on the script, please type './NTT.sh -help'.
