...
#
# Generated by Vivado on Tue Jun 01 16:40:42 -0400 2021
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/NTT.protoinst" -log simulate.log
}
