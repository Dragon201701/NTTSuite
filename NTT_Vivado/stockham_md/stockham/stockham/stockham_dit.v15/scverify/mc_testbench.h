...
public:
   ...
   public:
      static void capture_IN( ac_int<32, false > xt[1024], ac_int<32, false > p,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024]) ;
   public:
      static void capture_OUT( ac_int<32, false > xt[1024], ac_int<32, false > p,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024]) ;
   public:
      static void exec_stockham_dit( ac_int<32, false > xt[1024], ac_int<32, false > p,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024]) ;
   protected:
