...
// Generated date: Wed Sep 15 18:40:54 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void stockham_dit( ac_int<32, false > xt[1024], ac_int<32, false > p,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_stockham_dit( ac_int<32, false > xt[1024], ac_int<32, false > p,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024]) {
...
void mc_testbench::capture_xt_IN( ac_int<32, false > xt[1024])
{
   ...
   if (_capture_xt_IN && !testbench::xt_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<32, false >,1024> xt_IN_tmp;
      int xt_linear_idx = 0;
...
void mc_testbench::capture_xt( ac_int<32, false > xt[1024])
{
   if (_capture_xt)
   {
      int cur_iter = xt_iteration_count;
      ++xt_iteration_count;
      mc_golden_info< mgc_sysc_ver_array1D<ac_int<32, false >,1024>, MaskPacket<0, 32> > xt_tmp(testbench::xt_ignore, false, xt_iteration_count);
...
void mc_testbench::capture_IN( ac_int<32, false > xt[1024], ac_int<32, false > p,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024])
{
...
void mc_testbench::capture_OUT( ac_int<32, false > xt[1024], ac_int<32, false > p,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024])
{
   that->capture_xt(xt);
}
// ============================================
...
void mc_testbench::exec_stockham_dit( ac_int<32, false > xt[1024], ac_int<32, false > p,  ac_int<32, false > twiddle[1024],  ac_int<32, false > twiddle_h[1024])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
