...
// Generated date: Wed Sep 15 22:00:29 EDT 2021
//
// ----------------------------------------------------------------------------
// 
// -------------------------------------
...
extern "C++" void stockham_dit( ac_int<32, false > xt[4096], ac_int<32, false > p,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
void testbench::exec_stockham_dit( ac_int<32, false > xt[4096], ac_int<32, false > p,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096]) {
...
void mc_testbench::capture_IN( ac_int<32, false > xt[4096], ac_int<32, false > p,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096])
{
...
void mc_testbench::capture_OUT( ac_int<32, false > xt[4096], ac_int<32, false > p,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096])
{
   that->capture_xt(xt);
}
// ============================================
...
void mc_testbench::exec_stockham_dit( ac_int<32, false > xt[4096], ac_int<32, false > p,  ac_int<32, false > twiddle[4096],  ac_int<32, false > twiddle_h[4096])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   that->cpp_testbench_active.write(true);
