...
public:
  ...
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<9,32,512 >                                    xt_rsc_0__0__INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<9,32,512 >                                    xt_rsc_0__1__INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<9,32,512 >                                    xt_rsc_0__2__INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<9,32,512 >                                    xt_rsc_0__3__INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<9,32,512 >                                    xt_rsc_0__4__INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<9,32,512 >                                    xt_rsc_0__5__INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<9,32,512 >                                    xt_rsc_0__6__INST;
  BLOCK_DPRAM_RBW_DUAL_trans_rsc<9,32,512 >                                    xt_rsc_0__7__INST;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , CCS_CLK_CTOR(clk, "clk", 7.41, SC_NS, 0.5, 0, SC_NS, false)
    , rst_driver("rst_driver", 111.149994, false)
    , TLS_rst("TLS_rst")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 73814, 73814, 0)
    , catapult_monitor_INST("Monitor", clk, true, 73814LL, 73814LL)
...
void scverify_top::generate_reset() {
  ...
  if (activate_reset || sc_time_stamp() == SC_ZERO_TIME) {
    ...
    generate_reset_event.notify(111.149994 , SC_NS);
  } else {
    if (toggle_hw_reset) {
