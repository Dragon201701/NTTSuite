...
extern void mc_testbench_capture_IN( ac_int<32, false > xt[16384], ac_int<32, false > p,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384]);
extern void mc_testbench_capture_OUT( ac_int<32, false > xt[16384], ac_int<32, false > p,  ac_int<32, false > twiddle[16384],  ac_int<32, false > twiddle_h[16384]);
extern void mc_testbench_wait_for_idle_sync();

#define ccs_intercept_stockham_dit_32 \
  ccs_real_stockham_dit(ac_int<32, false > xt[16384],ac_int<32, false > p,ac_int<32, false > twiddle[16384],ac_int<32, false > twiddle_h[16384]);\
  void stockham_dit(ac_int<32, false > xt[16384],ac_int<32, false > p,ac_int<32, false > twiddle[16384],ac_int<32, false > twiddle_h[16384])\
{\
