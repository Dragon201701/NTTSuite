...
HD_PWD='D:/NTT_Xilinx/NTT_Vivado/inplace_DIF_md_16384/inplace_DIF_md_16384.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inPlaceNTT_DIF_precomp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inPlaceNTT_DIF_precomp.tcl
