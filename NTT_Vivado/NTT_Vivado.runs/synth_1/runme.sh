...
HD_PWD='D:/fhe_accelerator/ntt/Vivado_proj/inplace_DIT_precomp/inplace_DIT_precomp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inPlaceNTT_DIF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inPlaceNTT_DIF.tcl
