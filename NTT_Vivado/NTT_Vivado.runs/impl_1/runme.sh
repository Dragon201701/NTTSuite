...
HD_PWD='D:/fhe_accelerator/ntt/Vivado_proj/inplace_DIT_precomp/inplace_DIT_precomp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inPlaceNTT_DIF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inPlaceNTT_DIF.tcl -notrace
