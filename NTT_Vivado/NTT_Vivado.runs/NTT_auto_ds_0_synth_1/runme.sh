...
HD_PWD='D:/NTT_Xilinx/NTT_Vivado/NTT_Vivado.runs/NTT_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NTT_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NTT_auto_ds_0.tcl
