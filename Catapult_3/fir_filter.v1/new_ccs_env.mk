ifeq "$(CXX_HOME)" ""
CXX_HOME                                              := /opt/mentorgraphics/Catapult_10.3a/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                              := gcc
...
ifeq "$(TCLSH_CMD)" ""
TCLSH_CMD                                             := /opt/mentorgraphics/Catapult_10.3a/Mgc_home/bin/tclsh8.5
export TCLSH_CMD
endif
ifeq "$(ModelSim_Path)" ""
ModelSim_Path                                         := /opt/mentorgraphics/modelsimSE106/modeltech/linux_x86_64
...
OSCI_SYSTEMC_INCLUDE                                  := /opt/mentorgraphics/Catapult_10.3a/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                      := /opt/mentorgraphics/Catapult_10.3a/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
ifeq "$(LowPower_VERIFICATION_RESOLVE_FILE)" ""
LowPower_VERIFICATION_RESOLVE_FILE                    := 
export LowPower_VERIFICATION_RESOLVE_FILE
endif
ifeq "$(LowPower_DEBUG)" ""
