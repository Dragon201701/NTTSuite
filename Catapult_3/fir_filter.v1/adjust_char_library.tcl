...
#library load /opt/mentorgraphics/Catapult_10.3a/Mgc_home/pkgs/siflibs/designcompiler/mgc_sample-065nm-dw_beh_dc.lib
library set /LIBS/mgc_sample-065nm-dw_beh_dc/MODS/mgc_add/PARAMETERS/width_b -- -CHAR_RANGE {1, 2 to 2, 4 to 32, 64 to 64}
library set /LIBS/mgc_sample-065nm-dw_beh_dc/MODS/mgc_mux/PARAMETERS/ctrlw -- -CHAR_RANGE {1 to 5 by 1, 7}
library set /LIBS/mgc_sample-065nm-dw_beh_dc/MODS/mgc_mux/PARAMETERS/p2ctrlw -- -CHAR_RANGE {2 to 2, 4 to 4, 8 to 8, 16 to 16, 32 to 32, 128}
library set /LIBS/mgc_sample-065nm-dw_beh_dc/MODS/mgc_mul/PARAMETERS/width_a -- -CHAR_RANGE {3, 4 to 4, 8 to 8, 16 to 16, 32 to 32}
